...
public class XxGamMaPasajerosInfoVOImpl extends OAViewObjectImpl {
    ...
    void searchPasajerosInfo(Number ticketId, Number idGeneral) {
        ...
        try {
            ...
            System.out.println("getEstimatedRowCount() PasajerosInfo " + 
        ...
        if (deleteRows != null) {
            if (deleteRows.length > 0) {
                ...
                if (deleteRows != null) {
                    ...
                    throw new OAException("Registro borrado satisfactoriamente", 
                                          OAException.INFORMATION);
                }
            } else {
                throw new OAException("Al preguntar si la longitud del registo es mayor que cero", 
                                      OAException.WARNING);
            }
        } else {
            throw new OAException("Al preguntar si el registro es diferente de nulo", 
                                  OAException.WARNING);
        }
    ...
    XxGamMaPasajerosInfoVORowImpl getPasajerosInfo(XxGamMaPasajerosInfoVORowImpl rowBase, 
        ...
        if (rowBase == null) {
            ...
            try {
                rowActual = 
                        (XxGamMaPasajerosInfoVORowImpl)iterNuevo.createRow();
                ...
                System.out.println("Excepcion desde PasajerosInfoVoImpl al " + 
                                   exception.getMessage());
            }
            return rowActual;
        ...
        try {
            if (pasajerosInfoIter != null) {
                while (pasajerosInfoIter.hasNext()) {
                    XxGamMaPasajerosInfoVORowImpl currentRow = 
                        (XxGamMaPasajerosInfoVORowImpl)pasajerosInfoIter.next();
                    if (null != currentRow) {
                        strAttribute = null;
            ...
            throw new OAException("Excepcion en la validacion de cancelacion de boletos " + 
                                  exception.getMessage(), OAException.ERROR);
        }
        ...
        while (PasajerosInfoIter.hasNext()) {
            ...
            if (null != PasajerosInfoVORowImpl) {
                if (null != PasajerosInfoVORowImpl.getTicketNumber()) {
                    ...
                    if (null != strTicketNumber && 
                        !"".equals(strTicketNumber) && 
                        "0".equals(strTicketNumber)) {
            ...
            if (pasajerosInfoIter != null) {
                while (pasajerosInfoIter.hasNext()) {
                    ...
                    if (null != currentRow) {
                        strAttribute = null;
                        strAttribute = currentRow.getTicketNumber();
                        System.out.println("BugCleanTickets: " + 
                                           currentRow.getTicketNumber());
                        if (null != strAttribute && !"".equals(strAttribute)) {
