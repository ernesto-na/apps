...
public class XxGamMaFlightInf0EOImpl extends OAEntityImpl {
    ...
    public void postChanges(TransactionEvent transactionEvent) {
            ...
            if (ticketP != null && (ticketP.getPostState() == STATUS_NEW || ticketP.getPostState() == STATUS_MODIFIED)){
    ...
    protected void validateEntity(){
        String isValidate = (String)getOADBTransaction().getTransientValue("IsValidateEntityFlight");
    ...
    public boolean validateDepartureDate(Date data) {
        ...
        if (data.compareTo(dDateReturn) == -1 || data.compareTo(dDateReturn) == 0)
            isValido = true;
