...
public class XxGamAdvanceRequestVOImpl extends OAViewObjectImpl {
     ...
     *
     */
    public void executeQueryAdvanceReq(Number nUserId, String sOpcion, 
        ...
        XxGamMAnticiposUtil.debugMessage(XxGamConstantsUtil.DEBUG_DIAGNOSTICS_MODE, 
                                         ...
                                         pageContext, webBean);
        XxGamMAnticiposUtil.debugMessage(XxGamConstantsUtil.DEBUG_DIAGNOSTICS_MODE, 
                                         "Dup Session franchiseType AdvPG: " + 
                                         pageContext.getSessionValue("sfranchiseType"), 
                                         pageContext, webBean);
        XxGamMAnticiposUtil.debugMessage(XxGamConstantsUtil.DEBUG_DIAGNOSTICS_MODE, 
                                         "Dup Session Request AdvPG: " + 
        ...
        if (XxGamMAnticiposUtil.validatesResponsability(pageContext, webBean, 
            ...
            sClauseWhere = 
                    " NUMBER_PAYMENT like 'PF%' AND ORIGIN = '" + nvlFranchiseType + 
                    "'";
        }
