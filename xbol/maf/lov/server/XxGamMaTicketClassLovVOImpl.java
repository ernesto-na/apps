...
public class XxGamMaTicketClassLovVOImpl extends OAViewObjectImpl {
    ...
    void initTicketClass(String franchiseType) {
        ...
        if (null != franchiseType && !"".equals(franchiseType)) {
            vcRow.setAttribute("Tag", 
                               XxGamConstantsUtil.LIKE_OPEN + franchiseType + 
        ...
        while (hasNext()) {
            ...
            System.out.println(curTicketRate.getAttribute("Meaning") + " " + 
                               curTicketRate.getAttribute("Id") + " " + 
                               curTicketRate.getAttribute("Tag"));
        }
