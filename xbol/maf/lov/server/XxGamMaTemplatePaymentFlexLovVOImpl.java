...
public class XxGamMaTemplatePaymentFlexLovVOImpl extends OAViewObjectImpl
{
     ...
     */
    public void searchTemplatePaymentByFlex(Number templateId, String costCenterFlex){
     ...
     * @param costCenterFlex contiene el valor del centro de costo alterno
     */
    public void setSearchTemplatePaymentByFlexVc(Number templateId, String costCenterFlex){
  ...
  ************************/
                                        ...
                                        , String orgShortNameEmp)
  {
    ...
    System.out.println("Comienza searchTemplatePaymentByFlex 3 parametros Capa Lov Impl orgShortNameEmp:"+orgShortNameEmp); 
    ...
    if(costCenterFlex != null ){
        ...
        if(ccost.length == 2)
            try{
                ...
                System.out.println("Error al seteo de valores: " + e.getMessage().toString());
            }    
       }
    ...
    ******************************************************/
    ...
    if(null!=costCenterLoc && !"".equals(costCenterLoc)){
     ...
     while (hasNext()) {
            Row curPerson = next();
            System.out.println(curPerson.getAttribute("CostCenterFlex") + " " +curPerson.getAttribute("TemplateId")+" " +curPerson.getAttribute("UnidadOperativa"));
            }
     //clearViewCriterias();  
