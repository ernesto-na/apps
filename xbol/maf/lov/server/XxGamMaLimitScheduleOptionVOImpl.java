...
public class XxGamMaLimitScheduleOptionVOImpl extends OAViewObjectImpl {
    ...
    void searchLimitSchedule(Number templateId, Number typePayment, 
                             String typePaymentDesc, String currencyCode) {
        ...
        try {
            ...
            System.out.println("Exception from searchLimitSchedule " + 
        ...
        while (hasNext()) {
            ...
            System.out.println(curLimitAmount.getAttribute("ExpenseReportId") + 
                               " " + 
                               curLimitAmount.getAttribute("ParameterId") + 
                               " " + curLimitAmount.getAttribute("Prompt") + 
                               " " + 
                               curLimitAmount.getAttribute("CurrencyCode"));
            break;
        }
