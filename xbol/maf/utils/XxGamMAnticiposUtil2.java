...
public class XxGamMAnticiposUtil2 {
        ...
        if ((pageContext != null) && (webBean != null)) {
            ...
            if (amXxGamMod != null) {
                ...
                if (amLov != null) {
                    ...
                    OADBTransaction oadbtrans = 
                        (OADBTransaction)amXxGamMod.getTransaction();
                ...
                **/
                        ...
                        if (retval && (empPositionID != null)) {
                            pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                                         "Comienza  LovAMImpl.initApproverAltLov", 
                            ...
                            if (LovAMImpl != null) {
                                mapResult = 
                                        amXxGamMod.callProceduceGetPositionEmployee(empPositionID);
                                System.out.println("mapResult!=null" + 
                                                   mapResult != null);
                                if (mapResult != null) {
                                    jobNameId = 
                                            (Number)mapResult.get("jobNameId");
                                    versionId = 
                                            (Number)mapResult.get("versionId");
                                    System.out.println("jobNameId" + 
                                                       jobNameId);
                                    System.out.println("versionId" + 
                                                       versionId);
                                    isSuccessTmp = 
                                            LovAMImpl.initApproverAltLov(jobNameId, 
                                                                         versionId);
                                    System.out.println("isSuccessTmp" + 
                                                       isSuccessTmp);
                                    pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                                                 "Resulatado  LovAMImpl.initApproverAltLov: " + 
                                                                 isSuccessTmp, 
                                                                 OAFwkConstants.PROCEDURE);
                                }
                            }
                            ...
                            pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                                         "Finaliza  LovAMImpl.initApproverAltLov ", 
                                                         OAFwkConstants.PROCEDURE);
    ...
    public static String getOrgNameByPersonId(String responsibility, 
        ...
        OracleCallableStatement cs = 
            (OracleCallableStatement)oadbTransaction.createCallableStatement(stmt.toString(), 
                                                                             DBTransaction.DEFAULT);
        ...
        try {
            ...
            System.out.println("EXCEPTION FROM JAVA AL -->" + 
                               exception2.getMessage());
            pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                         "EXCEPTION FROM JAVA AL -->" + 
                                         exception2.getMessage(), 
                                         OAFwkConstants.PROCEDURE);
            throw OAException.wrapperException(exception2);
        }
    ...
    public static Map getMapMaCostCenterByPersonId(String responsibility, 
        ...
        if (errcodOUT.equals("0")) {
            ...
            String getData = errmsgOUT;
            String sURL = 
                XxGamConstantsUtil.URL_PAGE_OAF + "XxGamPaymentInitAdvancePG";
    ...
    public static String getOrgNameByUserId(int UserID, 
        ...
        if (errcodOUT.equals("0")) {
            ...
            pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                         "Exception XxGamMAnticiposUtil2.getOrgNameByPersonId", 
                                         OAFwkConstants.PROCEDURE);

            String sURLPaymentInitAdvancePG = 
                XxGamConstantsUtil.URL_PAGE_OAF + "XxGamPaymentInitAdvancePG";
            String sURLAdvanceConsultationPG = 
                XxGamConstantsUtil.URL_PAGE_OAF + "XxGamAdvanceConsultationPG";
            ...
            if (XxGamMAnticiposUtil.validatesResponsability(pageContext, 
                ...
                retval = "02_AEROVIAS";
                sURLAdvanceConsultationPG = 
                        sURLAdvanceConsultationPG + "&errcodOUT=" + errcodOUT;
                sURL = sURLAdvanceConsultationPG;
            } else {
                retval = null;
                sURLPaymentInitAdvancePG = 
                        sURLPaymentInitAdvancePG + "&errcodOUT=" + errcodOUT;
    ...
    public static boolean LaunchWfReservarFondos(Number requestId, 
        ...
        String wfItemKeyGET = 
            oadbTransaction.getSequenceValue("XXGAM_MA_NUMPAY_EMP_S").toString();
        ...
        if (ctxSET == null) {
            ...
            WFEngineAPI.createProcess((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                      itemTypeSET, wfItemKeyGET, WfProcessSET);
            // set item owner

            if (WFEngineAPI.setItemOwner((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                         itemTypeSET, wfItemKeyGET, 
                                         "SYSADMIN"))
            ...
            WFEngineAPI.setItemAttrNumber((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                          itemTypeSET, wfItemKeyGET, 
                                          "XXGAM_ITA_CC_ID", bigAttribute);

            WFEngineAPI.startProcess((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                     itemTypeSET, wfItemKeyGET);
    ...
    private static void setUpWfContext(OADBTransactionImpl oadbTransactionImpl) {
        ...
        Connection connection = 
            appsContextGET.getExtraJDBCConnection(wfdb, appsContextGET.getSessionId());
    ...
    public static boolean initTemplatePayment(OAPageContext pageContext, 
        ...
        OAMessageLovInputBean templatePaymentLovBean = 
            (OAMessageLovInputBean)webBean.findChildRecursive("TemplatePaymentLov");
        OAMessageLovInputBean templatePaymentFlexLovBean = 
            (OAMessageLovInputBean)webBean.findChildRecursive("TemplatePaymentFlexLov");
        ...
        if (costCenterFlex != null) {
            ...
            generalRow.setTypeTemplateDesc(null);
            isSuccess = 
                    XxGamMAnticiposUtil2.initTemplatePaymentFlexLov(pageContext, 
                                                                    webBean, 
                                                                    costCenterFlex);
        }
        ...
        if (costCenterId != null) {
            ...
            generalRow.setTypeTemplateDesc(null);
            isSuccess = 
                    XxGamMAnticiposUtil2.initTemplatePaymentLov(pageContext, 
                                                                webBean, 
                                                                costCenterId);
        }
    ...
    private static boolean initTemplatePaymentLov(OAPageContext pageContext, 
        ...
        pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                     "Inicia Utilitarios2 initTemplatePaymentLov", 
        ...
        if (paramorgNameEmp != null && !"".equals(paramorgNameEmp)) {
            ...
            System.out.println("paramorgNameEmp-->" + paramorgNameEmp);
            pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                         " Utilitarios2 initTemplatePaymentLov paramorgNameEmp-->" + 
                                         paramorgNameEmp, 
                                         OAFwkConstants.STATEMENT);
        }
        ...
        XxGamMaTemplatePaymentLovVOImpl templateImpl = 
            amLov.getXxGamMaTemplatePaymentLovVO1();
        ...
        if (orgShortNameEmp != null && !"".equals(orgShortNameEmp)) {
            if (templateImpl != null) {
                pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                             ...
                                             "Tambien se agrego una variable de enlace al query del View Object", 
                                             OAFwkConstants.STATEMENT);
    ...
    public static boolean setPaymentReqDescriptionsReadOnly(OAPageContext pageContext, 
        ...
        if (XxGamMAnticiposUtil.validatesResponsability(pageContext, webBean, 
            ...
            strRequestId = 
                    pageContext.getParameter(XxGamConstantsUtil.GENERAL_ID);
        } else {
            strRequestId = 
                    pageContext.getParameter(XxGamConstantsUtil.REQUEST_ID);
        }

        System.out.println("Capa Utilitarios2 setPaymentReqDescriptionsReadOnly strRequestId: " + 
                           strRequestId);
        System.out.println("Capa Utilitarios2 setPaymentReqDescriptionsReadOnly STATUS: " + 
        ...
        if (null == strRequestId) {
            if ("update".equals((String)pageContext.getTransactionValue(XxGamConstantsUtil.STATUS))) {
                strRequestId = 
                        (String)pageContext.getTransactionValue("StrRequestIdUpdate");
            }
        ...
        if (strRequestId != null && !(strRequestId.equals(""))) {
            ...
            OADBTransaction oadbtrans = 
                (OADBTransaction)ModAntAMImpl.getTransaction();
            OracleCallableStatement cs = 
                (OracleCallableStatement)oadbtrans.createCallableStatement(stmt.toString(), 
                                                                           DBTransaction.DEFAULT);
    ...
    public static boolean callWorkFlowToSendConfirmationOfficeTicket(OAPageContext pageContext, 
        ...
        if (ctxSET == null) {
            ...
            if (XxGamMAnticiposUtil.validatesResponsability(pageContext, 
                ...
                wfItemKeyGET = 
                        oadbTransaction.getSequenceValue("XXGAM_MA_WF_S").toString();
                ...
                if (WFEngineAPI.setItemOwner((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                    ...
                    System.out.println("Set Item Owner: " + 
                                       pageContext.getUserName());
                }

                if (WFEngineAPI.setItemUserKey((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                               itemTypeSET, wfItemKeyGET, 
                                               pageContext.getUserName())) {
                    System.out.println("Set Item User Key:" + 
                                       pageContext.getUserName());
                }
                ...
                WFEngineAPI.setItemAttrNumber((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                              itemTypeSET, wfItemKeyGET, 
                                              "ANTICIPO_ID", bigAttribute);

                bigAttribute = new BigDecimal(employeeIdToStr);
                WFEngineAPI.setItemAttrNumber((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                              itemTypeSET, wfItemKeyGET, 
                                              "EMPLEADO_ID", bigAttribute);

                bigAttribute = new BigDecimal(approverIdToStr);
                WFEngineAPI.setItemAttrNumber((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                              itemTypeSET, wfItemKeyGET, 
                                              "APROBADOR_ID", bigAttribute);

                WFEngineAPI.setItemAttrText((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                            itemTypeSET, wfItemKeyGET, "RUTA", 
                                            routes);
        ...
        **/
                ...
                System.out.println("Antes operador Ternario ApproverId:" + 
                                   approverIdToStr + "\n ApproverAltId:" + 
                                   approverAltIdToStr);
                approverIdToStr = 
                        (null != approverAltIdToStr) ? approverAltIdToStr : 
                        approverIdToStr;
                // NVL (l_approver_alt_id, p_aprobador_id));
                System.out.println("Depues Operador Ternario ApproverId:" + 
                                   approverIdToStr + "\n ApproverAltId:" + 
                                   approverAltIdToStr);
    ...
    public static boolean setOriginApproverInGeneralUpdate(OAPageContext pageContext, 
                                                           OAWebBean webBean) {
        pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                     "Comienza XxGamMAnticiposUtil2.setOriginApproverInGeneralUpdate", 
                                     OAFwkConstants.PROCEDURE);
        ...
        if ((pageContext != null) && (webBean != null)) {
            ...
            if (amXxGamMod != null) {
                ...
                if (amLov != null) {
                    pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                                 "Comienza XxGamMAnticiposUtil2.setOriginApproverInGeneralUpdate --> amXxGamMod.setAppproverByHierarchy ", 
                                                 OAFwkConstants.PROCEDURE);
                    ...
                    if ("0" != errcodOUT) {
                            ...
                            if (LovAMImpl != null) {
                                ...
                                if (mapResult != null) {
                                    ...
                                    isSuccessTmp = 
                                            LovAMImpl.initApproverAltLov(jobNameId, 
                                                                         versionId);
                                    System.out.println("isSuccessTmp LovAMImpl.initApproverAltLov(jobNameId, versionId); " + 
                                                       isSuccessTmp);
                                    pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                                                 "Resulatado  LovAMImpl.initApproverAltLov: " + 
                                                                 versionId, 
                        ...
                        pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                                     "Exception XxGamMAnticiposUtil2.setOriginApproverInGeneralUpdate", 
                                                     OAFwkConstants.PROCEDURE);
                  ...
                  **/
                        ...
                        pageContext.putTransactionValue("errcodOUT", 
                                                        errcodOUT);
                        pageContext.putTransactionValue("errmsgOUT", 
                                                        errmsgOUT);
        ...
        pageContext.writeDiagnostics(XxGamMAnticiposUtil2.class, 
                                     "Finaliza XxGamMAnticiposUtil2.setOriginApproverInGeneralUpdate", 
                                     OAFwkConstants.PROCEDURE);
        ...
        if ((pageContext != null) && (webBean != null)) {
            ...
            if (am != null) {
                ...
                responsabilityId = 
                        new Number(pageContext.getResponsibilityId());
                isSuccess = 
                        am.initCostCenterFlexUpdate(responsabilityId, pageContext, 
                                                    webBean);
            }
        }
        return isSuccess;
    ...
    public static Map getLimitScheduleOption(OAPageContext pageContext, 
        ...
        if (null != amLov) {
            ...
            limitScheduleOption = 
                    amLov.getLimitScheduleOption(pageContext, webBean, 
                                                 templateId, typePayment, 
                                                 typePaymentDesc, 
                                                 currencyCode);
            if (null != limitScheduleOption) {
                System.out.println("\"Rate\": " + 
                                   limitScheduleOption.getRate());
                rateLimit = limitScheduleOption.getRate();
                retval.put("Rate", rateLimit);
            } else {
                retval.put("errcodOUT", "1");
                retval.put("errmsgOUT", 
                           "A Ocurrido una Exeption al obtener el limite para el Schedule");
            }
        }
    ...
    static boolean callWorkFlowToCancelTicketsOffice(OAPageContext pageContext, 
        ...
        if (ctxSET == null) {
            ...
            if (WFEngineAPI.setItemOwner((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                         itemTypeSET, wfItemKeyGET, 
                                         pageContext.getUserName())) {
                System.out.println("CallCancelWF Set Item Owner: " + 
                                   pageContext.getUserName());
            }
            ...
            if (WFEngineAPI.setItemUserKey((WFContext)oadbTransactionImpl.findObject("wfContext"), 
                                           itemTypeSET, wfItemKeyGET, 
                                           pageContext.getUserName())) {
                System.out.println("CallCancelWF Set Item User Key:" + 
                                   pageContext.getUserName());
            }
    ...
    public static String getDivisa(OAPageContext pageContext, 
                                   OAWebBean webBean) {
        ...
        OADBTransaction dbTransaction = 
            (OADBTransaction)amXxGamModAnt.getTransaction();
        OracleCallableStatement CallProcedure = 
            (OracleCallableStatement)dbTransaction.createCallableStatement(procedure.toString(), 
                                                                           1);
     ...
     */
    public static String getDivisaDesc(OAPageContext pageContext, 
                                       OAWebBean webBean) {
    ...
    String get_kind_Employee(OAPageContext pageContext, OAWebBean webBean) {
