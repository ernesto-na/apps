...
public class CcManagementValidation {
    ...
    public CcManagementValidation(OAPageContext pageContext, 
                                  OAWebBean webBean) {
        ...
        if (null != ModAntAM) {
            ...
            if (null != GeneralReqVoImpl) {
                ...
                GeneralReqVoRowImpl = 
                        (XxGamMaGeneralReqVORowImpl)GeneralReqVoImpl.getCurrentRow();
                if (null != GeneralReqVoRowImpl) {
                    ...
                    System.out.println("Debug CMV-AHH 5: Set CcEmployee " + 
                                       GeneralReqVoRowImpl.getCostCenterFlex());
                    if (null != GeneralReqVoRowImpl.getCostCenterFlex()) {

                        System.out.println("IndexOF: " + 
                                           GeneralReqVoRowImpl.getCostCenterFlex().indexOf("-"));

                        setCcEmployee(Integer.parseInt(GeneralReqVoRowImpl.getCostCenterFlex().substring(0, 
                                                                                                         GeneralReqVoRowImpl.getCostCenterFlex().indexOf("-"))));
                        System.out.println("Debug CMV-AHH 6: Get CcEmployee " + 
                                           getCcEmployee());

                        System.out.println("Debug CMV-AHH 7: ApproverAltId " + 
                                           GeneralReqVoRowImpl.getApproverAltId());
                        if (null != GeneralReqVoRowImpl.getApproverAltId()) {
                            setApproverAltId(GeneralReqVoRowImpl.getApproverAltId().intValue());
                            setCcApproverAlt(findCcValueByPersonId(ModAntAM, 
                                                                   getApproverAltId()));
                            System.out.println("Debug CMV-AHH 8: find Cc Value " + 
                                               getCcApproverAlt());
                        } else {
    ...
    public int findCcValueByPersonId(XxGamModAntAMImpl pModAntAM, 
                                     int pPersonId) {
        ...
        OADBTransaction oadbtrans = 
            (OADBTransaction)pModAntAM.getTransaction();
        ...
        try {
            ...
            System.out.println("Debug CMV-AHH 001: pni_person_id: " + 
                               pPersonId);
            System.out.println("Debug CMV-AHH 001: pno_cc_value: " + 
                               cs.getInt(2));
            System.out.println("Debug CMV-AHH 001: pso_errmsg: " + 
                               cs.getString(3));
            System.out.println("Debug CMV-AHH 001: pso_errcod: " + 
                               cs.getString(4));
    ...
    public boolean doManagementValidation(XxGamModAntAMImpl pModAntAM, 
                                          int pCcEmployee, int pCcApproverAlt, 
                                          int pApproverAltId) {
        ...
        try {
            ...
            System.out.println("Debug CMV-AHH 002: pni_cc_employee: " + 
                               pCcEmployee);
            System.out.println("Debug CMV-AHH 002: pni_cc_approver_alt: " + 
                               pCcApproverAlt);
            System.out.println("Debug CMV-AHH 002: pni_approver_alt_id: " + 
                               pApproverAltId);
            System.out.println("Debug CMV-AHH 002: pbo_cc_management_flag: " + 
                               cs.getString(4));
            System.out.println("Debug CMV-AHH 002: pso_errmsg: " + 
                               cs.getString(5));
            System.out.println("Debug CMV-AHH 002: pso_errcod: " + 
                               cs.getString(6));
