...
public class XxGamMaBlankPageCO extends OAControllerImpl
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    if(pageContext != null && webBean != null){
        ...
        msgError = pageContext.getParameter(XxGamConstantsUtil.LOAD_PAGE_MSG_ERROR);
        ...
        if(msgError != null){
         if("InvalidRespTicketPG".equals(msgError)){
             ...
             throw new OAException(msgError,
                                 OAException.ERROR);
         }
       }
      msgNoDataFoundPersonId = pageContext.getParameter("NoDataFoundPersonId");
      if(null!=msgNoDataFoundPersonId){
      System.out.println("msgNoDataFoundPersonId: " + msgNoDataFoundPersonId);
        throw new OAException(msgNoDataFoundPersonId,
                              OAException.ERROR);
      }
      
      msgNoDataFoundGP = pageContext.getParameter("NoDataFoundPG");
      if(null!=msgNoDataFoundGP&&"NoDataFoundGeneralPage".equals(msgNoDataFoundGP)){
        throw new OAException(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL,
                                          XxGamAOLMessages.GenericType.XXGAM_MAF_REQ_NF_ERROR,
                                          null, OAException.ERROR, null);
      }
      
      msgNoPersonTypeValid = pageContext.getParameter("NoPersonTypeValid");
      if(null!=msgNoPersonTypeValid){
        System.out.println("msgNoPersonTypeValid: " + msgNoPersonTypeValid);
        throw new OAException(msgNoPersonTypeValid,
                                OAException.ERROR);
      }  
