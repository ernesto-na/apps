...
public class XxGamAdvanceConsultationCO extends OAControllerImpl {
    ...
    private void searchAdvanceConsultantion(OAPageContext pageContext, 
        ...
        //Numero de anticipo
        advanceNum = pageContext.getParameter(XxGamConstantsUtil.ADVANCE_NUM);
        //Nombre del empleado
        employeeName = 
                pageContext.getParameter(XxGamConstantsUtil.EMPLOYEE_NAME);

        //Nombre del aprovador
        nameApproverByH = pageContext.getParameter("ApproverAllHierarchyLov");
        ...
        //Inicia la busqueda.
        XxGamMAnticiposUtil.searchAdvanceConsultantion(pageContext, webBean, 
                                                       advanceNum, 
                                                       employeeName, 
                                                       nameApprover, 
                                                       costCenter, 
    ...
    private void setForwardWhitParameters(OAPageContext pageContext, 
        ...
        //Busca el registro
        boolean foundReq = 
            XxGamMAnticiposUtil.searchRequest(pageContext, webBean, requestId);
...
XxGamConstantsUtil.URL_PAGE_OAF + XxGamConstantsUtil.XX_GAM_PAYMENT_REQ_INFO_GENERAL_PG;
    ...
    private void msgLoadPageProcess(OAPageContext pageContext, 
        ...
        if (pageContext != null && webBean != null) {
            ...
            if (!"0".equals(localErrcodOUT) && (null != localErrcodOUT)) {
                ...
                throw new OAException("No se Ha encontrado organizacion para este empleado", 
                                      OAException.ERROR);
            }
    ...
    private void validarLOV(OAPageContext pageContext, OAWebBean webBean) {
        ...
        if (null != operatingUnit && !"".equals(operatingUnit)) {
            ...
            OperatingUnitLovVO = 
                    (XxGamMaOperatingUnitLovVOImpl)AntLovAMImpl.getXxGamMaOperatingUnitLovVO1();
        ...
        if (null != operatingUnit && !"".equals(operatingUnit)) {
            if (!searchOperatingUnit) {
                String getData = 
                    "Eliga un valor valido para la lista de valores Operating Unit";
