...
public class XxGamPaymentReqTicketCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        if (pageContext != null && webBean != null) {
            ...
            Number flightIdNumber = null;*/
                ...
                messageRadioElectronic = 
                        (OAMessageRadioButtonBean)webBean.findIndexedChildRecursive("TypeEmissionElectronico");
                messageRadioPresencial = 
                        (OAMessageRadioButtonBean)webBean.findIndexedChildRecursive("TypeEmissionPresencial");
            ...
            flightIdNumber = XxGamMAnticiposUtil.converteNumber(flightId);
                ...
                System.out.println("FormSubmissionBug3: " + 
                                   pageContext.getParameter(XxGamConstantsUtil.BUTTON_NO));
                System.out.println("FormSubmissionBug3.1: " + 
                                   pageContext.getParameter(XxGamConstantsUtil.BUTTON_YES));
                System.out.println("FormSubmissionBug4: " + 
                ...
                if (null != FirePartialEvent) {
                    if (FirePartialEvent.equals(XxGamConstantsUtil.CANCEL) || 
                        FirePartialEvent.equals(XxGamConstantsUtil.SEND_CONFIRMATION) || 
                        FirePartialEvent.equals(XxGamConstantsUtil.CANCEL_REQUEST)) {
                        if (null == strEventButtonYes) {
                            XxGamMAnticiposUtil.cleanTickestValues(pageContext, 
                                                                   webBean);
                        }
                    }
                }
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        String Ticket_Office = 
            pageContext.getParameter("TicketOfficeDescription");
    ...
    private void checkEvents(OAPageContext pageContext, OAWebBean webBean) {
        ...
        responsibility = 
                pageContext.getResponsibilityName(); //"GAM_ANTICIPOS_AUDITOR";//pageContext.getResponsibilityName();
        String sURL = null;
        ...
        if ("delete41".equals(pageContext.getParameter(EVENT_PARAM))) {
            ...
            nInfoPasajeroId = 
                    XxGamMAnticiposUtil.converteNumber(sInfoPasajeroId);
...
pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
        ...
        ***************************************************************************/
        ...
        if (XxGamConstantsUtil.CANCEL.equals(pageContext.getParameter(EVENT_PARAM))) {
            ...
            String msg = 
                pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                       XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_CANCEL_QN, 
                                       null);
        ...
        if (XxGamConstantsUtil.SEND_CONFIRMATION.equals(pageContext.getParameter(EVENT_PARAM))) {
            ...
            XxGamMAnticiposUtil.validateTicketsSendConfirmation(pageContext, 
                                                                webBean);

            java.util.Hashtable params = new java.util.Hashtable(1);
            params.put(XxGamConstantsUtil.SEND_CONFIRMATION, 
                       XxGamConstantsUtil.SEND_CONFIRMATION);
            String msg = 
                pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                       XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_SEND_C_QN, 
                                       null);
            XxGamMAnticiposUtil.setMessageDialog(pageContext, msg, 
                                                 OAException.INFORMATION, 
                                                 params);
        ...
        if (XxGamConstantsUtil.CANCEL_REQUEST.equals(pageContext.getParameter(EVENT_PARAM))) {
            ...
            java.util.Hashtable params = new java.util.Hashtable(1);
            params.put(XxGamConstantsUtil.SEND_CONFIRMATION, 
                       XxGamConstantsUtil.CANCEL_REQUEST);
            String msg = 
                pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                       XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_SEND_X_QN, 
                                       null);
            XxGamMAnticiposUtil.setMessageDialog(pageContext, msg, 
                                                 OAException.INFORMATION, 
                                                 params);
        ...
        if (XxGamConstantsUtil.SEND.equals(pageContext.getParameter(EVENT_PARAM))) {
            ...
            isRegisterPassengers = 
                    XxGamMAnticiposUtil.isRegisterPassengers(pageContext, 
                                                             webBean, 
            ...
            if (!isRegisterPassengers) {
                ...
                OAException localOAException = 
                    new OAException(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                    XxGamAOLMessages.Validation.XXGAM_OIE_NODATAF_PASSENGERS, 
                                    arrayOfMessageToken, OAException.ERROR, 
                                    null);
                OADialogPage localOADialogPage = 
                    new OADialogPage(OAException.ERROR, localOAException, null, 
                                     "", null);
                ...
                java.util.Hashtable params = new java.util.Hashtable(1);
                params.put(XxGamConstantsUtil.SEND_CONFIRMATION, 
                           XxGamConstantsUtil.SEND);
                String msg = 
                    pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                           XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_SEND_QN, 
                                           null);
                XxGamMAnticiposUtil.setMessageDialog(pageContext, msg, 
                                                     OAException.INFORMATION, 
                                                     params);
                ...
                if (XxGamConstantsUtil.SEND_CONFIRMATION.equals(fromConfirm)) {
                    ...
                    if (XxGamMAnticiposUtil.isRegisteredFolio(pageContext, 
                        ...
                        if (errorMsg == null) {
                            ...
                            isSuccess = 
                                    callWorkFlowOfficeTicket(pageContext, webBean);
                            if (isSuccess) {
                                System.out.println("***OptionYesException27");
                                msgConfirm = 
                                        pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                               XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_FOLIO_SAVE, 
                                                               null);
                            } else {
                                System.out.println("***OptionYesException28");
                                errorMsg = 
                                        pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                               XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_SAVE_NOTF_ERR, 
                                                               null);
                            }
                        } else {
...
XxGamConstantsUtil.URL_PAGE_OAF + XxGamConstantsUtil.XX_GAM_A_TICKET_CONSULTATION;
                    ...
                    if (XxGamConstantsUtil.SEND.equals(fromConfirm)) {
                        ...
                        if (isRegisteredFlight) {
                            ...
                            String msgLoadPage = null;
                            isSuccess = 
                                    XxGamMAnticiposUtil.setNumberPayment(pageContext, 
                                                                         webBean);
                            if (isSuccess) {
                                    ...
                                    if (isSuccess) {
                                        ...
                                        if (errorMsg == null) {
                                            ...
                                            if (!isSuccess) {
                                                ...
                                                msgLoadPage += 
                                                        ". " + pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                                                      XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_NOTF_ERROR, 
                                                                                      null);
                                            } else {
                                                System.out.println("***OptionYesException47");
                                                msgLoadPage += 
                                                        ". " + pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                                                      XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_NOTF_INFO, 
                                                                                      null);
                                            }
                                            hmap.put(XxGamConstantsUtil.LOAD_PAGE_MSG_INFO, 
                                                     msgLoadPage);
...
XxGamConstantsUtil.URL_PAGE_OAF + XxGamConstantsUtil.XX_GAM_INIT_PAGE;
                        ...
                        if (XxGamConstantsUtil.CANCEL_REQUEST.equals(fromConfirm)) {
                            ...
                            System.out.println("***OptionYesxxflightId: " + 
                                               flightId + " ***");
                            if (flightId == null) {
                            ...
                            flightIdNumber = 
                                    XxGamMAnticiposUtil.converteNumber(flightId);
                            System.out.println("***OptionYesxxflightIdNumber: " + 
                                               flightIdNumber + " ***");
                            ...
                            if (null == errorMsg) {
                                ...
                                isSuccesCancelWf = 
                                        callWorkFlowToCancelTickets(pageContext, 
                                                                    webBean);
                                if (isSuccesCancelWf) {
                                    msgConfirm = 
                                            "La cancelacion de boletos ha sido procesada";
                                } else {
                                    errorMsg = 
                                            "A ocurrido una excepcion al procesar la cancelacion de boletos";
                                }

                            } else {
                                errorMsg = 
                                        "A ocurrido una excepcion al slavar los cambios en una cancelacion de Boletos";
                            }
...
XxGamConstantsUtil.URL_PAGE_OAF + XxGamConstantsUtil.XX_GAM_PAYMENT_REVIEW;
                    ...
                    if (XxGamConstantsUtil.CREATE.equals(accessForm) || 
                        XxGamConstantsUtil.UPDATE.equals(accessForm)) {
...
XxGamConstantsUtil.URL_PAGE_OAF + XxGamConstantsUtil.XX_GAM_PAYMENT_REQ_INFO_GENERAL_PG;
                    ...
                    String typeRequest = 
                        (String)pageContext.getTransactionValue(XxGamConstantsUtil.TYPE_REQUEST_TICKET);
                    if (typeRequest != null && 
                        XxGamConstantsUtil.REQUEST_TYPE_ADVANCE.equals(typeRequest)) {
                        System.out.println("***Exception72");
                        sURL = 
XxGamConstantsUtil.URL_PAGE_OAF + XxGamConstantsUtil.XX_GAM_PAYMENT_REVIEW;
                    } else {
                        if (typeRequest != null && 
                            XxGamConstantsUtil.REQUEST_TYPE_FRANCHISE.equals(typeRequest)) {
...
XxGamConstantsUtil.URL_PAGE_OAF + XxGamConstantsUtil.XX_GAM_PAYMENT_REQ_INFO_GENERAL_PG;
        ...
        if (pageContext.getParameter(XxGamConstantsUtil.BUTTON_NO) != null) {
        ...
        if (XxGamMAnticiposUtil.validatesResponsability(pageContext, webBean, 
            ...
            if (XxGamConstantsUtil.CREATE.equals(accessForm)) {
                ...
                if (XxGamConstantsUtil.UPDATE.equals(accessForm)) {
                    ...
                    XxGamMAnticiposUtil.setValidatesAllDatesFlight(pageContext, 
                                                                   webBean, 
                                                                   XxGamConstantsUtil.REQUEST_TYPE_ADVANCE);
                    ...
                    System.out.println("***Bug510: previo***");
            ...
            String typeRequest = 
                pageContext.getParameter(XxGamConstantsUtil.TYPE_REQUEST_TICKET); // add by DIHU (CCT) 21-Oct-2014
            if (typeRequest != null)
                pageContext.putTransactionValue(XxGamConstantsUtil.TYPE_REQUEST_TICKET, 
                                                typeRequest); // add by DIHU (CCT) 21-Oct-2014
            else
                requestType = 
                        (String)pageContext.getTransactionValue(XxGamConstantsUtil.TYPE_REQUEST_TICKET); // ADD BY DIHU ONLY FOR TEST
            ...
            if (getRequestType() != null && 
                ...
                try {
                    ...
                    errorMsg = 
                            pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                   XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_REQ_NF_ERROR, 
                                                   null);
                }
                ...
                try {
                    ...
                    errorMsg = 
                            pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                   XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_FOLIO_NF_ERROR, 
                                                   null);
                    folio = null;
                }
                ...
                if (true) { //if (folio == null || folio != null && folio.equals("")) {
                  ...
                  */
                    ...
                    if ("CAN".equals(statusNotiCode) || folio != null || 
                        folio == "0") {
                    ...
                    if (folio != null && !folio.equals("") || 
                        "CAN".equals(statusNotiCode) || folio == "0") {
                ...
                } else if (folio != null && !folio.equals("") || 
                           "CAN".equals(statusNotiCode) || folio == "0") {
                    //LISTO
                ...
                XxGamMAnticiposUtil.setPasajerosInfo(pageContext, webBean, 
                                                     generalId, null, ticketId, 
                                                     getRequestType());

                boolean isNewFranchise = false;
                String estatusBoletos = null;
                isNewFranchise = 
                        XxGamMAnticiposUtil.validateOldNewFranchise(pageContext, 
                                                                    webBean, 
                                                                    generalId, 
                                                                    null, 
                                                                    ticketId, 
               ...
               */
                if (!isNewFranchise) {
                    try {
                        ...
                        errorMsg = 
                                pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                       XxGamAOLMessages.GenericType.XXGAM_MAF_TKT_FOLIO_NF_ERROR, 
                                                       null);
                        System.out.println("EXCEPCION al " + 
                    ...
                    estatusBoletos = 
                            XxGamMAnticiposUtil.getEstatusFoliosTickets(pageContext, 
                                                                        webBean, 
                                                                        getRequestType());
                    System.out.println("***GetFoliosTicketsBug2***: " + 
                                       estatusBoletos);
                }
                ...
                if (true) { //if (folio == null || (folio != null && "".equals(folio))) { 
                    ...
                    String NotiCode = pageContext.getParameter("StatusNotCod");
                    System.out.println("***statusNotiCode3: " + 
                                       statusNotiCode + " ***");
                    ...
                    if ("CAN".equals(statusNotiCode) || folio != null || 
                        ...
                        if ("AlMenosUnBoletoCancelado".equals(estatusBoletos) || 
                            "AlMenosUnBoletoAsociado".equals(estatusBoletos)) {
                    ...
                    if ("CAN".equals(statusNotiCode) || folio == "0") {
                        ...
                        if ("AlMenosUnBoletoCancelado".equals(estatusBoletos) || 
                            ...
                            mtib = 
(OAMessageTextInputBean)webBean.findIndexedChildRecursive("TicketNumberItem411");
                            if (null != mtib) {
                ...
                msgError = 
                        pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                               XxGamAOLMessages.Validation.XXGAM_MAF_ACCESS_TR_ND_ERROR, 
                                               null);
            ...
            if (requestType != null)
                pageContext.putTransactionValue(XxGamConstantsUtil.TYPE_REQUEST_TICKET, 
                                                requestType); // add by DIHU (CCT) 21-Oct-2014
            else
                requestType = 
                        (String)pageContext.getTransactionValue(XxGamConstantsUtil.TYPE_REQUEST_TICKET); // ADD BY DIHU ONLY FOR TEST
            ...
            if (XxGamConstantsUtil.CREATE.equals(accessForm)) {
               ...
               **************************************************************/
                ...
                try {
                    requestId = 
                            new Number(pageContext.getParameter(XxGamConstantsUtil.REQUEST_ID));
                    ticketId = 
                            XxGamMAnticiposUtil.getTicketId(pageContext, webBean, 
                                                            requestId);
                } catch (SQLException e) {
                    errorMsg = 
                            pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
            ...
            hParameters.put(XxGamConstantsUtil.LOAD_PAGE_MSG_ERROR, 
                            "InvalidRespTicketPG");
            String sURL = 
                urlBase + "XxGamMaBlankPagePG"; //  not necessary with KEEP_MENU_CONTEXT
                // No need to specify since weï¿½re keeping menu context
                //retain AM 
    ...
    private boolean callWorkFlowOfficeTicket(OAPageContext pageContext, 
        ...
        try {
            ...
            dataForWorkFlow = 
                    XxGamMAnticiposUtil.getDataForWorkFlowOffieceTicket(pageContext, 
                                                                        webBean);
            if (dataForWorkFlow != null) {
                ...
                isSuccess = 
                        XxGamMAnticiposUtil2.callWorkFlowToSendConfirmationOfficeTicket(pageContext, 
                                                                                        webBean, 
                                                                                        dataForWorkFlow);
            }
        } catch (Exception e) {
    ...
    private void OnlyReadDataForAdvance(OAWebBean webBean) {
        ...
        XxGamMAnticiposUtil.setRenderedComponent(webBean, 
                                                 "XxGamMaPasajerosInfoVO411", 
                                                 false);
        XxGamMAnticiposUtil.setRenderedComponent(webBean, "numBolTableLayout", 
                                                 false);
        /**   Final ocultar nuevas regiones **/
    }
    ...
    private boolean validateDates(OAPageContext pageContext, 
        ...
        if (pageContext != null && webBean != null) {
            ...
            if (rowRef != null) {
                ...
                isValid = 
                        XxGamMAnticiposUtil.validateNotLessCurrentDateFlightFromPage(pageContext, 
                                                                                     webBean, 
                                                                                     rowRef);
                if (isValid) {
                    isValid = 
    ...
    private boolean callWorkFlowToCancelTickets(OAPageContext pageContext, 
        ...
        try {
            isSuccess = 
                    XxGamMAnticiposUtil.callWorkFlowToCancelTickets(pageContext, 
                                                                    webBean);
    ...
    public void getRenderedFilialFields(OAPageContext pageContext, 
        ...
        int exists = 
            XxGamMAnticiposUtil.callFunctionExistsFilial(pageContext, webBean, 
                                                         filial);
        ...
        { "Filial", "ClassPass", "TotalAmount", "AmountDiscount", "Tax", 
          ...
          "Filial61", "ClassPass61", "TotalAmount61", "AmountDiscount61", 
          "Tax61", "ClassPassFV", "DiscountRateFV", "AmountDiscountFV" };
