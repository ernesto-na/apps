...
public class XxGamPaymentReqInfoGeneralCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        if (!pageContext.isFormSubmission()) {
            ...
            if (null != pageContext.getSessionValue("sfranchiseType") && 
                !"".equals(pageContext.getSessionValue("sfranchiseType"))) {
                pageContext.putParameter("pfranchiseType", 
                                         pageContext.getSessionValue("sfranchiseType"));
            }
            if (null != pageContext.getSessionValue("sRequest") && 
                !"".equals(pageContext.getSessionValue("sRequest"))) {
        ...
        if (pageContext != null && webBean != null) {
            ...
            pageContext.writeDiagnostics(this, 
                                         "Capa CO processRequest getOrgName-->" + 
                                         getOrgName, OAFwkConstants.STATEMENT);

            if (getOrgName == null) {
                getOrgName = 
                        XxGamMAnticiposUtil2.getOrgNameByUserId(pageContext.getUserId(), 
                                                                pageContext, 
                                                                pageContext.getApplicationModule(webBean).getOADBTransaction(), 
                                                                webBean);
                pageContext.putTransactionValue("orgNameEmp", getOrgName);
            ...
            String step1Flag = 
                //--> la primera vez que lanza el error este dato viene null posteriormente biene como create
                (String)pageContext.getTransactionValue(XxGamConstantsUtil.VIEW_STEP_ONE);

            //Verifica la responsabilidad de empleado
                ...
                if (XxGamConstantsUtil.CREATE.equals(pageContext.getTransactionValue(XxGamConstantsUtil.STATUS))) {
                    ...
                    if (step1Flag == null) {
                        ...
                        if (isErrorInit) {
                            ...
                            isErrorInit = 
                                    XxGamMAnticiposUtil2.setOriginApproverInGeneral(pageContext, 
                                                                                    webBean);

                            if (!isErrorInit) {
                                msgErrorApprover = 
                                        pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                               XxGamAOLMessages.Validation.XXGAM_MAF_APPROVER_NF_ERROR, 
                                                               null);
                            }
                        }
                        if (!isErrorInit) {
                            ...
                            msgError = 
                                    pageContext.getMessage(XxGamAOLMessages.GenericType.SHORT_NAME_XBOL, 
                                                           ...
                                                           null);
                            msgErroraux = 
                                    pageContext.getParameter("ErrorEspecifico");
                            if (msgErrorApprover != null) {
                                msgError += ". " + msgErrorApprover;
                                msgErroraux = 
                                        pageContext.getParameter("ErrorEspecificoAp");
                                 ...
                                 */
                                if (pageContext.getParameter("ErrorEspecificoAp") != 
                                    null && 
                                    !"".equals(pageContext.getParameter("ErrorEspecificoAp").toString().trim()))
                                    msgError += ". " + msgErroraux;
                            }
                            /* Add by DIHU (CCT) 17-Oct-2014
                             * Se agrego un codigo al final de la cadena con la finalidad de identificar el error de forma mas especifica.
                             */
                            if (pageContext.getParameter("ErrorEspecifico") != 
                                null && 
                                !"".equals(pageContext.getParameter("ErrorEspecifico").toString().trim()))
                                msgError += ". " + msgErroraux;

                            hmap.put(XxGamConstantsUtil.LOAD_PAGE_MSG_ERROR, 
                                     msgError);
                            System.out.println(" Descripcion del error en la pantalla de informacion general " + 
                                               msgError);
                    ...
                    if (XxGamConstantsUtil.UPDATE.equals(pageContext.getTransactionValue(XxGamConstantsUtil.STATUS))) {
                        if (step1Flag == null) {
                            ...
                            StrRequestIdUpdate = 
                                    pageContext.getParameter("requestId");
                            if (null != StrRequestIdUpdate && 
                                "" != StrRequestIdUpdate) {
                                pageContext.putTransactionValue("StrRequestIdUpdate", 
                                                                StrRequestIdUpdate);
                            }
                            /******************/
                            ...
                            if (isEditable) {
                                ...
                                isInitSuccess = 
                                        XxGamMAnticiposUtil2.setOriginApproverInGeneralUpdate(pageContext, 
                                                                                              webBean);
     ...
     */
    private static Boolean validaCuenta(OAPageContext pageContext, 
                                        OAWebBean webBean) throws SQLException {
        System.out.println("Inicio del metodo valida cuenta");
        String MyValue = "My Value";
        OAMessageLovInputBean text = 
            (OAMessageLovInputBean)webBean.findChildRecursive("PurposeLov");
        OAMessageLovInputBean templateLov = 
            (OAMessageLovInputBean)webBean.findChildRecursive("TemplatePaymentLov");
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if (null != strEvntContBttn) {
            if (strEvntContBttn.equals("goto")) {
                ...
                //Added
                OAMessageStyledTextBean ccMSTextBean = 
                    (OAMessageStyledTextBean)webBean.findChildRecursive("CostCenterDescRO");
                OAMessageStyledTextBean ccaMSTextBean = 
                    (OAMessageStyledTextBean)webBean.findChildRecursive("CostCenterFlexRO");
                OAMessageStyledTextBean temMSTextBean = 
                    (OAMessageStyledTextBean)webBean.findChildRecursive("TemplateDescRO");
                OAMessageStyledTextBean ppMSTextBean = 
                    (OAMessageStyledTextBean)webBean.findChildRecursive("PurposeDescRO");
                String paramPurpose = null;
                paramPurpose = 
                        ppMSTextBean.getValue(pageContext).toString().toUpperCase();
                ...
                System.out.println("CC: " + 
                                   ccMSTextBean.getValue(pageContext));
                System.out.println("CCA: " + 
                                   ccaMSTextBean.getValue(pageContext));
                System.out.println("TEMPLATE: " + 
                                   temMSTextBean.getValue(pageContext));

                if (ccaMSTextBean.getValue(pageContext) != null) {
                    /**AHH 29Jul2015  patValue = ((String)ccaMSTextBean.getValue(pageContext)).substring(0,6); **/
                    if (((String)ccaMSTextBean.getValue(pageContext)).length() == 
                        11) {
                        patValue = 
                                ((String)ccaMSTextBean.getValue(pageContext)).substring(0, 
                                                                                        6) + 
                                "_" + 
                                ((String)ccaMSTextBean.getValue(pageContext)).substring(7, 
                                                                                        ((String)ccaMSTextBean.getValue(pageContext)).length());
                    } else {
                        patValue = "-1";
                    }
                } else {
                    /** patValue = ((String)ccMSTextBean.getValue(pageContext)).substring(0,6); Valicacion Ubicacion y CC**/
                    if (((String)ccMSTextBean.getValue(pageContext)).length() == 
                        11) {
                        patValue = 
                                ((String)ccMSTextBean.getValue(pageContext)).substring(0, 
                                                                                       6) + 
                                "_" + 
                                ((String)ccMSTextBean.getValue(pageContext)).substring(7, 
                                                                                       ((String)ccMSTextBean.getValue(pageContext)).length());
                    } else {
                        patValue = "-1";
                    }
                ...
                if (!"-1".equals(patValue) && (null != patValue)) {
                    ...
                    mat = 
pat.matcher((CharSequence)temMSTextBean.getValue(pageContext));
                    ...
                    if (mat.find() && templatePurpose) {
                        ...
                        if (!templatePurpose) {
                            ...
                            { new MessageToken("PARAM1", 
                                               (String)temMSTextBean.getValue(pageContext)), 
                              new MessageToken("PARAM2", paramPurpose) };
                            OAException localOAException = 
                                new OAException("SQLAP", 
                                                "XXGAM_AP_OIE_VALIDA_CCPP", 
                                                arrayOfMessageToken, 
                                                OAException.ERROR, null);
                            OADialogPage localOADialogPage = 
                                new OADialogPage(OAException.ERROR, 
                                                 localOAException, null, "", 
                                                 null);
                        ...
                        if (!mat.find()) {
                            ...
                            { new MessageToken("PARAM1", 
                                               (String)temMSTextBean.getValue(pageContext)), 
                              new MessageToken("PARAM2", patValue) };
                            OAException localOAException = 
                                new OAException("SQLAP", 
                                                "XXGAM_AP_OIE_VALIDA_CCTEMP", 
                                                arrayOfMessageToken, 
                                                OAException.ERROR, null);
                            OADialogPage localOADialogPage = 
                                new OADialogPage(OAException.ERROR, 
                ...
                if (null != ModAntAMImpl) {
                    ...
                    CcManagementValidation CcManagementValidation1 = 
                        new CcManagementValidation(pageContext, webBean);
                    System.out.println("Debug CMV-AHH 01: Post constructor class validation");

                    if (!CcManagementValidation1.getCcManagementFlag() && 
                        null == CcManagementValidation1.getErrmsgOUT() && 
                        null == CcManagementValidation1.getErrcodOUT()) {
                        ...
                        if (!CcManagementValidation1.getCcManagementFlag() && 
                            ...
                            throw new OAException("XBOL", 
                                                  "XXGAM_OIE_MAF_APPROV_CC_VAL_S", 
                                                  null, OAException.ERROR, 
                                                  null);
                        }
                    }

                    if (null != CcManagementValidation1.getErrmsgOUT() || 
                        null != CcManagementValidation1.getErrcodOUT()) {
                        //MANDAR MENSAJE DE ERROR POR VARIABLES
                        MessageToken[] messageTokenError = 
                        { new MessageToken("PARAM1", 
                                           CcManagementValidation1.getErrcodOUT()), 
                          new MessageToken("PARAM2", 
                                           CcManagementValidation1.getErrmsgOUT()) };
                        throw new OAException("XBOL", 
                                              "XXGAM_OIE_MAF_APPROV_CC_VAL_E", 
                                              messageTokenError, 
                                              OAException.ERROR, null);
                    }
    ...
    private void proccessLovInputAction(OAPageContext pageContext, 
        ...
        System.out.println("pageContext.getLovInputSourceId()-->" + 
            ...
            if (pageContext.getLovInputSourceId() != null) {
                ...
                if ("CostCenterFlexLov".equals(lovInputSourceId)) {
                    ...
                    pageContext.putSessionValue("ListVal", 
                                                ""); //Agregado para que al seleccionar un nuevo centro de costos la pantilla del anterior no se conserve

                    if ((null != orgShortNameEmp) && 
                        (!"02".equals(orgShortNameEmp))) {
                        System.out.println("Inicializa lista de valores para Centro de Costos Alternos y Sus Plantillas Correspondientes por Unidad Operativa:" + 
                                           paramorgNameEmp);
                        ...
                        if (XxGamConstantsUtil.UPDATE.equals(pageContext.getTransactionValue(XxGamConstantsUtil.STATUS))) {
                            initSuccess = 
                                    XxGamMAnticiposUtil2.initCostCenterFlexUpdate(pageContext, 
                                                                                  webBean);
                            if (initSuccess) {
                                initSuccess = 
                                        XxGamMAnticiposUtil2.setOriginApproverInGeneralUpdate(pageContext, 
                    ...
                    } else if ((null != orgShortNameEmp) && 
                               ("02".equals(orgShortNameEmp))) {
                        System.out.println("Inicializa lista de valores para centro de costos Alternos Unidad Operativa:" + 
                                           paramorgNameEmp);
                        //Inicializa lista de valores para centro de costos
                        /**  BEGIN  *********************************************/
                        initSuccess = 
                ...
                if ("TemplatePaymentLov".equals(lovInputSourceId) || 
                    ...
                    initSuccess = false;
                    String valFelx = 
                        pageContext.getParameter("TemplatePaymentFlexLov");
                    if (valFelx != null && !"".equals(valFelx)) {
                        pageContext.putSessionValue("ListVal", valFelx);
                    } else {
                        valFelx = 
                                pageContext.getParameter("TemplatePaymentLov");
                        if (valFelx != null && !"".equals(valFelx)) {
                            pageContext.putSessionValue("ListVal", valFelx);
                        } else {
                            pageContext.putSessionValue("ListVal", "");
                ...
                try {
                    String listFlex = 
                        pageContext.getSessionValue("ListVal").toString();
                    ...
                    if (listFlex != null && !"".equals(listFlex)) {
                        OAViewObject vo = 
                            (OAViewObject)am.findViewObject("XxGamMaGeneralReqVO1");
                        ...
                        if ("TemplatePaymentFlexLov".equals(lovInputSourceId)) {
                            ...
                            if (voFlex != null && 
                                voFlex.getEstimatedRowCount() > 0) {
                                XxGamMaTemplatePaymentFlexLovVORowImpl rowFlex = 
                                    null;
                                RowSetIterator itr = 
                                    voFlex.createRowSetIterator(null);
                                itr.setRangeStart(0);
                                while (itr.hasNext()) {
                                    rowFlex = 
                                            (XxGamMaTemplatePaymentFlexLovVORowImpl)itr.next();
                                    System.out.println("listFlex.equals: " + 
                                                       rowFlex.getTemplateDesc());
                                    if (listFlex.equals(rowFlex.getTemplateDesc())) {
                                        fila.setAttribute("TemplatePayment", 
                                                          rowFlex.getTemplateId());
                                        break;
                                    }
                                }
