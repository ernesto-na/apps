    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        if (!pageContext.isFormSubmission()) {
            ...
            XxGamMAnticiposUtil.debugMessage(XxGamConstantsUtil.DEBUG_DIAGNOSTICS_MODE, 
                                             ...
                                             pageContext, webBean);
                System.out.println("sfranchiseType:"+ pageContext.getSessionValue("sfranchiseType").toString());
        ...
        if (pageContext != null && webBean != null) {
            ...
            if (pageContext.getLovInputSourceId() != null) {
                ...
                if ("CostCenterFlexLov".equals(lovInputSourceId)) {
                    ...
                    initSuccess = 
                            false; // TODO :02 probar la llamada del sig metodo 
