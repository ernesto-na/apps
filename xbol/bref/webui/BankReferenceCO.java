...
/*    */ {
/* 25 */   public static final String RCS_ID = "$Header$";
...
/*    */ 
/*    */ 
/* 34 */   public void processRequest(OAPageContext pageContext, OAWebBean webBean)
/*    */   {
...
/*    */         }
/* 71 */         if (BankRefVO.first().getAttribute("Sucursal") != null) {
/*    */             SucursalS = BankRefVO.first().getAttribute("Sucursal").toString();
/*    */         }
/* 74 */         if (BankRefVO.first().getAttribute("Referencia") != null) {
/*    */             SucursalS = BankRefVO.first().getAttribute("Referencia").toString();
/*    */         }
/* 77 */         if (BankRefVO.first().getAttribute("Account") != null) {
...
/*    */         }
/* 83 */         if (BankRefVO.first().getAttribute("Bankcode") != null) {
/*    */             BankCodeS = BankRefVO.first().getAttribute("Bankcode").toString();
/*    */         }
/* 86 */         if (BankRefVO.first().getAttribute("Branchcode") != null) {
...
/*    */         }
/* 98 */         if (BankRefVO.first().getAttribute("Currency") != null) {
/*    */             CurrencyS = BankRefVO.first().getAttribute("Currency").toString();
/*    */         }
/*101 */         if (BankRefVO.first().getAttribute("Clabe") != null) {
/*    */             ClabeS = BankRefVO.first().getAttribute("Clabe").toString();
/*    */         }
/*101 */         if (BankRefVO.first().getAttribute("CuentaTransferencia") != null) {
/*    */             CuentatransS = BankRefVO.first().getAttribute("CuentaTransferencia").toString();
/*    */         }
/*101 */         if (BankRefVO.first().getAttribute("NumeroEmpleado") != null) {
/*    */             NumeroempS = BankRefVO.first().getAttribute("NumeroEmpleado").toString();
/*    */         }
/*    */                 
/*    */       
...
/*    */       }
 ...
 /*    */            oaWebBean = webBean.findChildRecursive("CuentaTransferencia");
 /* 68 */            oaWebBean.setRendered(false);
 /*    */      }  
               if (NumeroempS == null){
 /*    */            System.out.println("ocultando campo Numero Empleado ");
 /*    */            oaWebBean = webBean.findChildRecursive("NumeroEmpleado");
 /* 68 */            oaWebBean.setRendered(false);
 /*    */      }
               if (AccountS == null){
   ...
   /*    */            oaWebBean1 = webBean.findChildRecursive("Currency1");
   /* 68 */            oaWebBean.setRendered(false);
   /* 68 */            oaWebBean1.setRendered(false);
   /*    */    }
               if (ClabeS == null){
