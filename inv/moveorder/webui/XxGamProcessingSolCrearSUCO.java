...
public class XxGamProcessingSolCrearSUCO extends OAControllerImpl {
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if (null != InvSolicitudAMImpl) {
            ...
            String strFillInvSoliVOInfo = 
                InvSolicitudAMImpl.fillInvSoliVOInfoSU(strSVGrabKitCode);
            if (null != strFillInvSoliVOInfo) {
                if (strFillInvSoliVOInfo.contains("EXCEPTION")) {
                    throw new OAException(strFillInvSoliVOInfo, 
                                          OAException.ERROR);
                }
            }

            String strFillSoliDtlIDInfoSU = 
                InvSolicitudAMImpl.fillSoliDtlIDInfoSU(strFillInvSoliVOInfo);
            if (null != strFillSoliDtlIDInfoSU) {
                if (strFillSoliDtlIDInfoSU.contains("EXCEPTION")) {
                    throw new OAException(strFillSoliDtlIDInfoSU, 
                                          OAException.ERROR);
                }
            ...
            String sURL = 
                "OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudCrearSuperUserPG";
