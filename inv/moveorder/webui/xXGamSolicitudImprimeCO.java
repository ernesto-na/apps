...
public class xXGamSolicitudImprimeCO extends OAControllerImpl {
    ...
    public static final String RCS_ID = 
        "$Header: xXGamSolicitudImprimeCO.java 1.1 2013/02/27 10:51:48 eroncoroni ship $";
    public static final boolean RCS_ID_RECORDED = 
        VersionInfo.recordClassVersion("$Header: xXGamSolicitudImprimeCO.java 1.1 2013/02/27 10:51:48 eroncoroni ship $", 
                                       "%packagename%");
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        pageContext.writeDiagnostics(this, "XXGAM Dotaciones - Version 1.0", 
                                     3);
        String SoliId = pageContext.getParameter("SoliId");
        pageContext.writeDiagnostics(this, 
                                     "XXGAM Dotaciones - SoliId" + SoliId, 3);
    ...
    public BlobDomain getSoliDataPKG(String strSoliId, 
    ...
    public BlobDomain getSoliDataTMPL(String strSoliId, 
                                      OAPageContext pageContext, 
                                      OAWebBean webBean) {
        OAApplicationModule oaapplicationmodule = 
            pageContext.getApplicationModule(webBean);
        ...
        try {
            ...
            DataTemplate datatemplate = 
                new DataTemplate(oadbtransactionimpl.getAppsContext(), lApps, 
                                 lTemp);
            ...
            throw new OAException("XDOException=" + var15.getMessage(), 
                                  (byte)0);
