...
public class xXGamSolicitudActualizaCO extends OAControllerImpl {
   ...
   public static final String RCS_ID = "$Header: xXGamSolicitudActualizaCO.java 1.1 2013/02/27 10:51:48 eroncoroni ship $";
   public static final boolean RCS_ID_RECORDED = VersionInfo.recordClassVersion("$Header: xXGamSolicitudActualizaCO.java 1.1 2013/02/27 10:51:48 eroncoroni ship $", "%packagename%");
   ...
   public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
    int lUserid=0; 
      ...
      pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - Version 1.1 - processRequest", 3);
      ...
      if(null==lpSoliId||"".equals(lpSoliId)){
        throw new OAException("EXCEPTION Al recuperar el parametro SoliId.",OAException.ERROR); 
      }
      
      System.out.println("lpSoliId:"+lpSoliId);
      
      pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - Consulta Soli Id: " + lpSoliId, 3);
      ...
      pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - Buscamos el nombre del empleado sqlNombreEmpleado", 3);

      OracleCallableStatement pstmt = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement("SELECT distinct ppf.full_name FROM per_all_people_f ppf,     xxgam_inv_soli xis WHERE xis.person_id = ppf.person_id  AND TRUNC(SYSDATE) BETWEEN ppf.effective_start_date   AND ppf.effective_end_date  AND xis.soli_id = ?", 1);

       XxGamInvConstantes constantesErrors = new XxGamInvConstantes(); 
       String lMessageKitOutPeriodError = constantesErrors.ERROR_KIT_PERIOD_CLOSE.toString();      
       
       OAMessageTextInputBean observBean = (OAMessageTextInputBean)webBean.findChildRecursive("Observaciones");
       OAColumnBean columObservBean = (OAColumnBean)webBean.findChildRecursive("column12");
       OAButtonBean buttonBean = (OAButtonBean)webBean.findChildRecursive("generarpedido");
       OAButtonBean buttonBeanSave = (OAButtonBean)webBean.findChildRecursive("save");
       ...
       try {
          ...
          if(rs.next()) {
             ...
             pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - lNombreEmpleado: " + lNombreEmpleado, 3);
          }
       } catch (SQLException var30) {
          pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - sqlNombreEmpleado Error: " + var30.getMessage().toString(), 3);
       } finally {
          try {
             pstmt.close();
          } catch (Exception var29) {
             pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - sqlNombreEmpleado Error: " + var29.getMessage().toString(), 3);
             throw OAException.wrapperException(var29);
          }
       }

       pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - Incia Consulta en VO xXGamInvSoliVO1 ", 3);
       ...
       System.out.println("FechedRowCount:"+invSoliVOImpl.getFetchedRowCount());
       ...
       try{
        v_estatusEmployee = validaEmpleadoActivo(lpSoliId,oaapplicationmodule );        
       }catch(Exception e){
           ...
           throw new OAException("FND", "FND_GENERIC_MESSAGE", tokens);
              ...
              if(lSuperUser != null && lSuperUser.equals("Y")) {
                 ...
                 if(esFechaValida != null && "NO".equals(esFechaValida.trim())) {
                    ...
                    enRango = false;
                    buttonBeanSave.setDisabled(true);
                     throw new OAException(lMessageKitOutPeriodError, OAException.INFORMATION);        
                 } else {
                    am.validaCicloConFechaEntrega(pageContext, webBean);
                     System.out.println("Invoca deshabilitar lineas");
                 }
             ...
             pstmAccounDefault = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement("DECLARE\n" + 
               ...
               try {
                  ...
                  pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - Refresh Error: " + var129.getMessage().toString(), 3);
                 System.out.println("Error en refrescar estatus de paginas: " + var129.getMessage().toString());
               } finally {
                  try {
              ...
              if("ERROR".equals(statusSolicitud.toUpperCase()) || "CANCELADO".equals(statusSolicitud.toUpperCase())) {
                 System.out.println("Entra validación para  validacion de estatus ERROR O Cancelado.");
                 am.deshabilitaTodasLineasActializacion(true);
              }
              
               
               OAFormValueBean handleKitFormValue = (OAFormValueBean)oapagelayoutbean.findIndexedChildRecursive("KitAsignadoForm"); 
               if(null!=handleKitFormValue){
                System.out.println("handleKitFormValue.getValue(pageContext):"+handleKitFormValue.getValue(pageContext));
                if(null==handleKitFormValue.getValue(pageContext)||"".equals(handleKitFormValue.getValue(pageContext))){
                  Row row = invSoliDtlVOImpl.first();
                  kit_Asignado = (String)row.getAttribute("KitCod");
                }else{
                  kit_Asignado = (String)handleKitFormValue.getValue(pageContext)/*.toString()*/;
                }
               } /** END  if(null!=handleKitFormValue){ **/
               
               String vResultKitAsignado = validaPeriodValid(kit_Asignado,oaapplicationmodule );
   ...
   public void processFormRequest(OAPageContext pageContext, OAWebBean webBean) {
      ...
      pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - Version 1.1 - processFormRequest", 3);
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
       xXGamInvSolicitudAMImpl am = (xXGamInvSolicitudAMImpl)pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      OAPageLayoutBean oapagelayoutbean = pageContext.getPageLayoutBean();
      ...
      /**Refresh para ver el detalle de la linea*/
       if("show".equals(lEvent)) {
        int fetchRowCount;
        System.out.println("SoliIdH " + pageContext.getParameter("SoliIdH"));
           xXGamInvSoliDtlVOImpl invSoliDtlVOImpl = (xXGamInvSoliDtlVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliDtlVO1");
      ...
      System.out.println("lSuperUser: "  + lSuperUser);
      System.out.println("Se recupera statusSolicitud: "  + statusSolicitud);
      String vResultKitAsignado = validaPeriodValid(kit_Asignado,oaapplicationmodule );                         
      XxGamInvConstantes constantesErrors = new XxGamInvConstantes(); 
      String lMessagePeriodError = constantesErrors.ERROR_KIT_PERIOD_CLOSE.toString();      
      ...
      if("generarpedido".equals(lEvent)) {
         ...
         MessageToken[] tokens2 = new MessageToken[]{new MessageToken("MESSAGE", "Se ejecuto la actualizacion del pedido verifique el concurrente REQUEST ID: " + lReqId.toString())};
      ...
      /**Envento para inhabilitar las lineas despues de mostrar u ocultar los detalles solicitud*/
       ...
       if("linkPage".equals(lEvent)) {
          ...
          params.put("pSoliDtlId",  getSoliDtl(pageContext.getParameter("evtSrcRowRef")).toString());
          params.put("pSoliId",  SoliId);
          params.put("pOrigen",  "A");
          
          pageContext.setForwardURL("OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudLineDtlPG", (String)null, (byte)0, (String)null, params, true, "N", (byte)99);
       }
   ...
   public void updateProcess(OAPageContext pageContext, OAWebBean webBean, OADBTransactionImpl oadbtransactionimpl, OAApplicationModule oaapplicationmodule ){
       OAPageLayoutBean oapagelayoutbean = pageContext.getPageLayoutBean();
       pageContext.writeDiagnostics(this, "xXGamSolicitudActualizaCO - Evento Grabar", 3);
       OAFormValueBean oaSoliBean = (OAFormValueBean)oapagelayoutbean.findIndexedChildRecursive("SoliIdH");
       String lSoliIdC = (String)oaSoliBean.getValue(pageContext);
    ...
    public String validaPeriodValid(String pKitName, OAApplicationModule oaapplicationmodule  ){
        ...
        try {
          ...
          if(resulstQuery.next()) {
           ...
           System.out.println("Un error encontrado en Validar periodo Activo: " + var01.getMessage().toString());
        } finally {
           try {
              pstmtKit.close();
           } catch (Exception var02) {
                System.out.println("Un error encontrado en Validar periodo Activo: " + var02.getMessage().toString());   
           }
        }
        return val;
    }    
    public String validaEmpleadoActivo(String pSoliId, OAApplicationModule oaapplicationmodule){
         String v_estatusEmployee = "NA";
         System.out.println("Inicia Proceso validaEmpleadoActivo, se recibe pSoliId: " + pSoliId);
         OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
