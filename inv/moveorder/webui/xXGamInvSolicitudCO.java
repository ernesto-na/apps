...
public class xXGamInvSolicitudCO extends OAControllerImpl {
    ...
    public static final String RCS_ID = 
        "$Header: xXGamInvSolicitudCO.java 1.1 2013/02/07 10:51:48 eroncoroni ship $";
    public static final boolean RCS_ID_RECORDED = 
        VersionInfo.recordClassVersion("$Header: xXGamInvSolicitudCO.java 1.1 2013/02/07 10:51:48 eroncoroni ship $", 
                                       "%packagename%");
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        pageContext.writeDiagnostics(this, 
                                     "xXGamInvSolicitudCO - Version 1.0 - processRequest", 
                                     3);
        ...
        * */
        OAButtonBean crearSolicitudBtn = 
            ((OAButtonBean)webBean.findChildRecursive("crearsolicitud"));
        OAButtonBean generarPedidoBtn = 
            ((OAButtonBean)webBean.findChildRecursive("generarpedido"));
        OAButtonBean cancelarPedidoBtn = 
            ((OAButtonBean)webBean.findChildRecursive("cancelarpedido"));
        ...
        System.out.println("Se omptiene getUserId: " + 
                           oadbtransactionimpl.getUserId());
        System.out.println("Se optiene employeeNumber: " + 
                           am.obtieneEmployeeNumber(oadbtransactionimpl.getUserId()));
        System.out.println("Se optiene UserId" + pageContext.getUserId());
        System.out.println("Se imprime personId: " + 
                           am.obtienePersonId(pageContext.getUserId()));
        System.out.println("retainAM: " + 
                           pageContext.getParameter("retainAM"));
        OALinkBean linkDownLoadPDFBean = 
            (OALinkBean)oapagelayoutbean.findIndexedChildRecursive("linkDownLoadPDF");
        OAQueryBean queryBean = 
            (OAQueryBean)webBean.findChildRecursive("QuerySolicitudRN");
        ...
        xXGamInvSoliSummaryVOImpl invSoliVOImpl = 
            (xXGamInvSoliSummaryVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliSummaryVO1");
        //invSoliVOImpl.setQuery(null);
        //invSoliVOImpl.setWhereClauseParams(null);
        int validaSearchPanel = 0;
        try {
            validaSearchPanel = 
                    validQueryInit(invSoliVOImpl.getQuery().toString());
        } catch (Exception e) {
            System.out.println("");
        }
        ...
        if (validaSearchPanel <= 0) {
            try {
                String filter = 
                    am.validaInitReport("" + oadbtransactionimpl.getUserId());
        ...
        if (!lSuperUser.equals("Y") && !lperfil.equals("Y")) {
            ...
            if (estaActiva == null) {
                ...
                String existeSolicitudValida = 
                    am.comparaFechaCreacionUser(personId);
                System.out.println("existeSolicitudValida: " + 
                                   existeSolicitudValida);
                if (existeSolicitudValida != null && 
                    "SI".equals(existeSolicitudValida)) {
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        pageContext.writeDiagnostics(this, 
                                     "xXGamInvSolicitudCO - Version 1.0 - processFormRequest", 
                                     3);
        OADBTransactionImpl oadbtransactionimpl = 
            (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
        OAPageLayoutBean oapagelayoutbean = pageContext.getPageLayoutBean();
        OAQueryBean queryBean = 
            (OAQueryBean)webBean.findIndexedChildRecursive("QuerySolicitudRN");
        ...
        if (pageContext.getParameter(idGo) != null && 
            !"NroSolicitudDesde".equals(lSource) && 
            !"NroSolicitudDesde".equals(lSource)) {
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - Evento Go o Ir ", 
                                         3);
            OAMessageLovInputBean oaNroSoliDesdeBean = 
                (OAMessageLovInputBean)oapagelayoutbean.findIndexedChildRecursive("NroSolicitudDesde");
            String lNroSoliD = 
                (String)oaNroSoliDesdeBean.getValue(pageContext);
            OAMessageLovInputBean oaNroSoliHastaBean = 
                (OAMessageLovInputBean)oapagelayoutbean.findIndexedChildRecursive("NroSolicitudHasta");
            String lNroSoliH = 
                (String)oaNroSoliHastaBean.getValue(pageContext);
            OAMessageDateFieldBean oaFechaDesdeBEEBean = 
                (OAMessageDateFieldBean)oapagelayoutbean.findIndexedChildRecursive("FechaSolicitudDesde");
            Date lFecha = null;
            oracle.jbo.domain.Date lFechaDesde = null;
            if (oaFechaDesdeBEEBean.getValue(pageContext) != null) {
                Timestamp ts = 
                    (Timestamp)oaFechaDesdeBEEBean.getValue(pageContext);
                lFecha = new Date(ts.getTime());
                lFechaDesde = new oracle.jbo.domain.Date(lFecha);
            }

            OAMessageDateFieldBean oaFechaHastaBEEBean = 
                (OAMessageDateFieldBean)oapagelayoutbean.findIndexedChildRecursive("FechaSolicitudHasta");
            Date lFecha1 = null;
            oracle.jbo.domain.Date lFechaHasta = null;
            if (oaFechaHastaBEEBean.getValue(pageContext) != null) {
                Timestamp ts1 = 
                    (Timestamp)oaFechaHastaBEEBean.getValue(pageContext);
                lFecha1 = new Date(ts1.getTime());
                lFechaHasta = new oracle.jbo.domain.Date(lFecha1);
            }

            OAMessageChoiceBean oaStatusBean = 
                (OAMessageChoiceBean)oapagelayoutbean.findIndexedChildRecursive("StatusChoice");
            String lStatus = (String)oaStatusBean.getValue(pageContext);
            OAMessageLovInputBean lovCvEmp = 
                (OAMessageLovInputBean)webBean.findChildRecursive("ClaveEmpleado");
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - ejecutamos XXGAM_INV_MOVEORDER_PKG.REFRESH_SOLICITUD ", 
                                         3);
            String sqlRefresh = 
            ...
            try {
                ...
                pageContext.writeDiagnostics(this, 
                                             "xXGamInvSolicitudCO - sqlRefresh Error: " + 
                                             var59.getMessage().toString(), 3);
                ...
                try {
                    ...
                    pageContext.writeDiagnostics(this, 
                                                 "xXGamInvSolicitudCO - sqlRefresh Error: " + 
                                                 var58.getMessage().toString(), 
                                                 3);
                    throw OAException.wrapperException(var58);
                }
            }

            xXGamInvSoliSummaryVOImpl invSummaryVOImpl = 
                (xXGamInvSoliSummaryVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliSummaryVO1");
            invSummaryVOImpl.clearCache();
            invSummaryVOImpl.initQuery(lNroSoliD, lNroSoliH, lFechaDesde, 
                                       lFechaHasta, lStatus, lCvEmp);
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - consuta VO  xXGamInvSoliSummaryVO1 con parametros seleccionados", 
                                         3);
        }

        if ("update".equals(lEvent)) {
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - Event update", 
                                         3);
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - call:OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudActualizaPG", 
                                         3);
            pageContext.setForwardURL("OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudActualizaPG", 
                                      ...
                                      (HashMap)null, true, "N", (byte)99);
        }

        if ("print".equals(lEvent)) {
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - Event print", 
                                         3);
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - call:/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudImprimePG", 
                                         3);
            ...
            pageContext.putJavaScriptFunction("RepSolicitud", 
                                              l_buffer.toString());
        }

        if ("crearsolicitud".equals(lEvent)) {
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - Event crearsolicitud", 
                                         3);
            ...
            if (!"Y".equals(lSuperUser) && !"Y".equals(lperfil)) {
                ...
                pageContext.writeDiagnostics(this, 
                                             "xXGamInvSolicitudCO - call:OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudCrearPG", 
                                             3);
                pageContext.setForwardURL("OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudCrearPG", 
                                          (String)null, (byte)0, (String)null, 
                                          (HashMap)null, true, "N", (byte)99);
            } else {
                ...
                pageContext.writeDiagnostics(this, 
                                             "xXGamInvSolicitudCO - call:OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudCrearSuperUserPG", 
                                             3);
                pageContext.setForwardURL("OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudCrearSuperUserPG", 
                                          (String)null, (byte)0, (String)null, 
                                          (HashMap)null, true, "N", (byte)99);
            }
        }
        ...
        if ("generarpedido".equals(lEvent)) {
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - Event generarpedido", 
                                         3);
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - call:checkSelectedrow", 
                                         3);
        ...
        if ("cancelarpedido".equals(lEvent)) {
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - Event cancelarpedido", 
                                         3);
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - call:checkSelectedrow", 
                                         3);
        ...
        if ("linkPage".equals(lEvent)) {
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamInvSolicitudCO - Event linkPage", 
                                         3);
            String esDevolucion = null;
            String numSoli = null;
            Number idSoli = null;
            String rowRef = pageContext.getParameter("evtSrcRowRef");
            xXGamInvSoliSummaryVORowImpl row = 
                (xXGamInvSoliSummaryVORowImpl)am.findRowByRef(rowRef);
            if (row != null) {
                numSoli = row.getNroSolicitud();
                idSoli = row.getSoliId();
                esDevolucion = 
                        am.validaLineas(pageContext, webBean, lSuperUser, 
                                        numSoli);
            }
            ...
            if (esDevolucion != null && "NO".equals(esDevolucion)) {
                pageContext.writeDiagnostics(this, 
                                             "xXGamInvSolicitudCO - go to CONSULTA", 
                                             3);
                ...
                pageContext.writeDiagnostics(this, 
                                             "xXGamInvSolicitudCO - go to DEVOLUCION", 
                                             3);
                pageContext.setForwardURL("OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamInvDevolucionesPG", 
                                          (String)null, (byte)0, (String)null, 
                                          params, true, "N", (byte)99);
            } else {
                pageContext.writeDiagnostics(this, 
        ...
        if ("lovPrepare".equals(lEvent)) {
            ...
            OAMessageLovInputBean NroSolicitudDesdeLov = 
                ((OAMessageLovInputBean)webBean.findChildRecursive("NroSolicitudDesde"));
            try {
                valueLov = 
                        NroSolicitudDesdeLov.getValue(pageContext).toString();
    ...
    public void checkSelectedrow(OAPageContext pageContext, OAWebBean webBean, 
                                 String action) {
        OAApplicationModule oaapplicationmodule = 
            pageContext.getApplicationModule(webBean);
        OAViewObject invSoliSummVO = 
            (OAViewObject)oaapplicationmodule.findViewObject("xXGamInvSoliSummaryVO1");
        OADBTransactionImpl oadbtransactionimpl = 
            (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
        ...
        RowSetIterator selectIter = 
            invSoliSummVO.createRowSetIterator("selectIter");
        if (fetchedRowCount > 0) {
            ...
            for (int i = 0; i < fetchedRowCount; ++i) {
                xXGamInvSoliSummaryVORowImpl row = 
                    (xXGamInvSoliSummaryVORowImpl)selectIter.getRowAtRangeIndex(i);
                String selectFlag1 = row.getSelectFlag1() + "";
                if ("Y".equals(selectFlag1)) {
                    pageContext.writeDiagnostics(this, 
                                                 "xXGamInvSolicitudCO - selecciono Solicitud Id: " + 
                                                 row.getSoliId().toString(), 
                                                 3);
                    try {
                        v_estatusEmployee = 
                                validaEmpleadoActivo(row.getPersonId().toString(), 
                                                     oaapplicationmodule);
                    } catch (Exception e) {
                        v_estatusEmployee = "NA";
                    ...
                    if ("G".equals(action)) {
                        ...
                        if (!v_estatusEmployee.toString().equals("1") && 
                            ...
                            throw new OAException("FND", "FND_GENERIC_MESSAGE", 
                                                  tokens);
                        } else if ("CREADO".equals(row.getStatus()) || 
                                   "EJECUCION".equals(row.getStatus()) || 
                                   "CANCELADO".equals(row.getStatus()) || 
                                   "CERRADO".equals(row.getStatus()) || 
                                   "PREAPROBADO".equals(row.getStatus())) {
                            String lMessageE = 
                                "La solicitud no se pudo generar por que ya fue Aprobada, Cerrada o Cancelada.";
                            pageContext.writeDiagnostics(this, 
                                                         "xXGamInvSolicitudCO - error: " + 
                                                         lMessageE, 3);
                            MessageToken[] tokens = 
                                new MessageToken[] { new MessageToken("MESSAGE", 
                                                                      lMessageE) };
                        ...
                        String sqlGen = 
                            "SELECT header_id FROM xxgam_inv_soli WHERE header_id IS NOT NULL AND soli_id = ? ";
                        OracleCallableStatement pstmtGen = 
                            (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(sqlGen, 
                                                                                                 1);
                        ...
                        try {
                            ...
                            if (rsGen.next()) {
                                String lMessageE1 = 
                                    "La solicitud no se puedo generar por que ya tiene un Pedido de Movimiento generado.";
                                pageContext.writeDiagnostics(this, 
                                                             "xXGamInvSolicitudCO - error: " + 
                                                             lMessageE1, 3);
                            ...
                            pageContext.writeDiagnostics(this, 
                                                         "xXGamInvSolicitudCO - sqlGen Error: " + 
                                                         var59.getMessage().toString(), 
                                                         3);
                        } finally {
                            try {
                                pstmtGen.close();
                        ...
                        if (!v_estatusEmployee.toString().equals("1") && 
                            ...
                            throw new OAException("FND", "FND_GENERIC_MESSAGE", 
                                   ...
                                   "CERRADO".equals(row.getStatus())) {
                            String lMessageE2 = 
                                "La solicitud no se puede cancelar por que ya fue Cerrada o Cancelada.";
                            pageContext.writeDiagnostics(this, 
                                                         "xXGamInvSolicitudCO - error: " + 
                                                         lMessageE2, 3);
                        ...
                        lSoliIdSTR = row.getSoliId().toString();
                        String sqlCancel = 
                            "SELECT line_id FROM xxgam_inv_soli_dtl xisd WHERE EXISTS (SELECT 1       FROM mtl_txn_request_lines mtrl       WHERE mtrl.line_id = xisd.line_id       AND (nvl(mtrl.line_status,-1) = 5             OR           mtrl.QUANTITY_DELIVERED IS NOT NULL)) AND xisd.line_id       IS NOT NULL AND xisd.soli_id      = ?  ";
                        OracleCallableStatement pstmtCancel = 
                            (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(sqlCancel, 
                                                                                                 1);
                        ...
                        try {
                            ...
                            if (rsCancel.next()) {
                                String lMessageE3 = 
                                    "La solicitud no se puede cancelar por que alguna de sus lineas esta Cerrada o se recepciono uniforme.";
                                pageContext.writeDiagnostics(this, 
                                                             "xXGamInvSolicitudCO - error: " + 
                                                             lMessageE3, 3);
                            ...
                            pageContext.writeDiagnostics(this, 
                                                         "xXGamInvSolicitudCO - sqlCancel Error: " + 
                                                         var61.getMessage().toString(), 
                                                         3);
                        } finally {
                            try {
                                pstmtCancel.close();
                        ...
                        lReqId = 
                                this.callConcMoveOrder(lSoliIdSTR, "XXGAM_INV_CANCEL_MV", 
                                                       "XXGAM INV Cancelar Move Order", 
                                                       pageContext, webBean);
                    }
                }
            }
        ...
        if (lReqId.compareTo(0) > 0) {
            if ("C".equals(action)) {
                MessageToken[] tokens4 = 
                    new MessageToken[] { new MessageToken("MESSAGE", 
                                                          "Se ejecuto la cancelaci\u00f3n del pedido verifique el concurrente REQUEST ID: " + 
                                                          lReqId.toString()) };
                OAException message = 
                    new OAException("FND", "FND_GENERIC_MESSAGE", tokens4, 
                                    (byte)3, (Exception[])null);
                pageContext.putDialogMessage(message);
            } else {
                MessageToken[] tokens5 = 
                    new MessageToken[] { new MessageToken("MESSAGE", 
                                                          "Se ejecuto la generaci\u00f3n del pedido verifique el concurrente REQUEST ID: " + 
                                                          lReqId.toString()) };
                OAException message1 = 
                    new OAException("FND", "FND_GENERIC_MESSAGE", tokens5, 
                                    (byte)3, (Exception[])null);
    ...
    public BlobDomain getSoliData(String strSoliId, OAPageContext pageContext, 
                                  OAWebBean webBean) {
        ...
        try {
            ...
            String sqlCBlob = 
                "BEGIN ? := XXGAM_INV_SOLI_DOTA_PKG.GeneraXML(?); END; ";
            pstmt = 
                    (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(sqlCBlob, 
                                                                                         1);
    ...
    public void callConcSoli(String strSoliId, OAPageContext pageContext, 
                             OAWebBean webBean) {
        OAApplicationModule oaapplicationmodule = 
            pageContext.getApplicationModule(webBean);
        Vector lParam = new Vector();
        ...
        try {
            ...
            lRequestId = 
                    lConc.submitRequest(lAppCode, lConcReqCode, "XXGAM INV Dotaciones", 
                                        (String)null, false, lParam);
            oaapplicationmodule.getOADBTransaction().commit();
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudActualizaCO - " + var16.toString(), 
                                         3);
        }
        ...
        pageContext.setForwardURL(url, (String)null, (byte)0, (String)null, 
                                  parameters, true, "N", (byte)99);
    }
    ...
    public void clearSearchPanel(OAPageContext pageContext, 
                                 OAWebBean webBean) {
        OAMessageChoiceBean StatusChoiceBean = 
            (OAMessageChoiceBean)webBean.findChildRecursive("StatusChoice");
        OAMessageLovInputBean NroSolicitudDesdeBean = 
            (OAMessageLovInputBean)webBean.findChildRecursive("NroSolicitudDesde");

        OAMessageLovInputBean NroSolicitudHastaBean = 
            (OAMessageLovInputBean)webBean.findChildRecursive("NroSolicitudHasta");

        OAMessageLovInputBean ClaveEmpleadoBean = 
            (OAMessageLovInputBean)webBean.findChildRecursive("ClaveEmpleado");
        OAMessageDateFieldBean FechaSolicitudHastaBean = 
            (OAMessageDateFieldBean)webBean.findChildRecursive("FechaSolicitudHasta");
        OAMessageDateFieldBean FechaSolicitudDesdeBean = 
            (OAMessageDateFieldBean)webBean.findChildRecursive("FechaSolicitudDesde");
    ...
    public void SearchPanelAltaernative(OAPageContext pageContext, 
                                        OAWebBean webBean) {
        ...
        try {
            if (!StatusChoiceBean.getValue(pageContext).toString().equals(null)) {
                WhereClause = 
                        WhereClause + " AND status LIKE " + StatusChoiceBean.getValue(pageContext).toString();
            }
        } catch (Exception e) {
            System.out.println("");
        }
        ...
        try {
            if (!ClaveEmpleadoBean.getValue(pageContext).toString().equals(null)) {
                WhereClause = 
                        WhereClause + " AND status LIKE " + ClaveEmpleadoBean.getValue(pageContext).toString();
            }
        } catch (Exception e) {
            System.out.println("");
        }
        ...
        try {
            ...
            try {
                if (!NroSolicitudDesdeBean.getValue(pageContext).toString().equals(null)) {
                    SolicitudDesde = 
                            NroSolicitudDesdeBean.getValue(pageContext).toString();
                }
            } catch (Exception e) {
                SolicitudDesde = "";
            }
            try {
                if (!NroSolicitudHastaBean.getValue(pageContext).toString().equals(null)) {
                    SolicitudHasta = 
                            NroSolicitudHastaBean.getValue(pageContext).toString();
                }
            } catch (Exception e) {
                SolicitudHasta = "";
            }
    ...
    public String validSearchPanel(OAPageContext pageContext, 
                                   OAWebBean webBean) {
    ...
    private void disableRegionsByProfiles(OAPageContext pageContext, 
        ...
        if (null != lperfil && !"".equals(lperfil)) {
            if (!"Y".equals(lperfil)) {
                OAWebBean columnUpdateBean = 
                    webBean.findChildRecursive("columnUpdate");
                if (null != columnUpdateBean) {
                    columnUpdateBean.setRendered(false);
                }

                OAWebBean crearsolicitudBean = 
                    webBean.findChildRecursive("crearsolicitud");
