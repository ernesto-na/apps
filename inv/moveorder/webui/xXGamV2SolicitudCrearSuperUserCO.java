...
public class xXGamV2SolicitudCrearSuperUserCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        if (null != pageContext.getProfile("XXGAM_INV_USUARIO_UNIFORME") && 
            ...
            if ("Y".equals(strIsSuperUser)) {
                ...
                throw new OAException("EXCEPTION Valor:" + strIsSuperUser + 
                                      " no valido para el perfil XXGAM_INV_USUARIO_UNIFORME.", 
                                      OAException.ERROR);
            }
        }
        ...
        if (!"Y".equals(strIsSuperUser)) {
            disableRegions(pageContext, webBean);
            throw new OAException("EXCEPTION Pantalla de uso exclusivo para usuarios que contengan asignado el Perfil XXGAM_INV_USUARIO_UNIFORME.", 
                                  OAException.ERROR);
        }
        ...
        if (!pageContext.isFormSubmission()) {
            ...
            String strExceptValPeriodKit = 
                pageContext.getParameter("pExceptValPeriodKit");

            if (null != strExceptValPeriodKit && 
                !"".equals(strExceptValPeriodKit)) {
                ...
                throw new OAException(strExceptValPeriodKit, 
                                      OAException.ERROR);
            }

            String strExceptValSoloUnaUNI = 
                pageContext.getParameter("pExceptValSoloUnaUNI");
            if (null != strExceptValSoloUnaUNI && 
                !"".equals(strExceptValSoloUnaUNI)) {
                pageContext.removeParameter("pExceptValSoloUnaUNI");
                pageContext.putParameter("pExceptValSoloUnaUNI", "");
                if (null != InvSolicitudAMImpl) {
                    InvSolicitudAMImpl.filterInvAvailableKitsVO();
                }
                throw new OAException(strExceptValSoloUnaUNI, 
                                      OAException.ERROR);
            }

            String strExceptValHistoryInfo = 
                pageContext.getParameter("pExceptValHistoryInfo");
            if (null != strExceptValHistoryInfo && 
                !"".equals(strExceptValHistoryInfo)) {
                pageContext.removeParameter("pExceptValHistoryInfo");
                pageContext.putParameter("pExceptValHistoryInfo", "");
                if (null != InvSolicitudAMImpl) {
                    InvSolicitudAMImpl.filterInvAvailableKitsVO();
                }
                throw new OAException(strExceptValHistoryInfo, 
                                      OAException.ERROR);
            }

            String strSucessSoliID = 
                pageContext.getParameter("pSuccessSoliID");
            if (null != strSucessSoliID && !"".equals(strSucessSoliID)) {
                ...
                throw new OAException("UNI-" + strSucessSoliID + 
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if ("crea".equals(pageContext.getParameter(this.EVENT_PARAM))) {
            if (null != InvSolicitudAMImpl) {
                ...
                String strFillSolCrearCabeInfoSU = 
                    InvSolicitudAMImpl.fillSolCrearCabeInfoSU(pageContext, 
                                                              webBean);
                if (null != strFillSolCrearCabeInfoSU) {
                    if (strFillSolCrearCabeInfoSU.contains("EXCEPTION")) {
                        throw new OAException(strFillSolCrearCabeInfoSU, 
                                              OAException.ERROR);
                    }
                }

                String strGetAvailableKitsInfoSU = 
                    InvSolicitudAMImpl.getAvailableKitsInfoSU();
                if (null != strGetAvailableKitsInfoSU) {
                    if (strGetAvailableKitsInfoSU.contains("EXCEPTION")) {
                        throw new OAException(strGetAvailableKitsInfoSU, 
                                              OAException.ERROR);
                    }
                }

                String strValGamHrUniformesInfo = 
                    InvSolicitudAMImpl.valGamHrUniformesInfo(strGetAvailableKitsInfoSU);
        ...
        if ("AvailableKitEvt".equals(pageContext.getParameter(this.EVENT_PARAM))) {
           ...
           **********************************************************************/
              ...
              *****************************************************************/
                    ...
                    InvSolicitudAMImpl.cleanV2InvSoliDtlVOInfo();
                    String strFillV2InvSoliDtlVOInfoSU = 
                        InvSolicitudAMImpl.fillV2InvSoliDtlVOInfoSU(pageContext, 
                                                                    strKitCode, 
                                                                    numPersonID, 
                                                                    strKitID);
                    if (null != strFillV2InvSoliDtlVOInfoSU) {
                        if (strFillV2InvSoliDtlVOInfoSU.contains("EXCEPTION")) {
                            ...
                            hashMap.put("pExceptValHistoryInfo", 
                                        strFillV2InvSoliDtlVOInfoSU); /* com.sun.java.util.collections.HashMap parameters, */
                                /* boolean retainAM, */
        ...
        if ("V2GrabarEvt".equals(pageContext.getParameter(this.EVENT_PARAM))) {
            ...
            if (null != strGrabKitCode && !"".equals(strGrabKitCode)) {
                ...
                com.sun.java.util.collections.List listValAmountsV2InvSoliDtlSU = 
                    InvSolicitudAMImpl.valAmountsV2InvSoliDtlSU();
                ...
                OAProcessingPage processingPage = 
                    new OAProcessingPage("xxgam.oracle.apps.inv.moveorder.webui.XxGamProcessingSolCrearSUCO");
    ...
    private void disableOldRegions(OAPageContext pageContext, 
                                   OAWebBean webBean) {
        OAWebBean SingleColumnCreaSuperUserRG2Bean = 
            webBean.findChildRecursive("SingleColumnCreaSuperUserRG2");
        if (null != SingleColumnCreaSuperUserRG2Bean) {
            SingleColumnCreaSuperUserRG2Bean.setRendered(false);
        }

        OAWebBean SingleColumnCreaSuperUserRG3Bean = 
            webBean.findChildRecursive("SingleColumnCreaSuperUserRG3");
    ...
    private void disableRegions(OAPageContext pageContext, OAWebBean webBean) {
        OAWebBean region5SingleColumnCreaSuperUserRG0Bean = 
            webBean.findChildRecursive("region5SingleColumnCreaSuperUserRG0");
        if (null != region5SingleColumnCreaSuperUserRG0Bean) {
            region5SingleColumnCreaSuperUserRG0Bean.setRendered(false);
        }
        OAWebBean SingleColumnCreaSuperUserRG1Bean = 
            webBean.findChildRecursive("SingleColumnCreaSuperUserRG1");
        ...
        OAWebBean SingColEmpInfoBean = 
            webBean.findChildRecursive("SingColEmpInfo");
        if (null != SingColEmpInfoBean) {
            SingColEmpInfoBean.setRendered(false);
        }
        OAWebBean SingColDotacionInfoBean = 
            webBean.findChildRecursive("SingColDotacionInfo");
