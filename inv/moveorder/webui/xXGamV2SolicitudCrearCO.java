...
public class xXGamV2SolicitudCrearCO extends OAControllerImpl
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
    ...
    if(null!=pageContext.getParameter("pExceptValHistoryInfo")&&!"".equals(pageContext.getParameter("pExceptValHistoryInfo"))){
      disablePageRegions(pageContext,webBean);
      throw new OAException(pageContext.getParameter("pExceptValHistoryInfo").toString(),OAException.ERROR);
    } 
    ...
    xXGamInvSolicitudAMImpl InvSolicitudAMImpl = (xXGamInvSolicitudAMImpl)pageContext.getApplicationModule(webBean);
     if(!pageContext.isFormSubmission()){
        if(null!=InvSolicitudAMImpl){
         String strValFillSolCrearCabeInfo = InvSolicitudAMImpl.valFillSolCrearCabeInfo();
         if(null!=strValFillSolCrearCabeInfo){
           if("Y".equals(strValFillSolCrearCabeInfo)){
             String getFillSolCrearCabeInfo = InvSolicitudAMImpl.fillSolCrearCabeInfo(pageContext
                                                                                     ,webBean);
             if(null!=getFillSolCrearCabeInfo){
               if(getFillSolCrearCabeInfo.contains("EXCEPTION")){
                 disablePageRegions(pageContext,webBean);
                throw new OAException(getFillSolCrearCabeInfo,OAException.ERROR); 
               }
          ...
          String strGetAvailableKitsInfo = InvSolicitudAMImpl.fillAvailableKitsInfo();
          ...
          String strValGamHrUniformesInfo = InvSolicitudAMImpl.valGamHrUniformesInfo(strGetAvailableKitsInfo);
          ...
          if(null!=pageContext.getParameter("pExceptValPeriodKit")&&!"".equals(pageContext.getParameter("pExceptValPeriodKit"))){
            /*************************************************************************************
            ...
            *************************************************************************************/
            throw new OAException(pageContext.getParameter("pExceptValPeriodKit").toString(),OAException.ERROR); 
          } 
          
          if(null!=pageContext.getParameter("pExceptValSoloUnaUNI")&&!"".equals(pageContext.getParameter("pExceptValSoloUnaUNI"))){
            /*************************************************************************************
            OAButtonBean V2GrabarBtnBean = (OAButtonBean)webBean.findChildRecursive("V2GrabarBtn"); 
            if(null!=V2GrabarBtnBean){
              V2GrabarBtnBean.setDisabled(true);
            ...
            *************************************************************************************/
            throw new OAException(pageContext.getParameter("pExceptValSoloUnaUNI").toString(),OAException.ERROR); 
          } 
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean) {
     ...
     if("AvailableKitEvt".equals(pageContext.getParameter(this.EVENT_PARAM))){
       ...
       OAFormValueBean personIdBean = (OAFormValueBean)webBean.findChildRecursive("personId");
         ...
         &&(null!=numPersonID)){
           ...
           *****************************************************************************/
           ...
           if(null!=strValSoloUnaUNI){
             ...
             InvSolicitudAMImpl.cleanV2InvSoliDtlVOInfo(); 
             String strFillV2InvSoliDtlVOInfo = InvSolicitudAMImpl.fillV2InvSoliDtlVOInfo(pageContext,strKitCode,numPersonID,strKitID); 
             if(null!=strFillV2InvSoliDtlVOInfo){
               if(strFillV2InvSoliDtlVOInfo.contains("EXCEPTION")){
                 com.sun.java.util.collections.HashMap hashMap = new com.sun.java.util.collections.HashMap();
                 hashMap.put("pExceptValHistoryInfo",strFillV2InvSoliDtlVOInfo);
                 pageContext.forwardImmediatelyToCurrentPage(hashMap /* com.sun.java.util.collections.HashMap parameters, */
                                                            ,false   /* boolean retainAM, */
                                                            , OAWebBeanConstants.ADD_BREAD_CRUMB_NO       /* String addBreadCrumb*/ 
                                                            );
       ...
       if(this.LOV_PREPARE.equals(strEvent)){
         if("V2TallaNbr".equals(strLovInputSourceId)){
           OARow oaRow = (OARow)InvSolicitudAMImpl.findRowByRef(strEvtSrcRowRef);
           if(null!=oaRow){
                  oracle.jbo.domain.Number numDotaID = (oracle.jbo.domain.Number)oaRow.getAttribute("DotaId");
                  pageContext.putSessionValue("SoliDtlValue",numDotaID.toString());
           } /** End  if(null!=oaRow){ **/
         }
        ...
        **********************************************************************************/
        ...
        com.sun.java.util.collections.List listValAmountsV2InvSoliDtl = InvSolicitudAMImpl.valAmountsV2InvSoliDtl();
        if(null!=listValAmountsV2InvSoliDtl){
         ...
         if(null!=strCallValidarSustitutos){
           ...
           ****/
            ...
            OAProcessingPage processingPage = new OAProcessingPage("xxgam.oracle.apps.inv.moveorder.webui.XxGamProcessingSolCrearCO");
    ...
    {
      OAWebBean SingleColumnCreaRG1Bean = webBean.findChildRecursive("SingleColumnCreaRG1");
      if(null!=SingleColumnCreaRG1Bean){
        SingleColumnCreaRG1Bean.setRendered(false);
      }
      OAWebBean SingleColumnCreaRG2Bean = webBean.findChildRecursive("SingleColumnCreaRG2");
      if(null!=SingleColumnCreaRG2Bean){
        SingleColumnCreaRG2Bean.setRendered(false);
      }
      OAWebBean SingleColumnCreaRG3Bean = webBean.findChildRecursive("SingleColumnCreaRG3");
      if(null!=SingleColumnCreaRG3Bean){
        SingleColumnCreaRG3Bean.setRendered(false);
      }
      OAWebBean SingleColumnCreaRG4Bean = webBean.findChildRecursive("SingleColumnCreaRG4");
