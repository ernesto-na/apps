...
public class xXGamSolicitudCrearSuperUserCO extends OAControllerImpl {
    ...
    public static final String RCS_ID = 
        "$Header: xXGamSolicitudCrearSuperUserCO.java 1.1 2013/02/27 10:51:48 eroncoroni ship $";
    public static final boolean RCS_ID_RECORDED = 
        VersionInfo.recordClassVersion("$Header: xXGamSolicitudCrearSuperUserCO.java 1.1 2013/02/27 10:51:48 eroncoroni ship $", 
                                       "%packagename%");
    ...
    public static final String sqlKit2 = 
        "SELECT NVL(XIK.KIT_ID,-1) , XUK.KIT_CODE , FLV.MEANING FROM XXGAM_HR_UNIFORMS_KIT_V XUK , XXGAM_INV_KIT XIK , FND_LOOKUP_VALUES FLV WHERE 1 = 1 AND XUK.KIT_CODE = XIK.KIT_COD(+) AND FLV.LOOKUP_TYPE = \'GAM_HR_UNIFORMES\' AND XUK.KIT_CODE = FLV.LOOKUP_CODE AND XUK.LANGUAGE = FLV.LANGUAGE AND XUK.LANGUAGE = \'ESA\' AND XUK.PERSON_ID = ?";
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        OAFormValueBean oaUserIdBean = 
            (OAFormValueBean)oapagelayoutbean.findIndexedChildRecursive("userIdSL");
        oaUserIdBean.setValue(pageContext, (Object)null);
        OAMessageLovInputBean oaSelectEmployeeNameBean = 
            (OAMessageLovInputBean)oapagelayoutbean.findIndexedChildRecursive("SelectEmployeeName");
        ...
        xXGamInvSoliDtlVOImpl invSoliDtlVOpImpl = 
        ...
        if (!v_estatusEmployee.toString().equals("1") && 
            ...
            OAButtonBean CrearPedidoBean = 
                (OAButtonBean)webBean.findIndexedChildRecursive("CrearPedido");
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        while (enums.hasMoreElements()) {
            ...
            System.out.println("Param name:-->" + paramName + ";Value:-->" + 
                               pageContext.getParameter(paramName));
        }
       ...
       * */
        ...
        pageContext.writeDiagnostics(this, 
                                     "xXGamSolicitudCrearSuperUserCO - Version 1.1 - processFormRequest ", 
                                     3);
        pageContext.writeDiagnostics(this, 
                                     "xXGamSolicitudCrearSuperUserCO - Initial Variable", 
                                     3);
        OAPageLayoutBean oapagelayoutbean = pageContext.getPageLayoutBean();
        OAMessageStyledTextBean nombreEmpleadoBean = 
            (OAMessageStyledTextBean)oapagelayoutbean.findIndexedChildRecursive("nombreEmpleado");
        ...
        pageContext.writeDiagnostics(this, 
                                     "xXGamSolicitudCrearSuperUserCO - get Event", 
                                     3);
        ...
        if ("lovPrepare".equals(lEvent)) {
            if (pageContext.getLovInputSourceId().toString().equals("SelectEmployeeName")) {
                ...
                try {
                    globalEmployeeName = 
                            nombreEmpleadoBean.getValue(pageContext).toString();
                    System.out.println("Valor en LovPrepare: " + 
                                       globalEmployeeName);
                } catch (Exception e) {
                ...
                System.out.println("Valor que se recupera lovPrepare: " + 
                                   globalEmployeeName);
        ...
        if ("lovUpdate".equals(lEvent) && 
            pageContext.getLovInputSourceId().toString().equals("SelectEmployeeName")) {
            ...
            System.out.println("Nuevo valor: " + 
                               pageContext.getParameter("SelectEmployeeName").toString());

            if (flagInsert.equals("N")) {
                if (!pageContext.getParameter("SelectEmployeeName").toString().equals(globalEmployeeName) && 
                    globalEmployeeName != "INICIAL") {
                    flagInsert = "Y";
                    am.setRenderOptions("BtnCrearPedidoSuperRender", false);
                    ...
                    xXGamInvSoliVOImpl invSoliVOImpl = 
                        (xXGamInvSoliVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliVO1");
                    xXGamInvSoliDtlVOImpl invSoliDtlVOpImplclr = 
                        (xXGamInvSoliDtlVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliDtlVO1");
                    invSoliVOImpl.initQuery("-1");
        ...
        if ("crea".equals(lEvent)) {
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Event Crea", 
                                         3);
            OAFormValueBean oaUserIdBean = 
                (OAFormValueBean)oapagelayoutbean.findIndexedChildRecursive("userIdSL");
            OAFormValueBean oaPersonIdBean = 
                (OAFormValueBean)oapagelayoutbean.findIndexedChildRecursive("PersonIdSL");
            if (oaPersonIdBean.getValue(pageContext) == null) {
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - No selecciono un Empleado de la LOV correctamente", 
                                             3);
            ...
            try {
                lPerson = 
                        new Number((String)oaPersonIdBean.getValue(pageContext));
                lUser = new Number(oaUserIdBean.getValue(pageContext));
            } catch (SQLException var131) {
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - al convertir PersonId y UserId Error: " + 
                                             var131.getMessage().toString(), 
                                             3);
            }
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - PersonId: " + 
                                         lPerson.toString(), 3);
            xXGamInvSoliVOImpl invSoliVOImplclr = 
                (xXGamInvSoliVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliVO1");
            xXGamInvSoliDtlVOImpl invSoliDtlVOpImplclr = 
                (xXGamInvSoliDtlVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliDtlVO1");
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Inicializamos las VO para que no traigan nada ", 
                                         3);
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - buscamos el KIT - sqlKit por Person_Id", 
                                         3);
            String lSuperUser = 
         ...
         * */
            ...
            try {
                ...
                if (rsK.next()) {
                    ...
                    pageContext.writeDiagnostics(this, 
                                                 "xXGamSolicitudCrearSuperUserCO - KIT: " + 
                                                 lKitCode, 3);
                }

            } catch (SQLException var129) {
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - sqlKit Error: " + 
                                             var129.getMessage().toString(), 
                                             3);
            } finally {
                try {
            ...
            System.out.println("Valor de cuenta por Defecto: " + 
                               lAccountDefault);

            String lMessageError;
            if (lKitId.longValue() == (long)-1) {
                String lmensage = 
                    am.getMessageError(pageContext, webBean, Integer.parseInt(pageContext.getParameter("PersonIdSL")));
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Completamos los datos del kit por pantalla", 
                                         3);
            OAMessageStyledTextBean oanombreEmpleadoBean = 
                (OAMessageStyledTextBean)oapagelayoutbean.findIndexedChildRecursive("nombreEmpleado");
            ...
            xXGamInvSoliVOImpl invSoliVOImpl = 
                (xXGamInvSoliVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliVO1");
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Buscamos los datos del empleado sqlNombreEmpleado", 
                                         3);
            ...
            try {
                ...
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - Crea Nro de Solicitud: " + 
                                             soliD.trim().toString(), 3);
            } catch (SQLException var127) {
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - sqlNombreEmpleado Error: " + 
                                             var127.getMessage().toString(), 
                                             3);
            } finally {
                try {
                    pstmtSoli.close();
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Buscamos las dotaciones configuradas-sqlDota", 
                                         3);
            ...
            try {
                ...
                while (rsD.next()) {
                    ...
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("SoliId", 
                                                                   lSoliId);
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("SoliDtlId", 
                                                                   Long.valueOf(rsD.getLong(1)));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("DotaId", 
                                                                   Long.valueOf(rsD.getLong(2)));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("UniformTypeCod", 
                                                                   rsD.getString(3));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("Nomenclature", 
                                                                   rsD.getString(4));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("MeasureUnitCod", 
                                                                   rsD.getString(5));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("CycleCod", 
                                                                   rsD.getString(6));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("QtyPlanta", 
                                                                   Long.valueOf(rsD.getLong(7)));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("QtyEventual", 
                                                                   Long.valueOf(rsD.getLong(8)));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("SustitucionSwitcher", 
                                                                   rsD.getString(9));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("Status", 
                                                                   rsD.getString(10));
                    invSoliDtlVOpImpl.getCurrentRow().setAttribute("Attribute1", 
                                                                   lAdscr);
                    if ("Planta".equals(lAdscr)) {
                        invSoliDtlVOpImpl.getCurrentRow().setAttribute("Attribute2", 
                                                                       rsD.getString(7));
                    } else {
                        invSoliDtlVOpImpl.getCurrentRow().setAttribute("Attribute2", 
                                                                       rsD.getString(8));
                    ...
                    lFlagLoop = true;
                    pageContext.writeDiagnostics(this, 
                                                 "xXGamSolicitudCrearSuperUserCO - Crea Dotacion Detalle Id : " + 
                                                 rsD.getString(1), 3);
                }
                ...
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - sqlDota Error: " + 
                                             var132.getMessage().toString(), 
                                             3);
            } finally {
                try {
                    pstmtDota.close();
        ...
        if ("grabar".equals(lEvent)) {
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Event Grabar", 
                                         3);
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - ejecuta XXGAM_INV_MOVEORDER_PKG.VALIDA_SUSTITUTOS", 
                                         3);
            ...
            try {
                ...
                pstmtSust.close();
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - ejecutado con exito", 
                                             3);
            } catch (SQLException var126) {
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - pstmtSust Error: " + 
                                             var126.getMessage().toString(), 
                                             3);
            ...
            oadbtransactionimpl.commit();
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Commit Fin Grabar", 
                                         3);
            xXGamInvSoliDtlVOImpl invSoliDtlVOImpl1 = 
                (xXGamInvSoliDtlVOImpl)oaapplicationmodule.findViewObject("xXGamInvSoliDtlVO1");
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Reconsulto la VO para el Soli Id" + 
                                         lSoliIdC.toString(), 3);
        ...
        if ("generarpedido".equals(lEvent)) {
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Event generarpedido", 
                                         3);
            OAFormValueBean oaStatusBean = 
                (OAFormValueBean)oapagelayoutbean.findIndexedChildRecursive("StatusHDR");
            OAButtonBean oaButtonBean = 
                (OAButtonBean)oapagelayoutbean.findIndexedChildRecursive("generarpedido");
            ...
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - Ejecuta concurrente para SOLI ID " + 
                                         lSoliIdSTR, 3);
            Number lReqId = 
            ...
            if (lReqId.compareTo(0) <= 0) {
                ...
                pageContext.writeDiagnostics(this, 
                                             "xXGamSolicitudCrearSuperUserCO - Error al ejecutar concurrente", 
                                             3);
                MessageToken[] tokens8 = 
                    new MessageToken[] { new MessageToken("MESSAGE", 
                                                          lMessageE1) };
            ...
            MessageToken[] tokens7 = 
                new MessageToken[] { new MessageToken("MESSAGE", 
                                                      ...
                                                      lReqId.toString()) };
            pageContext.writeDiagnostics(this, 
                                         "xXGamSolicitudCrearSuperUserCO - verifique el concurrente REQUEST ID: " + 
                                         lReqId.toString(), 3);
            OAException message1 = 
                new OAException("FND", "FND_GENERIC_MESSAGE", tokens7, (byte)3, 
                                (Exception[])null);
