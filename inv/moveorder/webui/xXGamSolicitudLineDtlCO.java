...
public class xXGamSolicitudLineDtlCO extends OAControllerImpl {
   ...
   public static final String RCS_ID = "$Header: xXGamSolicitudLineDtlCO.java 1.1 2013/02/27 10:51:48 eroncoroni ship $";
   public static final boolean RCS_ID_RECORDED = VersionInfo.recordClassVersion("$Header: xXGamSolicitudLineDtlCO.java 1.1 2013/02/27 10:51:48 eroncoroni ship $", "%packagename%");
   ...
   public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
      ...
      xXGamInvLineDtlVOImpl invSoliLineDtlVOImpl = (xXGamInvLineDtlVOImpl)oaapplicationmodule.findViewObject("xXGamInvLineDtlVO1");
   ...
   public void processFormRequest(OAPageContext pageContext, OAWebBean webBean) {
      super.processFormRequest(pageContext, webBean);
       ...
       if("linkPage".equals(lEvent)) {
          ...
          if (pOrigen.equals("A")){
              pageContext.setForwardURL("OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/webui/xXGamSolicitudActualizaPG", (String)null, (byte)0, (String)null, params, true, "N", (byte)99);
