...
public class XxGamSizesUniformsAMImpl extends OAApplicationModuleImpl {
    ...
    public static void main(String[] args) { /* package name */
            /* Configuration Name */launchTester("xxgam.oracle.apps.inv.moveorder.siz.server", 
                                                 "XxGamSizesUniformsAMLocal");
    }
    ...
    public String fillPersonSizeUniformsInfo(String userName, int userId) {
        ...
        XxGamPersonalUniformInfoVOImpl SizesPersonalUniformInfoVOImpl = 
            getXxGamPersonalUniformInfoVO1();
        ...
        if (null != SizesPersonalUniformInfoVOImpl) {
            ...
            SizesPersonalUniformInfoRow = 
                    (XxGamPersonalUniformInfoVORowImpl)SizesPersonalUniformInfoVOImpl.createRow();
          ...
          String strAssignmentID = null;*/
            ...
            String[] arrayFullNameEmpNumSex = 
                this.getFulNameEmpNumSex(strPersonID, connection);
            ...
            String[] arrayPersonTypeId = 
                this.getPersonTypeID(strPersonID, connection);
            ...
            String[] arrayOrganizationInfo = 
                this.getOrganizationInfo(strPersonID, connection);
            ...
            String[] arrayGradeInfo = 
                this.getGradeInfo(strPersonID, connection);
            ;
            ...
            String[] arrayPositionInfo = 
                this.getPositionInfo(strPersonID, connection);
            if (null != arrayPositionInfo[0]) {
                ...
                String strShortPosition = 
                    arrayPositionInfo[2].substring(arrayPositionInfo[2].indexOf('.', 
                                                                                3) + 
                                                   1);
                if (null == SizesPersonalUniformInfoRow.getCategoriaGr() || 
                    "".equals(SizesPersonalUniformInfoRow.getCategoriaGr())) {
                    SizesPersonalUniformInfoRow.setCategoriaGr(strShortPosition);
                }
            }

            String[] arrayPayrollInfo = 
                this.getPayrollInfo(strPersonID, connection);
            ...
            String[] arrayAccountingInfo = 
                this.getAccountingInfo(strPersonID, connection);
            ...
            String[] arrayHrLocationZona = 
                this.getHrLocationZonaInfo(strPersonID, connection);
            ...
            String kitsAviables = /*Organizacion*/
                /*Posicion*/
                /*Sexo*/
                /*Payroll*/
                /*Zona*/
                /* Tipo Empleado (P) (E) */
                this.fillAvailableKitsInfo(arrayOrganizationInfo[2], 
                                           arrayPositionInfo[2], 
                                           arrayFullNameEmpNumSex[3], 
                                           arrayPayrollInfo[2], 
                                           arrayHrLocationZona[3], 
                                           arrayInvAssignExcept[1], 
                                           connection);
            ...
            System.out.println("DEBUG GNOSISHCM " + 
                               ...
                               " " + methodName);
            System.out.println("DEBUG GNOSISHCM " + 
                               "Empty VO, sizesPersonalUniformInfo is NULL!");
     ...
     */
    public String getPersonIdFromUserID(String userName, 
    ...
    private String[] getOrganizationInfo(String strPersonID, 
        ...
        String strPrpStmt = 
            ...
            " AND  paaf.person_id = ? " + " and paaf.primary_flag = 'Y' " + 
            " AND  TRUNC(SYSDATE) BETWEEN paaf.effective_start_date " + 
            "                        AND paaf.effective_end_date " + 
        ...
        try {
            prepStmt = 
                    pConnection.prepareStatement(strPrpStmt, ResultSet.TYPE_FORWARD_ONLY, 
                                                 ResultSet.CONCUR_READ_ONLY);
            prepStmt.setDouble(1, new Double(strPersonID));
            resultSet = prepStmt.executeQuery();
    ...
    private String[] getAccountingInfo(String strPersonID, 
        ...
        int counter = 0;
        String strPrepStmt = 
            " SELECT gcc.code_combination_id " + "   ,gcc.segment3 cost_center " + 
            "   ,gcc.segment4 station " + "   ,gcc.segment1||'-'|| " + 
    ...
    private String[] getHrLocationZonaInfo(String strPersonID, 
        ...
        try {
            ...
            retval[0] = 
                    "EXCEPTION al obtener la zona del empleado:" + sqle.getErrorCode() + 
                    " , " + sqle.getMessage();
        }
    ...
    public ArrayList<String> fillAvailableKitsInfo(String pStrOrganization, 
        ...
        try {
            ...
            while (resultSet.next()) {
                System.out.println("DEBUG GNOSISHCM kit " + counter + ":  " + 
            ...
            kitsAssig.add("EXCEPTION al obtener los kits disponibles en funcion de organizacion, puesto, genero. " + 
                          sqle.getErrorCode() + " , " + sqle.getMessage());
            return kitsAssig;
        }
    ...
    *****************************************************************************/
        ...
        if (null != strNumUNIS) {
            if (strNumUNIS.contains("EXCEPTION")) {
                ...
                String valAperturaPeriodos = 
                    this.valAperturaPeriodsKits(strAvailableKits, connection);
    ...
    String fillPersonSizeKitAssig(HashSet<String> pHashSet, String pKitAssig) {
        String retval = null;
        ...
        if (null != KitItemsInfoVOImpl) {
            ...
            String strPrepStmt = 
                " SELECT XID.KIT_COD " + "   , XID.DOTA_ID " + "   , XID.UNIFORM_TYPE_COD " + 
                "   , XID.PLANTA_QTY " + "   , XID.EVENT_QTY " + 
                "   , XID.MEASURE_UNIT_COD " + "   , XID.CYCLE_COD " + 
                "   , XID.NOMENCLATURE " + "   , XID.NP_COD " + 
                " FROM XXGAM_INV_DOTA XID " + " WHERE 1=1 " + 
            ...
            try {
                ...
                while (resultSet.next()) {
                    ...
                    if (!(isInHashSet(pHashSet, LinesQuery))) {
                        ...
                        KitItemsInfoVORow = 
                                (XxGamKitItemsInfoVORowImpl)KitItemsInfoVOImpl.createRow();
                        ...
                        XxGamPersonalUniformInfoVORowImpl SizesPersonalUniformInfoRow = 
                            null;
                        if (null != SizesPersonalUniformInfoVOImpl) {
                            System.out.println("Into SizesPersonalUniformInfoVOImpl");
                            SizesPersonalUniformInfoRow = 
                                    (XxGamPersonalUniformInfoVORowImpl)SizesPersonalUniformInfoVOImpl.first();
                            String[] arrayPersonIds = new String[6];
                            String[] outArraySizes = new String[5];

                            arrayPersonIds[0] = 
                                    SizesPersonalUniformInfoRow.getPersonID();
                            arrayPersonIds[1] = 
                                    SizesPersonalUniformInfoRow.getAssigmentID();
                            arrayPersonIds[2] = 
                                    SizesPersonalUniformInfoRow.getGradeID();
                            arrayPersonIds[3] = 
                                    SizesPersonalUniformInfoRow.getCodeCombinationID();
                            arrayPersonIds[4] = 
                                    SizesPersonalUniformInfoRow.getPersonTypeID();
                            arrayPersonIds[5] = 
                                    resultSet.getString("NOMENCLATURE");
                ...
                System.out.println("DEBUG GNOSISHCM " + "SQLEXCEPTION" + 
                                   sqle.getErrorCode() + " , " + 
                                   sqle.getMessage());
                retval = 
                        "EXCEPTION al obtener los kits disponibles en funcion de organizacion, puesto, genero. " + 
    ...
    public String setSizesUpdateInsert(ArrayList<String> kitTypes, 
        ...
        XxGamPersonalUniformInfoVOImpl ConsultPersonalUniformInfoVOImpl = 
            this.getXxGamPersonalUniformInfoVO1();
        XxGamPersonalUniformInfoVORowImpl ConsultPersonalUniformInfoVORowImpl = 
            null;

        if (null != ConsultPersonalUniformInfoVOImpl) {
            ConsultPersonalUniformInfoVORowImpl = 
                    (XxGamPersonalUniformInfoVORowImpl)ConsultPersonalUniformInfoVOImpl.first();

            System.out.println("DEBUG GNOSISHCM Into TempPersonalUniformInfoVOImpl");

            System.out.println("PersonID:  " + 
                               ConsultPersonalUniformInfoVORowImpl.getPersonID());
            System.out.println("AssignmentID:  " + 
                               ConsultPersonalUniformInfoVORowImpl.getAssigmentID());
            System.out.println("JobID:  " + 
                               ConsultPersonalUniformInfoVORowImpl.getGradeID());
            System.out.println("CodeCombination:  " + 
                               ConsultPersonalUniformInfoVORowImpl.getCodeCombinationID());
            System.out.println("PersonTypeID:  " + 
                               ConsultPersonalUniformInfoVORowImpl.getPersonTypeID());
            ...
            System.out.println("[New]Observaciones: " + 
                               pKitValues[9]); //Add by SEJR 30032017
        ...
        XxGamSizesUniformsHistoryVOImpl SizesUniformsHistoryVOImpl = 
            this.getXxGamSizesUniformsHistoryVO1();
        ...
        if (null != SizesUniformsHistoryVOImpl) {
            ...
            if (!SizesUniformsHistoryVOImpl.isPreparedForExecution()) {
                ...
                SizesUniformsHistoryVOImpl.initQueryUpdateRegisters(arrayParameters, 
                                                                    pKitValues[6]);
                System.out.println("Fetched Row Count:" + 
                                   SizesUniformsHistoryVOImpl.getFetchedRowCount());
            } else {
            ...
            System.out.println("XxGamSizesUniformsHistoryVO RowCount" + 
                               SizesUniformsHistoryVOImpl.getRowCount());
            System.out.println("XxGamSizesUniformsHistoryVO FetchedRowCount()" + 
                               SizesUniformsHistoryVOImpl.getFetchedRowCount());

            System.out.println("Result of Excecute  SizesUniformsHistoryVOImpl  " + 
                               arrayParameters[0]);

            RowSetIterator rowSetIteratorHistory = 
                SizesUniformsHistoryVOImpl.createRowSetIterator(null);
            XxGamSizesUniformsHistoryVORowImpl SizesUniformsHistoryVORow = 
                null;

            System.out.println("rowSetIteratorHistory count:  " + 
                               rowSetIteratorHistory.getRowCount());
            System.out.println("rowSetIteratorHistory count:  " + 
                               rowSetIteratorHistory.getFetchedRowCount());
                ...
                if (null != rowSetIteratorHistory) {
                    if (rowSetIteratorHistory.getFetchedRowCount() != 0) {
                        ...
                        while (rowSetIteratorHistory.hasNext()) {
                            ...
                            SizesUniformsHistoryVORow = 
                                    (XxGamSizesUniformsHistoryVORowImpl)rowSetIteratorHistory.next();
                            ...
                            System.out.println("Consult KIT: " + 
                                               SizesUniformsHistoryVORow.getKitCod());

                            String[] updateValues = /*Inventory Id*/
                                this.paramsKitConsult(connection, 
                                                      SizesUniformsHistoryVORow.getKitCod(), 
                                                      pKitValues[6], 
                                                      pKitValues[4]);
                            ...
                            if (!updateValues[0].contains("EXCEPTION")) {
                                ...
                                System.out.println("[New Sucess Update]Observaciones:" + 
                                                   pKitValues[9]); //Add by SEJR 30032017
                        ...
                        for (String kitTemp: kitTypes) {
                            if (!isInHashSet(KitsHashSet, kitTemp)) {
                                String[] updateValues = /*Inventory Id*/
                                    this.paramsKitConsult(connection, kitTemp, 
                                                          pKitValues[6], 
                                                          pKitValues[4]);
                                if (!updateValues[0].contains("EXCEPTION")) {
                                    /**si el KIT no esta, INSERTA un Registro*/
                                    XxGamSizesUniformsHistoryVORowImpl SizesUniformsHistoryVORowInsert = 
                                        (XxGamSizesUniformsHistoryVORowImpl)SizesUniformsHistoryVOImpl.createRow();
                                    System.out.println("No match KIT: " + 
                                                       kitTemp);
                                    ...
                                    System.out.println("[New Update/Insert]Observaciones:" + 
                                                       pKitValues[9]); //Add by SEJR 30032017
                                    System.out.println("XXGAM_INV_SIZ_UNIF_HISTORY_S:" + 
                                                       SizesUniformsHistoryVORowInsert.getUnifId());
                        ...
                        System.out.println("Sequence: " + 
                                           getOADBTransaction().getSequenceValue("XXGAM_INV_SIZ_UNIF_HISTORY_S"));
                        for (String kitTemp: kitTypes) {
                            /*preguntamos si existe Articulo en KIT*/
                            if (this.kitConsult(connection, kitTemp, 
                                                pKitValues)) {
                                ...
                                if (!updateValues[0].contains("EXCEPTION")) {
                                    ...
                                    SizesUniformsHistoryVORow.setInventoryId(converteStringToNumber(pKitValues[4]));
                                    SizesUniformsHistoryVORow.setAttribute1(pKitValues[9]); //Add by SEJR 30032017
                                    System.out.println("[New Sucess Insert]Observaciones:" + 
                                                       pKitValues[9]); //Add by SEJR 30032017
     ...
     * @param kitValues
     */
    public boolean kitConsult(Connection connection, String kitType, 
                              String[] kitValues) {
        ...
        String strQuery = 
            " SELECT DISTINCT 'X' FLAG " + "  FROM XXGAM_INV_DOTA " + 
            "  WHERE 1=1 " + "      AND KIT_COD = ? " + 
            "      AND NP_COD = ? " + "      AND NOMENCLATURE = ?  ";
        /***********************************
                         "      AND PLANTA_QTY = ? " +
                         "      AND EVENT_QTY = ? ";
                        ***********************************/
        ...
        try {
            ...
            prepStmt = 
                    connection.prepareStatement(strQuery, ResultSet.TYPE_FORWARD_ONLY, 
                                                ResultSet.CONCUR_READ_ONLY);
            ...
            System.out.println("CAUSE:  " + sqle.getCause() + "CODE: " + 
                               sqle.getErrorCode());
        }
        this.closePreparedStatement(prepStmt);
        this.closeResultSet(resultSet);
    ...
    public void sizesConsult(String[] pArrayPersonIds, String[] pOutSizes) {
        ...
        String stmtQuery = //Add by SEJR 30032017
            " SELECT TALLA_ID " + "        ,TALLA_NBR " + 
            "        ,INVENTORY_ID " + "        ,ATTRIBUTE1 " + 
            "  FROM XXGAM_INV_SIZ_UNIF_HISTORY " + "  WHERE 1=1 " + 
            "    AND PERSON_ID = ?  " + "    AND ASSIGNMENT_ID = ?  " + 
            "    AND JOB_ID =  ?" + "    AND CODE_COMBINATION_ID = ?  " + 
            "    AND PERSON_TYPE_ID = ?  " + "    AND NOMENCLATURE = ?  ";
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                pOutSizes[4] = 
                        resultSet.getString("ATTRIBUTE1"); // Add by SEJR 30032017
            }
    ...
    private boolean isInHashSet(HashSet<String> pHashSet, String pLines) {
        ...
        try {
            ...
            System.out.println("DEBUG GNOSISHCM EXCEPTION:  " + e.getCause() + 
                               e.getMessage());
        }
        return retval;
    }
    ...
    public com.sun.java.util.collections.List valAllTallasFilled() {
        ...
        RowSetIterator KitItemsInfoIter = 
            KitItemsInfoVOImpl.createRowSetIterator(null);
        while (KitItemsInfoIter.hasNext()) {
            KitItemsInfoVORowImpl = 
                    (XxGamKitItemsInfoVORowImpl)KitItemsInfoIter.next();
            ...
            if (null == strSizeLOV || null == strInventoryId || 
                null == strTallaId || 
                ("".equals(strSizeLOV) || "".equals(strInventoryId) || 
                 "".equals(strTallaId))) {
    ...
    public com.sun.java.util.collections.List validValuesRowByRow() {
        ...
        while (KitItemsInfoIter.hasNext()) {
            ...
            if (null != strSizeLov && !"".equals(strSizeLov)) {
                ...
                String[] arrayValidarTallasCorrectas = 
                    this.validarTallasCorrectas(strDotaID, strSizeLov, 
                                                strNPCode, connection);
                if (null != arrayValidarTallasCorrectas[0]) {
                    if (arrayValidarTallasCorrectas[0].contains("EXCEPTION")) {
                        retval.add(new OAException(strNomenclature + ": " + 
                                                   arrayValidarTallasCorrectas[0], 
                                                   OAException.ERROR));
                    } else {
    ...
    private String[] validarTallasCorrectas(String strDotaID, 
        ...
        String stmtQuery = 
            " select    xit.dota_id " + "        , xit.talla_id " + 
            "        , xid.nomenclature||'  '||xit.talla_nbr description " + 
            "        , xit.kit_cod " + "        , xit.talla_nbr " + 
            "        , xit.inventory_id " + "        , xit.inventory_cod " + 
            "        , xit.np_cod " + " from      xxgam_inv_talla xit " + 
            "        , xxgam_inv_dota xid " + " where 1=1 " + 
            " and xit.dota_id = xid.dota_id " + " and xid.dota_id = ? " + 
            " and xit.talla_nbr = ? " + " and xit.np_cod = ?";
        ...
        try {
            ...
            retval[0] = 
                    "EXCEPTION al validar la talla:" + strSizeLov + " ,dotaID:" + 
                    strDotaID + " ," + sqle.getMessage() + ", " + 
                    sqle.getErrorCode();
            return retval;
        }
        ...
        if (0 == counter) {
            retval[0] = 
                    "EXCEPTION al validar la talla:" + strSizeLov + " ,dotaID:" + 
                    strDotaID + ". No se encontraron Registros.";
            return retval;
        }
    ...
    private String valAperturaPeriodsKits(String strAvailableKits, 
        ...
        int counter = 0;
        String strShortAvailableKits = 
            strAvailableKits.substring(0, strAvailableKits.length() - 1);
        String stmtQuery = 
        ...
        try {
            ...
            retval = 
                    "EXCEPTION: al validar en el lookup XXGAM_APERTURA_DE_PERIODOS " + 
        ...
        if (0 == counter) {
            retval = 
                    "EXCEPTION Los kits:" + strShortAvailableKits + " no estan abiertos.";
            return retval;
        }
     ...
     * @param invId
     */
    public String[] paramsKitConsult(Connection connection, String kitType, 
                                     String nomenclature, String invId) {
        ...
        String strQuery = 
            "  select " + "          XIT.DOTA_ID " + "        , XIT.TALLA_ID " + 
            "        , XIT.INVENTORY_ID " + "        , XID.NOMENCLATURE " + 
            "        , XIT.KIT_COD " + "  from   XXGAM_INV_TALLA XIT " + 
            "        , XXGAM_INV_DOTA XID " + "  where 1=1 " + 
            "  and XIT.DOTA_ID = XID.DOTA_ID " + "  and  XIT.KIT_COD = ? " + 
            "  and XID.NOMENCLATURE = ? " + "  and XIT.inventory_id = ? ";
    ...
    public String valAperturaPeriodsKitsV2(String strAvailableKits, 
        ...
        if (0 == counter) {
            retval = 
                    "EXCEPTION El kit:" + strAvailableKits + " no esta abierto.";
            return retval;
        }
        this.closePreparedStatement(prepStatement);
        this.closeResultSet(resultSet);
     ...
     * @param connection
     */
    public String validateExistUnis(String pPersonId, String pCategory, 
                                    String pKitCod, Connection connection) {
        String retval = "Success";

        int counter = 0;

        String stmtQuery = 
            "  select xis.NRO_SOLICITUD  " + "        ,xis.PERSON_ID  " + 
            "        ,xis.EMPLOYEE_NUMBER  " + "        ,xis.SOLI_DATE  " + 
            "        ,xis.STATUS  " + "  from XXGAM_INV_SOLI xis  " + 
            "  where 1=1  " + "  and xis.person_id = ?  " + 
            "  and exists     (  " + "                        select 'Y'  " + 
            "                        from  fnd_lookup_values flv  " + 
            "                        where  flv.lookup_type = 'XXGAM_APERTURA_DE_PERIODOS'  " + 
            "                        and  flv.language = sys_context('USER','LANG')  " + 
    ...
    public String getNumberUNIS() {
        ...
        if (null != PersonalUniformInfoVOImpl) {
            PersonalUniformInfoVORowImpl = 
                    (XxGamPersonalUniformInfoVORowImpl)PersonalUniformInfoVOImpl.getCurrentRow();
            if (null != PersonalUniformInfoVORowImpl) {
                oracle.jbo.domain.Number numPersonID = null;
                try {
                    numPersonID = 
                            new oracle.jbo.domain.Number(PersonalUniformInfoVORowImpl.getPersonID());
                } catch (SQLException e) {
                    throw new OAException("Exception al convertir a numerico el PersonID:" + 
                                          PersonalUniformInfoVORowImpl.getPersonID(), 
                                          OAException.ERROR);
                }
                if (null != numPersonID) {
                    String retval2nd = 
     ...
     */
    public String getGrupoPagoFromLkp(String p_grupoPago, 
                                      Connection connection) {
        String v_grupoPago = null;
        int counter = 0;
        String strPrepStmt = 
            " SELECT FLV.meaning " + " FROM FND_LOOKUP_VALUES FLV " + 
            " WHERE 1 = 1" + "  AND FLV.DESCRIPTION = ? " + 
        ...
        try {
            ...
            v_grupoPago = 
                    "EXCEPTION al obtener el Grupo de Pago:" + sqle.getErrorCode() + 
                    " , " + sqle.getMessage();
        }
        this.closeResultSet(resultSet);
        this.closePreparedStatement(prepStmt);
        ...
        if (counter > 1) {
            v_grupoPago = 
                    "EXCEPTION al obtener el Grupo de Pago en Lookup:Mas de un registro.";
        }
        return v_grupoPago;
    }
    ...
    public boolean getValidGrupoPago(String p_grupoPago) {
        ...
        String v_grupoPago;
        OADBTransaction oaDBTransaction = 
            this.getOADBTransaction(); //Add by SEJR 30032017
        Connection connection = 
            oaDBTransaction.getJdbcConnection(); //Add by SEJR 30032017
        v_grupoPago = 
                this.getGrupoPagoFromLkp(p_grupoPago, connection); //Add by SEJR 30032017
        System.out.println("[getValidGrupoPago] obteniendo de lkp:" + 
                           v_grupoPago); //Add by SEJR 30032017
        if (null != v_grupoPago) {
