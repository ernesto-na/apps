...
public class XxGamCaptureSizesUniformsCO extends OAControllerImpl {
    ...
    private final String messageConfirmation = 
        "Las tallas se guardaron satisfactoriamente.";
    private final String messageExceptionUNI = 
        "Lo sentimos. Ya existe creada una UNI.";
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        OAHeaderBean HeaderEmployeeRNBean = 
            (OAHeaderBean)webBean.findChildRecursive("HeaderEmployeeRN");
        if (null != HeaderEmployeeRNBean) {
            System.out.println("TTT");
            HeaderEmployeeRNBean.setWrapEnabled(true);
            HeaderEmployeeRNBean.setAttributeValue(OAWebBeanConstants.BACKGROUND_ATTR, 
                                                   OAWebBeanConstants.BACKGROUND_TRANSPARENT);

        }
        OAMessageComponentLayoutBean MsgCompLayEmployeeRNBean = 
            (OAMessageComponentLayoutBean)webBean.findChildRecursive("MsgCompLayEmployeeRN");

        if (null != MsgCompLayEmployeeRNBean) {
            MsgCompLayEmployeeRNBean.setAttributeValue(OAWebBeanConstants.BACKGROUND_ATTR, 
                                                       OAWebBeanConstants.BACKGROUND_TRANSPARENT);
        }
        ...
        System.out.println("DEBUG GNOSISHCM " + 
                           XxGamCaptureSizesUniformsCO.class.getName() + " " + 
                           methodName);

        XxGamSizesUniformsAMImpl SizesUniformsAM = 
            (XxGamSizesUniformsAMImpl)pageContext.getApplicationModule(webBean);
        ...
        if (null != SizesUniformsAM) {
            if (!pageContext.isFormSubmission()) {
                String strGetVal = 
                    SizesUniformsAM.fillPersonSizeUniformsInfo(pageContext.getUserName(), 
                ...
                XxGamPersonalUniformInfoVOImpl PersonalUniformInfoVOImpl = 
                    SizesUniformsAM.getXxGamPersonalUniformInfoVO1();
                XxGamPersonalUniformInfoVORowImpl PersonalUniformInfoVORowImpl = 
                    null;

                RowSetIterator PersonSizeUniformInfoIterator = 
                    PersonalUniformInfoVOImpl.createRowSetIterator(null);

                if (PersonSizeUniformInfoIterator.hasNext()) {
                    PersonalUniformInfoVORowImpl = 
                            (XxGamPersonalUniformInfoVORowImpl)PersonSizeUniformInfoIterator.next();
                    /*Recuperacion de los kits disponibles en un ArrayList*/
                    kitsAssig = 
                            SizesUniformsAM.fillAvailableKitsInfo(PersonalUniformInfoVORowImpl.getOrganization(), 
                    ...
                    System.out.println("[processRequest]Grupo de Pago de Empleado: " + 
                                       PersonalUniformInfoVORowImpl.getPayroll()); //Add by SEJR 30032017
                    //Regla: Permitir solo captura de Observaciones a empleados con Grupo de Pago definido en Lookup
                    OAMessageTextInputBean txtObservaciones = 
                        (OAMessageTextInputBean)webBean.findChildRecursive("Observaciones"); //Add by SEJR 30032017
                    if (SizesUniformsAM.getValidGrupoPago(PersonalUniformInfoVORowImpl.getPayroll()) == 
                        true) //Add by SEJR 30032017
                    {
                    ...
                    while (iterkitsAssig.hasNext()) {
                        ...
                        if (null != getVal) {
                            if (getVal.contains("EXCEPTION")) {
                                OAWebBean EmployeeKitSizesRNBean = 
                                    webBean.findChildRecursive("EmployeeKitSizesRN");
              ...
              *****************************/
                ...
                System.out.println("DEBUG GNOSISHCM " + 
                                   "Post closeRowSetIterator() encbezado");
                ...
                for (String kitsAssigTemp: kitsAssig) {
                    strKitAssig = 
                            SizesUniformsAM.fillPersonSizeKitAssig(ElementsHashSet, 
                                                                   kitsAssigTemp);
                }
                ...
                if (null != strKitAssig) {
                    if (strKitAssig.contains("EXCEPTION")) {
                        System.out.println("DEBUG GNOSISHCM Exception in VO Assign-->" + 
                                           strKitAssig);
                ...
                System.out.println("DEBUG GNOSISHCM " + 
                                   "pageContext.isFormSubmission() ERROR");
            } /** END if(null!=SizesUniformsAM){ **/


            /**Modificado por NRC 23-feb-2017*/
            String strpSavePrendasInfo = 
                pageContext.getParameter("pSavePrendasInfo");
            System.out.println("strpSavePrendasInfo:" + strpSavePrendasInfo);
            if (null != strpSavePrendasInfo && 
                !"".equals(strpSavePrendasInfo)) {
              ...
              *****************************************************************************/
                ...
                if (null != strNumUNIS) {
                  ...
                  *******************************************************/
                        OADBTransaction oaDBTransaction = 
                            SizesUniformsAM.getOADBTransaction();
                        Connection connection = 
                            oaDBTransaction.getJdbcConnection();
                        for (String kitsAssigTemp: kitsAssig) {
                            String flagPeriod = 
                                SizesUniformsAM.valAperturaPeriodsKitsV2(kitsAssigTemp, 
                                                                         connection);
                ...
                throw new OAException(messageConfirmation, 
            ...
            if (null != strEvent) {
                if (this.LOV_PREPARE.equals(strEvent)) {
                    ...
                    if ("SizesLOV".equals(strLovInputSourceId)) {
                        Row RowSizesInfo = 
                            SizesUniformsAM.findRowByRef(strEvtSrcRowRef);

                        pageContext.putSessionValue("sDotaID", 
                                                    (String)RowSizesInfo.getAttribute("DotaId"));
                    }
              ...
              ******/
                ...
                if ("updateSizes".equals(strEvent)) {
                    ...
                    com.sun.java.util.collections.List listValidValuesRowByRow = 
                        SizesUniformsAM.validValuesRowByRow();
                    if (listValidValuesRowByRow.size() > 0) {
                        OAException.raiseBundledOAException(listValidValuesRowByRow);
                    }

                    com.sun.java.util.collections.List listValAllTallasFilled = 
                        SizesUniformsAM.valAllTallasFilled();
                    ...
                    String[] kitValues = 
                        new String[10]; //Update by SEJR 30032017
                    System.out.println("DEBUG GNOSISHCM Into Update/Insert Sizes Event");
                    XxGamKitItemsInfoVOImpl KitItemsInfoVOImpl = 
                        SizesUniformsAM.getXxGamKitItemsInfoVO1();
                    if (null != KitItemsInfoVOImpl) {
                        /*Recuperamos todo lo depositado en VO*/
                        RowSetIterator KitsSizesInfo = 
                            KitItemsInfoVOImpl.createRowSetIterator(null);
                        if (KitsSizesInfo.hasNext()) {
                            ...
                            while ((row = KitsSizesInfo.next()) != null) {
                                ...
                                System.out.println("DotaId: " + 
                                                   row.getAttribute("DotaId"));
                                System.out.println("SizeLOV: " + 
                                                   row.getAttribute("SizeLOV"));
                                System.out.println("TallaId: " + 
                                                   row.getAttribute("TallaId"));
                                System.out.println("[get from table ]Observaciones:" + 
                                                   row.getAttribute("Observaciones")); //Add by SEJR 30032017
                                kitValues[0] = null;
                                kitValues[1] = 
                                        (String)row.getAttribute("DotaId");
                                kitValues[2] = 
                                        (String)row.getAttribute("TallaId");
                                kitValues[3] = 
                                        (String)row.getAttribute("SizeLOV");
                                kitValues[4] = 
                                        (String)row.getAttribute("InventoryId");
                                kitValues[5] = 
                                        (String)row.getAttribute("NPCode");
                                kitValues[6] = 
                                        (String)row.getAttribute("Nomenclature");
                                kitValues[7] = 
                                        (String)row.getAttribute("PlantaQTY");
                                kitValues[8] = 
                                        (String)row.getAttribute("EventQTY");
                                kitValues[9] = 
                                        (String)row.getAttribute("Observaciones"); //Add by SEJR 30032017
                                /**strSuccessTransaction = SizesUniformsAM.setHistorySizes(XxGamCaptureSizesUniformsCO.kitsAssig, kitValues,*/
                                /**  pageContext); */

                                strSuccessTransaction = 
                                        SizesUniformsAM.setSizesUpdateInsert(XxGamCaptureSizesUniformsCO.kitsAssig, 
                                                                             kitValues, 
                                                                             pageContext);
                                ...
                                System.out.println("strSuccessTransaction   " + 
                                                   strSuccessTransaction);
                                counterRegisters = counterRegisters + 1;
                                System.out.println("counterRegisters:  " + 
                                                   counterRegisters);
                                /**break;*/
                            } /** END While **/
                            if (!strSuccessTransaction.contains("EXCEPTION")) {
                                ...
                                hashMap.put("pSavePrendasInfo", 
                                            strSuccessTransaction); /* com.sun.java.util.collections.HashMap parameters, */
                                    /* boolean retainAM, */
                ...
                if ("GenerarDotEvt".equals(strEvent)) {
                    ...
                    XxGamPersonalUniformInfoVOImpl PersonalUniformInfoVOImpl = 
                        SizesUniformsAM.getXxGamPersonalUniformInfoVO1();
                    XxGamPersonalUniformInfoVORowImpl PersonalUniformInfoVORowImpl = 
                        (XxGamPersonalUniformInfoVORowImpl)PersonalUniformInfoVOImpl.first();
                    ...
                    for (String kitsAssigTemp: kitsAssig) {
                        ...
                        flagUni = 
                                SizesUniformsAM.validateExistUnis(PersonalUniformInfoVORowImpl.getPersonID(), 
                    ...
                    if (!flagUni.contains("EXCEPTION")) {
                        String messageConfirmation = 
                            pageContext.getMessage("XBOL", 
                                                   ...
                                                   null);
                        OAException messageConfirmExc = 
                            new OAException(messageConfirmation, 
                                            OAException.CONFIRMATION);
                        OADialogPage confirmationPage = 
                            new OADialogPage(OAException.CONFIRMATION, 
                                             messageConfirmExc, null, 
                        ...
                        throw new OAException(messageExceptionUNI, 
                                              OAException.WARNING);
    ...
    private void disablePageRegions(OAPageContext pageContext, 
                                    OAWebBean webBean) {
        OAWebBean EmployeeInfoHeaderBean = 
            webBean.findChildRecursive("EmployeeInfoHeader");
        if (null != EmployeeInfoHeaderBean) {
            EmployeeInfoHeaderBean.setRendered(false);
        }
        OAWebBean EmployeeInfoBean = 
            webBean.findChildRecursive("EmployeeInfo");
    ...
    private void disableGenerarDotBtn(OAPageContext pageContext, 
                                      OAWebBean webBean) {
        OAButtonBean GenerarDotBtnBean = 
            (OAButtonBean)webBean.findChildRecursive("GenerarDotBtn");
