...
public class XxGamOrderUniformsAMImpl extends OAApplicationModuleImpl
{
  ...
  {
    launchTester("xxgam.oracle.apps.inv.moveorder.vta.server", /* package name */
      "XxGamOrderUniformsAMLocal" /* Configuration Name */);
  }
  ...
  {
    String retval = null;
    XxGamPersonVtaUniformInfoVOImpl PersonVtaUniformInfoVOImpl = getXxGamPersonVtaUniformInfoVO1();
    ...
    if(null!=PersonVtaUniformInfoVOImpl){
      ...
      PersonVtaUniformInfoVORowImpl = (XxGamPersonVtaUniformInfoVORowImpl)PersonVtaUniformInfoVOImpl.createRow(); 
      ...
      String[] arrayOrganizationInfo = getOrganizationInfo(strPersonID,connection);
      ...
      String[] arrayOperatingUnitInfo = getOperatingUnitInfo(arrayOrganizationInfo[2],connection);
  ...
  */
                                ...
                                , Connection pConnection)
  {
    String retval = null;
    int counter = 0;
    String strPrepStmt = " SELECT  paaf.assignment_id " + 
                          " FROM  per_all_assignments_f       paaf " + 
    ...
    {
       retval = "EXCEPTION al obtener el id de la asignacion:"+sqle.getErrorCode()+" , "+sqle.getMessage();
    }
    ...
    if(counter>1){
      retval = "EXCEPTION al obtener el id de la asignacion: mas de un registro";
    }
                                        ...
                                        Connection pConnection)
  {
    ...
    int counter = 0;
    String strPrepStmt = " SELECT   org.ORGANIZATION_ID org_id" + 
                         "       , org.NAME org_name " + 
                         "       , SUBSTR (org.NAME, 0, 2) " + 
    ...
    {
       retval[0] = "EXCEPTION al obtener la Unidad Operativa:"+sqle.getErrorCode()+" , "+sqle.getMessage();
    }
    ...
    if(counter>1){
      retval[0] = "EXCEPTION al obtener la Unidad Operativa: mas de un registro.";
    }
  ...
  public String fillInputOrderUniforms(String pStrAvailableKits)
  {
    ...
    String strNewAvailableKits = pStrAvailableKits.substring(0,pStrAvailableKits.length()-1);
    System.out.println("pStrAvailableKits:"+pStrAvailableKits);
    System.out.println("strNewAvailableKits:"+strNewAvailableKits);
    XxGamInputOrderUniformsVOImpl InputOrderUniformsVOImpl = getXxGamInputOrderUniformsVO1(); 
      ...
      while(resultSet.next()){
       counter = counter +1; 
        ...
        if (null!=InputOrderUniformsVOImpl){
          ...
          InputOrderUniformsVORowImpl = (XxGamInputOrderUniformsVORowImpl)InputOrderUniformsVOImpl.createRow();
          /****
         ...
         String strValRecords = /* resultSet.getString("UNIFORM_TYPE_COD")+  */
                                /* resultSet.getString("PLANTA_QTY")+        */
                                /* resultSet.getString("EVENT_QTY")+         */
                                /* resultSet.getString("MEASURE_UNIT_COD")+  */
                                /* resultSet.getString("CYCLE_COD")+         */
    ...
    {
      retval = "EXCEPTION al obtener las prendas. "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    closePreparedStatement(prepStmt);
    if(0==counter){
      retval = "EXCEPTION al obtener las prendas: No se encontraron  registros.";
     return retval;
    }
  ...
  public String putPriceListHdrID(OAPageContext pageContext)
  {
    ...
    String strPrepStmt = " select PRICE_LIST_HDR_ID " + 
                         "        ,payroll " + 
                         "        ,PRICE_LIST_DESC " + 
    ...
    try
    {
      ...
      while(resultSet.next()){
        counter = counter +1;
        pageContext.putSessionValue("sPriceListHdrID",resultSet.getString("PRICE_LIST_HDR_ID"));
        break;
      }
      
    } catch (SQLException sqle)
    {
      retval = "EXCEPTION al obtener el ID de la lista de precios. "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    if(0==counter){
     retval = "EXCEPTION al obtener la lista de precios: No se encontraron registros para este empleado.";
     return retval;
    } 
  ...
  public String valFillPersonVtaUniforms()
  {
    ...
    XxGamPersonVtaUniformInfoVOImpl PersonVtaUniformInfoVOImpl = getXxGamPersonVtaUniformInfoVO1(); 
    if(null!=PersonVtaUniformInfoVOImpl){
     System.out.println("FetchedRowCount:"+PersonVtaUniformInfoVOImpl.getFetchedRowCount());
  ...
  public com.sun.java.util.collections.List initReviewInputInfo()
  {
    ...
    XxGamInputOrderUniformsVOImpl InputOrderUniformsVOImpl = getXxGamInputOrderUniformsVO1(); 
    XxGamReviewInpOrderUniformsVOImpl ReviewInpOrderUniformsVOImpl = getXxGamReviewInpOrderUniformsVO1();
    
    XxGamInputOrderUniformsVORowImpl InputOrderUniformsVORowImpl = null; 
    XxGamReviewInpOrderUniformsVORowImpl ReviewInpOrderUniformsVORowImpl = null;
    
    OADBTransaction oaDBTransaction =  this.getOADBTransaction();
    Connection connection = oaDBTransaction.getJdbcConnection();
    
    if(null!=InputOrderUniformsVOImpl){
     RowSetIterator InputOrderUniformsIterator = InputOrderUniformsVOImpl.createRowSetIterator(null);
     while(InputOrderUniformsIterator.hasNext()){
       InputOrderUniformsVORowImpl = (XxGamInputOrderUniformsVORowImpl)InputOrderUniformsIterator.next();
       if(null!=InputOrderUniformsVORowImpl.getTallaID()&&!"".equals(InputOrderUniformsVORowImpl.getTallaID())
         &&(null!=InputOrderUniformsVORowImpl.getQuantity()&&!"".equals(InputOrderUniformsVORowImpl.getQuantity()))){
           if(null!=ReviewInpOrderUniformsVOImpl){
             ...
             String strInventoryID = InputOrderUniformsVORowImpl.getInventoryID();
             String strInvOrgID = InputOrderUniformsVORowImpl.getOrganizationID();
             String strQuantity = InputOrderUniformsVORowImpl.getQuantity();
             String strTallaNbr = InputOrderUniformsVORowImpl.getTallaNbr(); 
             String strNomenclature = InputOrderUniformsVORowImpl.getNomenclature();
             String strValCantidadDisponible = this.valCantidadDisponible(strInventoryID
                                                                         ,strInvOrgID
                                                                         ,strQuantity
                                                                         ,strTallaNbr
                                                                         ,connection); 
             
             System.out.println("strValCantidadDisponible:"+strValCantidadDisponible);
             if(null!=strValCantidadDisponible){
               if(!strValCantidadDisponible.contains("DISPONIBLE")){
                 retval.add(new OAException(strNomenclature+":"+strValCantidadDisponible,OAException.ERROR));
               }
             }
             
             ReviewInpOrderUniformsVORowImpl = (XxGamReviewInpOrderUniformsVORowImpl)ReviewInpOrderUniformsVOImpl.createRow();
            ...
            try
            {
              ReviewInpOrderUniformsVORowImpl.setTotAmount(new oracle.jbo.domain.Number(InputOrderUniformsVORowImpl.getQuantity())
                                                                                       .multiply(InputOrderUniformsVORowImpl.getPrice())
                                                           );
            } catch (SQLException sqle)
            {
               retval.add(new OAException("EXCEPTION Al calcular el monto total:"+sqle.getErrorCode()+" , "+sqle.getMessage(),OAException.ERROR));
               return retval;
            }
  ...
  public String fillSalesOrderHdrInfo()
  {
   ...
   String strBilling = null; 
    ...
    if(null!=PersonVtaUniformInfoVOImpl){
     ...
     if(PersonVtaUniformInfoIterator.hasNext()){
       PersonVtaUniformInfoVORowImpl = (XxGamPersonVtaUniformInfoVORowImpl)PersonVtaUniformInfoIterator.next();
       strOperativeUnitID = PersonVtaUniformInfoVORowImpl.getOperatingUnitID();
       strPayroll = PersonVtaUniformInfoVORowImpl.getPayroll();
     }
     PersonVtaUniformInfoIterator.closeRowSetIterator();
    } /** END if(null!=PersonVtaUniformInfoVOImpl){ **/
     ...
     String strPrepStmt = " select PRICE_LIST_DESC " + 
                          "     ,PRICE_LIST_HDR_ID " + 
                          "     ,PRICE_LIST " + 
                          "     ,CLIENT " + 
                          "     ,SHIPPING " + 
    ...
    {
      retval = "EXCEPTION al obtener Lista de Precios, Numero Cliente, Envio y Facturacion. "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    if(0==counter){
      retval = "EXCEPTION al obtener Lista de Precios, Numero Cliente, Envio y Facturacion. No se encontraron registros ";
      return retval;
    }else if(counter>1){
      retval = "EXCEPTION al obtener Lista de Precios, Numero Cliente, Envio y Facturacion. Mas de un registro ";
      return retval;
    }
    
    
    String strTransactionTypeID = getSOTransactionTypeID(strPriceListDesc,connection);
    ...
    String strShipLocID = getSOShipLocID(strOperativeUnitID,strShipping,connection);
    ...
    String strBillLocID = getSOBillLocID(strOperativeUnitID,strBilling,connection);
    ...
    XxGamSalesOrderHdrInfoVOImpl SalesOrderHdrInfoVOImpl = getXxGamSalesOrderHdrInfoVO1(); 
    ...
    if(null!=SalesOrderHdrInfoVOImpl){
      if(!SalesOrderHdrInfoVOImpl.isPreparedForExecution()){
        ...
        SalesOrderHdrInfoVORowImpl = (XxGamSalesOrderHdrInfoVORowImpl)SalesOrderHdrInfoVOImpl.createRow();
                                        ...
                                        Connection connection)
  {
    String retval = null; 
    int counter =0;
    String strPrepStmt = " select   T.TRANSACTION_TYPE_ID " + 
                         "        ,T.NAME " + 
                         "        ,T.DESCRIPTION      " + 
    ...
    {
      retval = "EXCEPTION al obtener el tipo de transaccion del Sale Order. "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    if(0==counter){
      retval = "EXCEPTION al obtener el tipo de transaccion del Sale Order: No se encontraron registros.";
      return retval;
    }else if(counter>1){
      retval = "EXCEPTION al obtener el tipo de transaccion del Sale Order: Mas de un registro. ";
      return retval;
    }
  ...
  private String getSOCustomerID(String strClient, Connection connection)
  {
    String retval = null; 
    int counter =0;
    String strPrepStmt = " select CUST_ACCT.CUST_ACCOUNT_ID " + 
    ...
    {
      retval = "EXCEPTION al obtener el ID del Cliente del Sale Order. "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    if(0==counter){
      retval = "EXCEPTION al obtener el ID del Cliente del Sale Order: No se encontraron registros.";
      return retval;
    }else if(counter>1){
      retval = "EXCEPTION al obtener el ID del Cliente del Sale Order: Mas de un registro. ";
      return retval;
    }
   ...
   * @return
   */
  private String getSOShipLocID(String strOperativeUnitID,String strShipping, Connection connection)
  {
    String retval = null; 
    int counter =0;
    String strPrepStmt = " select ship_su.SITE_USE_ID ship_loc_id " + 
                         "        ,ship_su.location " + 
    ...
    {
      retval = "EXCEPTION al obtener el ID del Lugar de Envio del Sale Order. "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    if(0==counter){
      retval = "EXCEPTION al obtener el ID del Lugar de Envio:"+strShipping+" del Pedido de Venta: No se encontraron registros.";
      return retval;
    }else if(counter>1){
      retval = "EXCEPTION al obtener el ID del Lugar de Envio:"+strShipping+" del Pedido de Venta: Mas de un registro. ";
      return retval;
    }
                                ...
                                Connection connection)
  {
    String retval = null; 
    int counter =0;
    String strPrepStmt = " select bill_su.SITE_USE_ID bill_loc_id " + 
                         "       ,bill_su.location " + 
    ...
    {
      retval = "EXCEPTION al obtener el ID del Lugar de Facturacion del Sale Order. "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    if(0==counter){
      retval = "EXCEPTION al obtener el ID del Lugar de Facturacion del Sale Order: No se encontraron registros.";
      return retval;
    }else if(counter>1){
      retval = "EXCEPTION al obtener el ID del Lugar de Facturacion del Sale Order: Mas de un registro. ";
      return retval;
    }
  ...
  public String populateSOHeaderInfo () 
  {
    ...
    XxGamInvVtaUnifHdrVOImpl InvVtaUnifHdrVOImpl = getXxGamInvVtaUnifHdrVO1(); 
    XxGamInvVtaUnifHdrVORowImpl InvVtaUnifHdrVORowImpl = null; 
    
    XxGamPersonVtaUniformInfoVOImpl PersonVtaUniformInfoVOImpl = getXxGamPersonVtaUniformInfoVO1();
    XxGamPersonVtaUniformInfoVORowImpl PersonVtaUniformInfoVORowImpl = null;
    if(null!=PersonVtaUniformInfoVOImpl){
    PersonVtaUniformInfoVORowImpl = (XxGamPersonVtaUniformInfoVORowImpl)PersonVtaUniformInfoVOImpl.getCurrentRow();
    }
    
    XxGamSalesOrderHdrInfoVOImpl  SalesOrderHdrInfoVOImpl = getXxGamSalesOrderHdrInfoVO1(); 
    XxGamSalesOrderHdrInfoVORowImpl  SalesOrderHdrInfoVORowImpl = null;
    if(null!=SalesOrderHdrInfoVOImpl){
      SalesOrderHdrInfoVORowImpl = (XxGamSalesOrderHdrInfoVORowImpl)SalesOrderHdrInfoVOImpl.getCurrentRow();
    }
    ...
    if(null!=InvVtaUnifHdrVOImpl){
     try
      ...
      try{
       numHdrID = oaDBTransaction.getSequenceValue("XXGAM_INV_VTA_UNIF_HDR_S");  
      }catch(SQLStmtException SQLStmte){
        retval="EXCEPTION al consultar la secuencia XXGAM_INV_VTA_UNIF_HDR_S: "+SQLStmte.getErrorCode()+" , "+SQLStmte.getMessage();
        return retval;
      } 
      
      InvVtaUnifHdrVORowImpl = (XxGamInvVtaUnifHdrVORowImpl)InvVtaUnifHdrVOImpl.createRow();
      ...
      {
         retval = "EXCEPTION al poblar la tabla XXGAM_INV_VTA_UNIF_HDR. "+sqle.getErrorCode()+" , "+sqle.getMessage();
         return retval;
      }
  ...
  public String createSalesOrderByApi(String strVtaUniHeaderID)
  {
    ...
    String strCallableStmt = " BEGIN " + 
                             "  APPS.XXGAM_INV_VTA_UNIF_PKG.CREATE_SO_BY_API ( pso_errmsg => :1" + 
                             "                                     , pso_errcod => :2" +
                             "                                     , pso_return_status => :3" +
                             "                                     , pni_vta_uni_id    => :4" +
                             "  ); " + 
    ...
    try
    {
      ...
      oraclecallablestatement.setDouble(4,new Double(strVtaUniHeaderID));
    ...
    {
       retval = "EXCEPTION al crear el Sales Order en Order Managment. "+sqle.getErrorCode()+" , "+sqle.getMessage();
       return retval;
    }
  ...
  public String populateSOLinesInfo(String strXxGamHeaderID)
  {
    ...
    XxGamReviewInpOrderUniformsVOImpl ReviewInpOrderUniformsVOImpl = getXxGamReviewInpOrderUniformsVO1();
    XxGamReviewInpOrderUniformsVORowImpl ReviewInpOrderUniformsVORowImpl = null;
    XxGamInvVtaUnifLinVOImpl InvVtaUnifLinVOImpl = getXxGamInvVtaUnifLinVO1();
    XxGamInvVtaUnifLinVORowImpl InvVtaUnifLinVORowImpl = null; 
    
    OADBTransaction oaDBTransaction =getOADBTransaction();
    
    RowSetIterator ReviewInpOrderUniformsIter = ReviewInpOrderUniformsVOImpl.createRowSetIterator(null);
    while(ReviewInpOrderUniformsIter.hasNext()){
     ReviewInpOrderUniformsVORowImpl = (XxGamReviewInpOrderUniformsVORowImpl)ReviewInpOrderUniformsIter.next();
    ...
    try
    {
     if(!InvVtaUnifLinVOImpl.isPreparedForExecution()){
       InvVtaUnifLinVOImpl.executeQuery();
        ...
        InvVtaUnifLinVORowImpl = (XxGamInvVtaUnifLinVORowImpl)InvVtaUnifLinVOImpl.createRow();
        numLineID = oaDBTransaction.getSequenceValue("XXGAM_INV_VTA_UNIF_LIN_S");
       ...
       {
         retval = "EXCEPTION al poblar la tabla XXGAM_INV_VTA_UNIF_LIN. "+sqle.getErrorCode()+" , "+sqle.getMessage();
         return retval;
       }
     }
                                          ...
                                          Number numSoHeaderId)
  {
    ...
    XxGamFollOrderUnifLinVOImpl FollOrderUnifLinVOImpl = getXxGamFollOrderUnifLinVO1();
  ...
  public com.sun.java.util.collections.List valAmntInputOrderUnif()
  {
    ...
    int counter = 0; 
    if(null!=InputOrderUniformsVOImpl){
     RowSetIterator IterInputOrderUniforms = InputOrderUniformsVOImpl.createRowSetIterator(null);
     while(IterInputOrderUniforms.hasNext()){
       ...
       InputOrderUniformsVORowImpl = (XxGamInputOrderUniformsVORowImpl)IterInputOrderUniforms.next();
       strNomenclature = InputOrderUniformsVORowImpl.getNomenclature();
       ...
       if(null!=strQuantity&&!"".equals(strQuantity)){
          try
          {
            numQuantity = new oracle.jbo.domain.Number(strQuantity);
          } catch (SQLException sqle)
          {
            retval.add(new OAException(strNomenclature+": "+sqle.getMessage()+" , "+sqle.getErrorCode(),OAException.ERROR));
          }
          
          if(null!=numQuantity){
            if(-1==numQuantity.compareTo(0)){
              retval.add(new OAException(strNomenclature+": La cantidad ingresada no puede ser menor a cero.",OAException.ERROR));
            }
            if(0==numQuantity.compareTo(0)){
              retval.add(new OAException(strNomenclature+": La cantidad ingresada no puede ser igual a cero.",OAException.ERROR));
            }
            try{
            java.lang.Integer.parseInt(numQuantity.toString());
            }catch(NumberFormatException nfe){
              retval.add(new OAException(strNomenclature+": La cantidad ingresada no puede tener decimales.",OAException.ERROR));
            }
          }
        ...
        if(null!=strTallaNbr&&!"".equals(strTallaNbr)){
           if(null==numQuantity){
             retval.add(new OAException(strNomenclature+": Si ingresa la talla debe ingresar la cantidad.",OAException.ERROR));
           }else{
             counter = counter +1;
           }
        ...
        if(null!=numQuantity){
          if(null==strTallaNbr||"".equals(strTallaNbr)){
            retval.add(new OAException(strNomenclature+": Si ingresa la cantidad debe de ingresar la talla.",OAException.ERROR));
          }
        }
    ...
    if(0==counter){
      retval.add(new OAException("Debe ingresar al menos un registro",OAException.ERROR));
    }
  ...
  public String[] fillSubtotalIvaInfo()
  {
    ...
    RowSetIterator ReviewInpOrderUnifIterator = ReviewInpOrderUniformsVOImpl.createRowSetIterator(null);
    oracle.jbo.domain.Number numSubtotal = new oracle.jbo.domain.Number(0); 
    
    oracle.jbo.domain.Number numRazonIvaArLoc = new oracle.jbo.domain.Number(0);
    ...
    while(ReviewInpOrderUnifIterator.hasNext()){
      ReviewInpOrderUniformsVORowImpl = (XxGamReviewInpOrderUniformsVORowImpl)ReviewInpOrderUnifIterator.next();
      numSubtotal = numSubtotal.add(ReviewInpOrderUniformsVORowImpl.getTotAmount());
    }
    ...
    if(null!=arrayGetIvaArLoc[0]){
      ...
      try
      {
        numRazonIvaArLoc = new oracle.jbo.domain.Number(arrayGetIvaArLoc[1]);
      } catch (SQLException sqle)
      {
        retval[0] = "EXCEPTION al convertir la tasa de iva a numerico:"+sqle.getMessage()+" , "+sqle.getSQLState();
        return retval;
      }
  ...
  private String[] getIvaArLocInfo(Connection connection)
  {
    ...
    int counter = 0; 
    String strPrepStmt = " SELECT   RateTLEO.TAX_RATE_ID, " + 
    ...
    {
      retval[0] = "EXCEPTION al obtener la razon del Iva IVA_AR_LOC: "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    if(0==counter){
      retval[0] = "EXCEPTION al obtener la razon del Iva IVA_AR_LOC: No se encontraron registros.";
      return retval;
    }
    
    if(counter>1){
      retval[0] = "EXCEPTION al obtener la razon del Iva IVA_AR_LOC: Mas de un registro.";
      return retval;
    }
                                       ...
                                       Connection connection)
  {
    ...
    String strPrepStmt = " select sum(transaction_quantity) sum_trx_qty " + 
                        "   from apps.mtl_onhand_quantities moh " + 
                        "  where 1=1 " + 
                        "   and moh.subinventory_code = 'MEX-UNIF' " + 
    ...
    {
      retval = "EXCEPTION el total de la disponibilidad MEX-UNIF: "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval;
    }
    ...
    if(0==counter){
      retval = "EXCEPTION el total de la disponibilidad MEX-UNIF: No se encontraron Registros.";
      return retval;
    } 
    
    if(counter>1){
      retval = "EXCEPTION el total de la disponibilidad MEX-UNIF: Mas de un registro.";
      return retval;
    } 
     ...
     if("Y".equals(isAlphaNum)){
       ...
       if (douTallaNbr.doubleValue()>=0d && douTallaNbr.doubleValue()<=12d){
         if(douSumTrxQty.doubleValue()>10d){
           if(douQuantity.doubleValue()>douSumTrxQty.doubleValue()){
             retval="Cantidad solicitada:"+douQuantity.intValue()+" es mayor que la existente:"+douSumTrxQty.intValue();
           }else{
             retval ="DISPONIBLE";   
           }
  ...
  {
    XxGamFollOrderUnifHdrVOImpl FollOrderUnifHdrVOImpl = getXxGamFollOrderUnifHdrVO1();
  ...
  /**Inicio de modificacion NRC 11-feb-2017*/
      public String isInDateClose(){
          ...
          String strPrepStmt = " select 'Y' flag " +
          ...
          try{
              ...
              retval = "EXCEPTION al validar cierre periodo XXGAM_FECHAS_CIERRE_PERIODO:"+sqle.getErrorCode()+" , "+sqle.getMessage();
              return retval;
          }
  ...
  /**
      ...
      public String findPersonId(String userId){
          ...
          {
            retval ="EXCEPTION al buscar PersonID "+sqle.getErrorCode()+" , "+sqle.getMessage();
            return retval; 
          }
          ...
          if(0==counter){
            retval ="EXCEPTION al buscar PersonID. No se encontraron registros." ;
            return retval; 
          }
