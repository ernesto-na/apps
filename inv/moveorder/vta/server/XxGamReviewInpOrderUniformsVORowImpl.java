...
// ---------------------------------------------------------------------
public class XxGamReviewInpOrderUniformsVORowImpl extends OAViewRowImpl {
    ...
    public static final int TOTAMOUNT = 18;

    /**This is the default constructor (do not remove)
     */
    public XxGamReviewInpOrderUniformsVORowImpl() {
    }
    ...
    /**Gets the attribute value for the calculated attribute TotAmount
     */
    public Number getTotAmount() {
        return (Number)getAttributeInternal(TOTAMOUNT);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute TotAmount
     */
