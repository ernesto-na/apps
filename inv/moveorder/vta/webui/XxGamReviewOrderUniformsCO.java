...
public class XxGamReviewOrderUniformsCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        if (!pageContext.isFormSubmission()) {
            if (null != OrderUniformsAMImpl) {
                String strCleanReviewInputInfo = 
                    OrderUniformsAMImpl.cleanReviewInputInfo();
                if (null != strCleanReviewInputInfo) {
                    if (strCleanReviewInputInfo.contains("EXCEPTION")) {
                        throw new OAException(strCleanReviewInputInfo, 
                                              OAException.ERROR);
                    }
                } /** END if(null!=strCleanReviewInputInfo){ **/

                com.sun.java.util.collections.List listReviewInputInfo = 
                    OrderUniformsAMImpl.initReviewInputInfo();
                if (listReviewInputInfo.size() > 0) {
                    OAWebBean EjecutarBtnBean = 
                        webBean.findChildRecursive("EjecutarBtn");
                    if (null != EjecutarBtnBean) {
                        EjecutarBtnBean.setRendered(false);
                    }

                    OAWebBean TotalesImpuestosRNBean = 
                        webBean.findChildRecursive("TotalesImpuestosRN");
                ...
                if (null != 
                    OrderUniformsAMImpl.getXxGamSalesOrderHdrInfoVO1()) {
                    if (0 == 
                        OrderUniformsAMImpl.getXxGamSalesOrderHdrInfoVO1().getFetchedRowCount()) {
                        String strSalesOrderHdrInfo = 
                            OrderUniformsAMImpl.fillSalesOrderHdrInfo();
                        if (null != strSalesOrderHdrInfo) {
                            if (strSalesOrderHdrInfo.contains("EXCEPTION")) {
                                disablePageRegions(pageContext, webBean);
                                throw new OAException(strSalesOrderHdrInfo, 
                                                      OAException.ERROR);
                            }
                ...
                String[] arrayFillSubtotalIvaInfo = 
                    OrderUniformsAMImpl.fillSubtotalIvaInfo();
                if (null != arrayFillSubtotalIvaInfo[0]) {
                    if (arrayFillSubtotalIvaInfo[0].contains("EXCEPTION")) {
                        disablePageRegions(pageContext, webBean);
                        throw new OAException(arrayFillSubtotalIvaInfo[0], 
                                              OAException.ERROR);
                    }

                    try {
                        OAMessageStyledTextBean SubTotalBean = 
                            (OAMessageStyledTextBean)webBean.findChildRecursive("Subtotal");
                        if (null != SubTotalBean) {
                            System.out.println("SubTotalBean is not null.");
                            /* SubTotalBean.setText(arrayFillSubtotalIvaInfo[1]); */

                            SubTotalBean.setValue(pageContext, 
                                                  new oracle.jbo.domain.Number(arrayFillSubtotalIvaInfo[1]));
                            SubTotalBean.setAttributeValue(OAWebBeanConstants.CURRENCY_CODE, 
                                                           "USD");
                        }

                        OAMessageStyledTextBean ImpuestoBean = 
                            (OAMessageStyledTextBean)webBean.findChildRecursive("Impuesto");
                        if (null != ImpuestoBean) {
                            /*  ImpuestoBean.setText(arrayFillSubtotalIvaInfo[2]); */
                            ImpuestoBean.setValue(pageContext, 
                                                  new oracle.jbo.domain.Number(arrayFillSubtotalIvaInfo[2]));
                            ImpuestoBean.setAttributeValue(OAWebBeanConstants.CURRENCY_CODE, 
                                                           "USD");
                        }

                        OAMessageStyledTextBean TotalBean = 
                            (OAMessageStyledTextBean)webBean.findChildRecursive("Total");
                        if (null != TotalBean) {
                            /*  TotalBean.setText(arrayFillSubtotalIvaInfo[3]); */
                            TotalBean.setValue(pageContext, 
                                               new oracle.jbo.domain.Number(arrayFillSubtotalIvaInfo[3]));
                            TotalBean.setAttributeValue(OAWebBeanConstants.CURRENCY_CODE, 
                                                        "USD");
                        }

                    } catch (SQLException sqle) {
                        throw new OAException("Error al recuperar subtotal,impuesto al convertir a Number.", 
                                              OAException.ERROR);
                    }
        ...
        throw new OAException("Descuento catorcenal via nomina.", 
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if ("RegresarBtnEvt".equals(pageContext.getParameter(this.EVENT_PARAM))) { /** String url **/
                /** String functionName **/
                ...
                pageContext.forwardImmediately("OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/vta/webui/XxGamCreateOrderUniformsPG", 
                                               null, 
        ...
        if (null != pageContext.getParameter("EjecutarBtn")) {
            ...
            oaException = 
                    new OAException("¿Esta usted seguro de que quiere realizar la compra?");
            /**Crea el dialog **/
            OADialogPage oaDialogPage = null;
            oaDialogPage = 
                    new OADialogPage(OAException.INFORMATION, oaException, 
                                     null, "", "");
        ...
        if (null != pageContext.getParameter("YesButton")) {
            OAProcessingPage processingPage = 
                new OAProcessingPage("xxgam.oracle.apps.inv.moveorder.vta.webui.XxGamProcessingOrderUniformsCO");
    ...
    private void enviromentCurrencyFormat(OAPageContext pageContext, 
        ...
        OATableBean oaTableBean = 
            (OATableBean)webBean.findChildRecursive("XxGamReviewInpOrderUniformsVO");
        if (null != oaTableBean) {
            OAMessageStyledTextBean AmountBean = 
                (OAMessageStyledTextBean)oaTableBean.findChildRecursive("TotAmount");
            if (null != AmountBean) {
    ...
    private void disablePageRegions(OAPageContext pageContext, 
        ...
        OAWebBean XxGamReviewInpOrderUniformsVOBean = 
            webBean.findChildRecursive("XxGamReviewInpOrderUniformsVO");

        if (null != XxGamReviewInpOrderUniformsVOBean) {
            XxGamReviewInpOrderUniformsVOBean.setRendered(false);
        }

        OAWebBean XxGamSalesOrderHdrInfoVOBean = 
            webBean.findChildRecursive("XxGamSalesOrderHdrInfoVO");
