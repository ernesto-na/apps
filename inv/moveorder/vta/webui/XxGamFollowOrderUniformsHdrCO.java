...
public class XxGamFollowOrderUniformsHdrCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        System.out.println("param" + 
                           pageContext.getParameter("pSuccessCallApi"));
        if (!pageContext.isFormSubmission()) {
            if (null != OrderUniformsAMImpl) {
                try {
                    ...
                    throw new OAException("EXCEPTION al ejecutar el viewObject XxGamFollOrderUnifHdrVO:" + 
                                          sqlStmt.getErrorCode() + " , " + 
                                          sqlStmt.getMessage(), 
                                          OAException.ERROR);
                }
            }
            if (null != pageContext.getParameter("pSuccessCallApi") && 
                !"".equals(pageContext.getParameter("pSuccessCallApi"))) {
                throw new OAException(pageContext.getParameter("pSuccessCallApi"), 
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if (null != 
            pageContext.getParameter("CrearOrdenBtn")) { /** String url **/
                /** String functionName **/
        ...
        if (null != strEventParam) {
            if ("ToLinesEvt".equals(strEventParam)) {
                System.out.println("pXxGamHdrId:" + 
                                   pageContext.getParameter("pXxGamHdrId")); /** String url **/
                    /** String functionName **/
                    /** byte menuContextAction **/
                    /** String menuName **/
                    /** com.sun.java.util.collections.HashMap parameters **/
                    /** boolean retainAM **/
                    /** String addBreadCrumb **/
                    pageContext.forwardImmediately("OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/vta/webui/XxGamFollowOrderUniformsLinPG", 
                                                   null, 
                                                   OAWebBeanConstants.KEEP_MENU_CONTEXT, 
                                                   null, null, true, 
                                                   OAWebBeanConstants.ADD_BREAD_CRUMB_NO);
    ...
    private void enviromentCurrencyFormat(OAPageContext pageContext, 
        ...
        OATableBean oaTableBean = 
            (OATableBean)webBean.findChildRecursive("XxGamFollOrderUnifHdrVO");
        if (null != oaTableBean) {
            System.out.println("YYYYYYYY");
            OAMessageStyledTextBean AmountBean = 
                (OAMessageStyledTextBean)oaTableBean.findChildRecursive("TotalPedido");
            if (null != AmountBean) {
     ...
     * @param webBean
     */
    private void filterByParameters(OAPageContext pageContext, 
                                    OAWebBean webBean) {
        XxGamOrderUniformsAMImpl OrderUniformsAMImpl = 
            (XxGamOrderUniformsAMImpl)pageContext.getApplicationModule(webBean);
        ...
        String strFechaOrdenDesde = 
            pageContext.getParameter("PFechaOrdenDesde");
        String strFechaOrdenHasta = 
            pageContext.getParameter("PFechaOrdenHasta");

        if (null == strPersonID) {
            OAFormValueBean PersonIDBean = 
                (OAFormValueBean)webBean.findChildRecursive("fvPersonID");
        ...
        if (null == strNumeroOrden) {
            OAMessageTextInputBean NumeroOrdenBean = 
                (OAMessageTextInputBean)webBean.findChildRecursive("PSoNumeroOrden");
        ...
        if (null == strEstatus) {
            OAMessageChoiceBean EstatusBean = 
                (OAMessageChoiceBean)webBean.findChildRecursive("PSoEstatus");
            if (null != EstatusBean) {
        ...
        if (null == strFechaOrdenDesde) {
            strFechaOrdenDesde = 
                    (String)pageContext.getSessionValue("sFechaOrdenDesde");
        } else {
            pageContext.putSessionValue("sFechaOrdenDesde", 
                                        strFechaOrdenDesde);
        } /** End  if(null==strFechaOrdenDesde){ **/

        if (null == strFechaOrdenHasta) {
            strFechaOrdenHasta = 
                    (String)pageContext.getSessionValue("sFechaOrdenHasta");
        } else {
            pageContext.putSessionValue("sFechaOrdenHasta", 
                                        strFechaOrdenHasta);
        }
        ...
        if (null != strPersonID && !"".equals(strPersonID)) {
            try {
                ...
                throw new OAException("EXCEPTION al filtrar por parametros:" + 
                                      sqle.getErrorCode() + " , " + 
                                      sqle.getMessage());
            }
        ...
        java.util.Locale currentLocale = 
            new java.util.Locale(strCurrentLanguage);

        System.out.println("strCurrentLanguage:" + strCurrentLanguage);

        if ("US".equals(strCurrentLanguage) || 
            "ESA".equals(strCurrentLanguage)) {
        ...
        java.text.SimpleDateFormat dateFormat = 
            new java.text.SimpleDateFormat("dd-MMM-yyyy", currentLocale);
        ...
        try {
            ...
            throw new OAException("EXCEPTION en conversion de fechas:" + 
        ...
        if (null != numPersonID || 
            ...
            (null != strEstatus && !"".equals(strEstatus) || 
             (null != dateFromDate)) || (null != dateToDate)) {
            if (null != OrderUniformsAMImpl) {

                XxGamFollOrderUnifHdrVOImpl FollOrderUnifHdrVOImpl = 
                    OrderUniformsAMImpl.getXxGamFollOrderUnifHdrVO1();
