...
public class XxGamCreateOrderUniformsCO extends OAControllerImpl
{
    ...
    ***********************************************************************/
    ...
    /**Inicio de modificacion NRC 11-feb-2017*/
      ...
      if(null!=strisInDateClose){
         ...
         if(strisInDateClose.equals("Y")){
           disablePageRegions(pageContext,webBean);
           String strCierreContable = "No es posible realizar la compra por motivo de cierre contable, favor de volver a intentar el siguiente día hábil.";
    ...
    if(!pageContext.isFormSubmission()){
      if(null!=OrderUniformsAMImpl){
       String strValFillPersonVtaUniforms = OrderUniformsAMImpl.valFillPersonVtaUniforms();
       if("Y".equals(strValFillPersonVtaUniforms)){
         String strGetVal = OrderUniformsAMImpl.fillPersonVtaUniformsInfo(pageContext.getUserName());
         if(null!=strGetVal){
       ...
       String strSessionPriceListHdrID = (String)pageContext.getSessionValue("sPriceListHdrID");
       if(null==strSessionPriceListHdrID||"".equals(strSessionPriceListHdrID)){
         String strPutPriceListHdrID = OrderUniformsAMImpl.putPriceListHdrID(pageContext);
          if(null!=strPutPriceListHdrID){
            if(strPutPriceListHdrID.contains("EXCEPTION")){
              disablePageRegions(pageContext,webBean);
             throw new OAException(strPutPriceListHdrID,OAException.ERROR);
            }
          } /*** END if(null!=strPutPriceListHdrID){ **/
       } /** END if(null==strSessionPriceListHdrID||"".equals(strSessionPriceListHdrID)){ **/
       
       XxGamPersonVtaUniformInfoVOImpl PersonVtaUniformInfoVOImpl = OrderUniformsAMImpl.getXxGamPersonVtaUniformInfoVO1();
       XxGamPersonVtaUniformInfoVORowImpl PersonVtaUniformInfoVORowImpl = null; 
       RowSetIterator PersonVtaUniformInfoIterator = PersonVtaUniformInfoVOImpl.createRowSetIterator(null);
       if(PersonVtaUniformInfoIterator.hasNext()){
         PersonVtaUniformInfoVORowImpl = (XxGamPersonVtaUniformInfoVORowImpl)PersonVtaUniformInfoIterator.next();
         String strGetAvailableKitsInfo = OrderUniformsAMImpl.fillAvailableKitsInfo(PersonVtaUniformInfoVORowImpl.getOrganization()
        ...
        if(null!=strGetAvailableKitsInfo){
         if(strGetAvailableKitsInfo.contains("EXCEPTION")){
           throw new OAException(strGetAvailableKitsInfo,OAException.ERROR);
         }
      ...
      String strValFillInputOrderUniforms = OrderUniformsAMImpl.valFillInputOrderUniforms();
      if("Y".equals(strValFillInputOrderUniforms)){
        String strGetInputOrderUniforms = OrderUniformsAMImpl.fillInputOrderUniforms(strAvailableKits);
        if(null!=strGetInputOrderUniforms){
           if(strGetInputOrderUniforms.contains("EXCEPTION")){
           throw new OAException(strGetInputOrderUniforms,OAException.ERROR);
           }
        }
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    if(null!=strEvent){
      if(this.LOV_PREPARE.equals(strEvent)){
        if("TallaNbr".equals(strLovInputSourceId)||"TallaNbrPren".equals(strLovInputSourceId)){
           OARow oaRow = (OARow)OrderUniformsAMImpl.findRowByRef(strEvtSrcRowRef);
           if(null!=oaRow){
            String strDotaID = (String)oaRow.getAttribute("DotaID");
    ...
    if(null!=pageContext.getParameter("ComprarBtn")){
       com.sun.java.util.collections.List listValAmntInputOrderUnif =  OrderUniformsAMImpl.valAmntInputOrderUnif();
  ...
  private void enviromentCurrencyFormat(OAPageContext pageContext, 
                                        OAWebBean webBean)
  {
   OATableBean oaTableBean = (OATableBean)webBean.findChildRecursive("XxGamInputOrderUniformsVO");
    if(null!=oaTableBean){
      OAMessageStyledTextBean AmountBean = (OAMessageStyledTextBean)oaTableBean.findChildRecursive("Amount");
      if(null!=AmountBean){
  ...
  {
   OAWebBean  CabeceraMsgComLayRNBean = webBean.findChildRecursive("CabeceraMsgComLayRN"); 
   if(null!=CabeceraMsgComLayRNBean){
     CabeceraMsgComLayRNBean.setRendered(false);
   }
   
    OAWebBean  XxGamInputOrderUniformsVOBean = webBean.findChildRecursive("XxGamInputOrderUniformsVO"); 
    if(null!=XxGamInputOrderUniformsVOBean){
      XxGamInputOrderUniformsVOBean.setRendered(false);
    }
    
    OAWebBean  XxGamPersonVtaUniformInfoVOBean = webBean.findChildRecursive("XxGamPersonVtaUniformInfoVO"); 
