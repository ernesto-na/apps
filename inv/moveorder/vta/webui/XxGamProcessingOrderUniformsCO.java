  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
      {
        ...
        if(null!=OrderUniformsAMImpl){
           String strPopulateSOHeaderInfo = OrderUniformsAMImpl.populateSOHeaderInfo();
           if(null!=strPopulateSOHeaderInfo){
             if(strPopulateSOHeaderInfo.contains("EXCEPTION")){
               throw new OAException(strPopulateSOHeaderInfo,OAException.ERROR);
             }
            /** OrderUniformsAMImpl.getTransaction().commit();  Migrar un paso mas adelante **/
          } /** end strPopulateSOHeaderInfo **/ 
          
          String strPopulateSOLinesInfo = OrderUniformsAMImpl.populateSOLinesInfo(strPopulateSOHeaderInfo);
          if(null!=strPopulateSOLinesInfo){
           if(strPopulateSOLinesInfo.contains("EXCEPTION")){
             throw new OAException(strPopulateSOLinesInfo,OAException.ERROR);
           }
            OrderUniformsAMImpl.getTransaction().commit();
          }
          
          String strCreateSalesOrderByApi =  OrderUniformsAMImpl.createSalesOrderByApi(strPopulateSOHeaderInfo);
          if(null!=strCreateSalesOrderByApi){
           if(strCreateSalesOrderByApi.contains("EXCEPTION")){
             throw new OAException(strCreateSalesOrderByApi,OAException.ERROR);
           }
          }
        
          String sURL = "OA.jsp?page=/xxgam/oracle/apps/inv/moveorder/vta/webui/XxGamFollowOrderUniformsHdrPG"; 
