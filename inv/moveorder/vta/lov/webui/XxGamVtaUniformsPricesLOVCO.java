...
public class XxGamVtaUniformsPricesLOVCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        System.out.println("searchText: " + 
                           pageContext.getParameter("searchText"));
        String strPriceListHdrID = 
        ...
        if (null != strPriceListHdrID && !"".equals(strPriceListHdrID)) {
            try {
                numPriceListHdrID = 
                        new oracle.jbo.domain.Number(strPriceListHdrID);
        ...
        XxGamUniformsLOVAMImpl UniformsLOVAMImpl = 
            (XxGamUniformsLOVAMImpl)pageContext.getApplicationModule(webBean);
        if (null != UniformsLOVAMImpl) {
            if (null != numPriceListHdrID && null != numDotaID) {
                UniformsLOVAMImpl.initVtaUniformsPricesLOV(numPriceListHdrID, 
                                                           numDotaID);
