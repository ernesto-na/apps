...
public class XxGamInvConstantes {
    ...
    public static final String ERROR_KIT_DETAIL_2 = 
    ...
    public static final String ERROR_KIT_DETAIL_3 = 
        " No tiene GRUPO DE PAGO asignado, " + 
    ...
    public static final String ERROR_KIT_DETAIL_4 = 
        " No tiene LOCALIDAD asignada, " + 
    ...
    public static final String ERROR_KIT_DETAIL_5 = 
        " Error no tienes un Kit de Uniforme Asignado, Enviar a planeaci\u00f3n tu solicitud, amplanmatgral@aeromexico.com (Sindicalizados) " + 
    ...
    public static final String ERROR_KIT_DETAIL_6 = 
        " Error no tienes un Kit de Uniforme Asignado, Enviar a planeaci\u00f3n tu solicitud, amplanmatgral@aeromexico.com (Sindicalizados) " + 
        " Si eres personal No  sindicalizado revisar link de pol\u00edtica. " + 
        " Si estas en la pol\u00edtica enviar un correo a amplanmatgral@aeromexico.com " + 
        " Si no estas en la pol\u00edtica contactar a tu BP (Business Parther)";
    ...
    public static final String ERROR_NOT_ACCOUNT_DEF = 
        "  Sin cuenta de Gasto por Defecto, acudir al \u00c1rea de Recursos Humanos para asignarla.";

    public static final String ERROR_EMPLOYEE_NOT_ACTIVE = 
        " Empleado Inactivo, acudir al \u00c1rea de Recursos Humanos para su Reactivaci\u00f3n.";

    public static final String ERROR_KIT_PERIOD_CLOSE = 
        "No se podr\u00e1n grabar los datos, el periodo del Kit asignado se encuentra cerrado";
