...
public class xXGamInvSolicitudCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        pageContext.writeDiagnostics(this, 
                                     "XXGAM INV Solicitudes - Version 1.0", 3);
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        OASubmitButtonBean clear = 
            (OASubmitButtonBean)queryBean.findChildRecursive(idClear);
        String idGo = queryBean.getGoButtonName();
        OASubmitButtonBean go = 
            (OASubmitButtonBean)queryBean.findChildRecursive(idGo);
    ...
    public void checkSelectedrow(OAPageContext pageContext, OAWebBean webBean, 
                ...
                if ("Y".equals(selectFlag1)) {
                    if ("G".equals(action)) {
                        if ("CREADO".equals(row.getStatus()) || 
                            ...
                            String lMessageE = 
                                "La solicitud no se puedo generar por que  ya fue Aprobada, Cerrada o Cancelada.";
                            MessageToken[] tokens = 
                        ...
                        if ("CREADO".equals(row.getStatus()) || 
                            ...
                            "CERRADO".equals(row.getStatus())) {
                            String lMessageE1 = 
                                "La solicitud no se puede cancela por que ya fue Cerrada o Cancelada.";
        ...
        if (lReqId.compareTo(0) > 0) {
            ...
            MessageToken[] tokens4 = 
                new MessageToken[] { new MessageToken("MESSAGE", lMessageE2) };
