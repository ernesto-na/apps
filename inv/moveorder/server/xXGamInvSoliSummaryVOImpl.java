...
public class xXGamInvSoliSummaryVOImpl extends OAViewObjectImpl {
    ...
    public void initQuery(String pNroSoliDesde, String pNroSoliHasta, Date pFechaDesde, Date pFechaHasta, String pStatus, String pCvEmp) {
      ...
      String reglaAnios = "AND to_char(sysdate, \'YYYY\')-5 <= to_char(SOLI_DATE, \'YYYY\')";
      ...
      String lWF = null;
      if(pNroSoliDesde == null && pNroSoliHasta == null && "".equals(pNroSoliDesde) && "".equals(pNroSoliHasta) && pFechaDesde == null && pFechaHasta == null && "".equals(pFechaDesde) && "".equals(pFechaHasta) && pCvEmp == null) {
         this.setWhereClause("status like :1 " + reglaAnios);
         this.setWhereClauseParams((Object[])null);
         this.setWhereClauseParam(0, lStatus);
         this.executeQuery();
      } else if(pNroSoliDesde == null && pNroSoliHasta == null && "".equals(pNroSoliDesde) && "".equals(pNroSoliHasta) && pFechaDesde == null && pFechaHasta == null && "".equals(pFechaDesde) && "".equals(pFechaHasta) && pStatus == null) {
         this.setWhereClause(" employee_number like :1 " + reglaAnios);
         this.setWhereClauseParams((Object[])null);
         this.setWhereClauseParam(0, lStatus);
         this.executeQuery();
      } else {
         if(pFechaDesde != null && pFechaHasta != null && !"".equals(pFechaDesde) && !"".equals(pFechaHasta)) {
            lWhereFecha.append(" and soli_date between :3 and :4 ");
            lWF = "Y";
         } else if(pFechaDesde != null || pFechaHasta != null || !"".equals(pFechaDesde) || !"".equals(pFechaHasta)) {
            lWhereFecha.append(" and soli_date between nvl(:3,to_date(\'01/01/1950\',\'dd/mm/yyyy\')) and nvl(:4,to_date(\'31/12/2950\',\'dd/mm/yyyy\')) ");
            lWF = "Y";
         }

         if(pNroSoliDesde != null && pNroSoliHasta != null && !"".equals(pNroSoliDesde) && !"".equals(pNroSoliHasta)) {
            if("Y".equals(lWF)) {
         ...
         } else if(pNroSoliDesde != null && !"".equals(pNroSoliDesde) && (pNroSoliHasta == null || "".equals(pNroSoliHasta))) {
            if("Y".equals(lWF)) {
