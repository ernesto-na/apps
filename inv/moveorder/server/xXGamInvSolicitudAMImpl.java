...
public class xXGamInvSolicitudAMImpl extends OAApplicationModuleImpl
{
  ...
  public static void main(String[] args) {
     launchTester("xxgam.oracle.apps.inv.moveorder.server", "xXGamInvSolicitudAMLocal");
  }
  ...
  public xXGamV2InvSoliVOImpl getxXGamV2InvSoliVO1()
  {
    ...
    public void setRenderOptions(String attributeName, boolean option) {
     ...
     System.out.println("option: " + option);
      ...
      xXGamInvSoliRenderedVOImpl renderImpl = this.getxXGamInvSoliRenderedVO1();
   ...
   public void deshabilitaFilas(OAPageContext pageContext) {
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - deshabilita lineas no Cerradas ", 3);
      ...
      try {
         ...
         while(iterator.hasNext()) {
            ...
            if(rowImpl != null) {
               ...
               if("CERRADO".equals(status.toUpperCase()) && qtyEntregada.compareTo(0) > 0) {
   ...
   public void setDisabledRowCheckbox() {
      ...
      for(int inc = 0; inc < row.length; ++inc) {
         ...
         if(rowi.getCheckBoxSelected() != null && rowi.getCheckBoxSelected().equals("Y")) {
   ...
   public boolean buscaEmpleadoPorClave(String cveEmpl) {
      ...
      isEmplValido = this.getxXgamInvEmpleadosVO1().buscaEmpleadoPorClave(cveEmpl);
      return isEmplValido;
   }

   public String buscaEmpleadoPorUserID(Number lUserId) {
      String cveEmpleado = "";
      cveEmpleado = this.getxXgamInvEmpleadosVO1().buscaEmpleadoPorUserID(lUserId);
      return cveEmpleado;
   }

   public String buscaCuentaPorClaveEmpl(String cveEmpl) {
      String ctaempl = null;
      ctaempl = this.getxXgamInvEmpleadosVO1().buscaCuentaPorClaveEmpl(cveEmpl);
      return ctaempl;
   }

   public String obtieneCompania(OAPageContext pageContext, OAWebBean webBean, String sPersonId) {
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto XXGAM_INV_DEV_PROCESS_PKG.xxgam_get_compania", 3);
      ...
      String str = " BEGIN ? :=  XXGAM_INV_DEV_PROCESS_PKG.xxgam_get_compania(?); END; ";
      OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
      ...
      try {
         ...
         pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto con exito", 3);
      } catch (Exception var14) {
         pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - lSql Error: " + var14.getMessage().toString(), 3);

         try {
            oraclecallablestatement.close();
         } catch (Exception var13) {
            pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - lSql Error: " + var13.getMessage().toString(), 3);
         }

         throw OAException.wrapperException(var14);
      }

      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - Commit al package: ", 3);
      return compania;
   }

   public String obtieneSubInventario(OAPageContext pageContext, OAWebBean webBean, String compania) {
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto XXGAM_INV_DEV_PROCESS_PKG.xxgam_get_subinventory", 3);
      String subInventario = null;
      String str = " BEGIN ? :=  XXGAM_INV_DEV_PROCESS_PKG.xxgam_get_subinventory(?); END; ";
      OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
      ...
      try {
         ...
         pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - lSql Error: " + var12.getMessage().toString(), 3);

         try {
            oraclecallablestatement.close();
         } catch (Exception var11) {
            pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - lSql Error: " + var11.getMessage().toString(), 3);
         }
   ...
   public Number obtieneOrganizationId(OAPageContext pageContext, OAWebBean webBean, String compania) {
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto XXGAM_INV_DEV_PROCESS_PKG.xxgam_get_organization_id", 3);
      Number orgId = null;
      String str = " BEGIN ? :=  XXGAM_INV_DEV_PROCESS_PKG.xxgam_get_organization_id(?); END; ";
      OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
   ...
   @SuppressWarnings("deprecation")public List validaExistencia(OAPageContext pageContext, OAWebBean webBean, Number orgId, String subinventario, String lSoliIdC, String compania) {
      pageContext.writeDiagnostics(this, "validaExistencia - soli_id: " + lSoliIdC, 3);
      ...
      try {
         if(soliDtlImpl != null && iterator != null && iterator.getRowCount() > 0) {
            while(iterator.hasNext()) {
               rowImpl = (xXGamInvSoliDtlVORowImpl)iterator.next();
               soliDtlId = rowImpl.getSoliDtlId();
               if(rowImpl != null && rowImpl.getCheckBoxSelected() != null && "Y".equals(rowImpl.getCheckBoxSelected())) {
                  iterNewLines = newLinesVO.createRowSetIterator((String)null);

                  try {
                     if(iterNewLines != null && iterNewLines.getRowCount() > 0) {
                        while(iterNewLines.hasNext()) {
                           rowNewLines = (xXGamInvSoliDtlVORowImpl)iterNewLines.next();
                           if(rowNewLines != null && soliDtlId.compareTo(rowNewLines.getSoliDtlId()) == 0) {
                              nomenclatura = rowNewLines.getNomenclature();
                              inventoryId = rowNewLines.getInventoryIdDev();
                              soliDtlId = rowNewLines.getSoliDtlId();
                              qtyDev = rowNewLines.getQtyDev();
                              if(inventoryId != null) {
                                 existencia = this.obtieneExistencias(pageContext, webBean, orgId, inventoryId, subinventario, compania);
                                 pageContext.writeDiagnostics(this, nomenclatura + ": " + existencia, 3);
                              }

                              if(existencia != null && existencia.compareTo(qtyDev) < 0) {
      ...
      pageContext.putSessionValueDirect("listaIdSinExistencia", listaIdSinExistencia);
      return listanoNombreSinExistencia;
   }

   public Number obtieneExistencias(OAPageContext pageContext, OAWebBean webBean, Number orgId, Number inventoryId, String subinventario, String compania) {
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto XXGAM_INV_DEV_PROCESS_PKG.xxgam_valida_onhand_string", 3);
      Number existencia = null;
      String str = " BEGIN ? :=  XXGAM_INV_DEV_PROCESS_PKG.xxgam_valida_onhand_string(?,?,?,?); END; ";
      OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
      ...
      try {
         ...
         pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - lSql Error: " + var15.getMessage().toString(), 3);
   ...
   public Number procesaMiscelanea(OAPageContext pageContext, OAWebBean webBean, String uniId) {
      xXGamInvSoliDtlVOImpl soliDtlImpl = this.getxXGamInvSoliDtlVO1();
      RowSetIterator iterator = null;
      iterator = soliDtlImpl.createRowSetIterator((String)null);
      xXGamInvSoliDtlVORowImpl rowImpl = null;
      ...
      if(!vacio) {
         OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
         OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
         pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto XXGAM_INV_DEV_PROCESS_PKG.xxgam_create_miscellaneous", 3);
         String str = " BEGIN XXGAM_INV_DEV_PROCESS_PKG.xxgam_create_miscellaneous(:1,:2); END; ";
         OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
         ...
         try {
            ...
            pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - lSql Error: " + var22.getMessage().toString(), 3);

            try {
               oraclecallablestatement.close();
            } catch (Exception var21) {
               pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - lSql Error: " + var21.getMessage().toString(), 3);
            }
   ...
   public String validaAperturaPeriodos(String lKitCode) {
      xXGamLookupAperPeriodVOImpl lookupVOImpl = this.getxXGamLookupAperPeriodVO1();
      lookupVOImpl.clearCache();
      lookupVOImpl.validaAperturaPeriodo(lKitCode);
      String statusPeriodo = "NO ENCONTRADO";
      if(lookupVOImpl != null) {
         xXGamLookupAperPeriodVORowImpl row = (xXGamLookupAperPeriodVORowImpl)lookupVOImpl.first();
         if(row != null) {
   ...
   public boolean validaNuevoEmpleado(Number personId, long lKitId) {
      xXGamInvFechaNvoEmplVOImpl fechaNvoEmplImp = this.getxXGamInvFechaNvoEmplVO1();
      ...
      if(fechaNvoEmplImp != null) {
         xXGamInvFechaNvoEmplVORowImpl row = (xXGamInvFechaNvoEmplVORowImpl)fechaNvoEmplImp.first();
         if(row != null) {
            esNvoEmpl = true;
         }
      }
   ...
   public String comparaFechaCreacion(String lpSoliId) {
      xXGamInvFechaCreacionEnPeriodoVOImpl fechaCreacionVOImpl = this.getxXGamInvFechaCreacionEnPeriodoVO1();
      fechaCreacionVOImpl.clearCache();
      fechaCreacionVOImpl.validaFechaEnRango(lpSoliId);
      String esValido = "SI";
      if(fechaCreacionVOImpl != null) {
         xXGamInvFechaCreacionEnPeriodoVORowImpl row = (xXGamInvFechaCreacionEnPeriodoVORowImpl)fechaCreacionVOImpl.first();
         if(row != null) {
   ...
   public void setDisabledSoli(String attributeName, boolean option) {
      xXGamInvSoliDtlDisabledVOImpl renderImpl = this.getxXGamInvSoliDtlDisabledVO1();
      Row renderRow = null;
      if(renderImpl.getEstimatedRowCount() > 0L) {
         renderRow = renderImpl.first();
      } else {
   ...
   public String validaLineas(OAPageContext pageContext, OAWebBean webBean, String lSuperUser, String numSoli) {
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - method validaLineas", 3);
      String esValid = "NO";
      if(lSuperUser != null && "Y".equals(lSuperUser.trim()) && numSoli != null) {
         esValid = this.validaLineasCerradoAprobado(pageContext, webBean, numSoli);
      }

      return esValid;
   }

   public String validaLineasCerradoAprobado(OAPageContext pageContext, OAWebBean webBean, String noSolicitud) {
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto XXGAM_INV_DEV_PROCESS_PKG.", 3);
      String isValid = null;
      String str = " BEGIN ? :=  XXGAM_INV_DEV_PROCESS_PKG.xxgam_valida_devolucion(?); END; ";
      OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
   ...
   public Number validaAsigAutoKit(OAPageContext pageContext, OAWebBean webBean, String sPersonId) {
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto xxgam_inv_kit_util_pkg.xxgam_get_kit_auto", 3);
      Number idKit = null;
      Number personId = null;
      ...
      String str = " BEGIN ? :=  xxgam_inv_kit_util_pkg.xxgam_get_kit_auto(?); END; ";
      OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
      ...
      try {
         ...
         oraclecallablestatement.close();
         pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto con exito. idkit: " + idKit, 3);
         return idKit;
      } catch (Exception var14) {
         pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - lSql Error: " + var14.getMessage().toString(), 3);
   ...
   public String validaSolicitudFechaActiva(Number personId) {
      xXGamInvFechaSolicitudActivaVOImpl solActivaVOImpl = this.getxXGamInvFechaSolicitudActivaVO1();
      ...
      if(solActivaVOImpl != null) {
         xXGamInvFechaSolicitudActivaVORowImpl row = (xXGamInvFechaSolicitudActivaVORowImpl)solActivaVOImpl.first();
         if(row != null) {
   ...
   public void validaCicloConFechaEntrega(OAPageContext pageContext, OAWebBean webBean) {
         ...
         try {
            ...
            while(iterator1.hasNext()) {
               ...
               if(rowImpl1 != null) {
                  ...
                  esValido = this.validaCiclo(pageContext, webBean, dotaId, cveEmpl, kitId, ciclo);
                  System.out.println("Nomenclature: "  + rowImpl1.getNomenclature().toString()  + " esValido : " +  esValido);
   ...
   public Number validaCiclo(OAPageContext pageContext, OAWebBean webBean, Number dotaId, String cveEmpl, Number kitId, String ciclo) {
      ...
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto xxgam_inv_kit_util_pkg.validate_cicle", 3);
      Number esValido = null;
          String str = " BEGIN ? :=  xxgam_inv_kit_util_pkg.validate_cicle(?,?,?,?); END; ";
      OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
   ...
   public void quitaPrendasSinExistencia(OAPageContext pageContext) {
      xXGamInvSoliDtlVOImpl soliDtlImpl = this.getxXGamInvSoliDtlVO1();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - quitaPrendasSinExistencia", 3);
      List listaIdSinExistencia = (List)pageContext.getSessionValueDirect("listaIdSinExistencia");
      RowSetIterator iterator = null;
      iterator = soliDtlImpl.createRowSetIterator((String)null);
      xXGamInvSoliDtlVORowImpl rowImpl = null;
            ...
            while(iterator.hasNext()) {
               ...
               if(rowImpl != null && rowImpl.getSoliDtlId() != null) {
                  ...
                  while(iterSinExistencia.hasNext()) {
                     ...
                     if(rowImpl.getSoliDtlId().compareTo(soliDtlId) == 0) {
                        pageContext.writeDiagnostics(this, "quitaPrendasSinExistencia - SOLI_DTL_ID " + soliDtlId, 3);
   ...
   public Number obtienePersonId(int userId) {
      ...
      if(emplVO != null) {
         xXgamInvEmpleadosVORowImpl row = (xXgamInvEmpleadosVORowImpl)emplVO.first();
         if(row != null) {
    ...
    public String obtieneEmployeeNumber(int userId) {
       ...
       if(emplVO != null) {
        ...
        System.out.println("obtieneEmployeeNumber retorna:  " +  employeeNumber);
   ...
   public void deshabilitaTodasFilas(OAPageContext pageContext) {
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - deshabilita todas lineas ", 3);
      xXGamInvSoliDtlVOImpl soliDtlImpl = this.getxXGamInvSoliDtlVO1();
      RowSetIterator iterator = null;
      iterator = soliDtlImpl.createRowSetIterator((String)null);
      xXGamInvSoliDtlVORowImpl rowImpl = null;
   ...
   public String validaStatusSolicitud(String lpSoliId) {
      ...
      try {
         ...
         while(iterator.hasNext()) {
            rowImpl = (xXGamInvSoliDtlVORowImpl)iterator.next();
            if(rowImpl != null) {
               if(!"ERROR".equals(statusSoli.toUpperCase()) && !"CANCELADO".equals(statusSoli.toUpperCase())) {
   ...
   public Number updateWrongSoli(OAPageContext pageContext, OAWebBean webBean, String noSolicitud) {
      OAApplicationModule oaapplicationmodule = pageContext.getApplicationModule(webBean);
      OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)oaapplicationmodule.getOADBTransaction();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - ejecuto XXGAM_INV_DEV_PROCESS_PKG.xxgam_update_wrong_solititud", 3);
      Number status = null;
      String str = " BEGIN ? :=  XXGAM_INV_DEV_PROCESS_PKG.xxgam_update_wrong_solititud(?); END; ";
      OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
   ...
   public String obtieneMsgErrorConsurrente(OAPageContext pageContext, String noSolicitud, Number status) {
      StringBuffer bufferMsg = new StringBuffer();
      pageContext.writeDiagnostics(this, "xXGamInvSolicitudAMImpl - obtieneMsgErrorConsurrente:" + noSolicitud, 3);
  ...
  public void executeInitialReport(int p_userId){
    ...
    try{
        ...
        System.out.println("Un error encontrado en executeInitialReport: " + exp.getMessage().toString());
    }
    ...
    public String getMessageError(OAPageContext pageContext, OAWebBean webBean, int p_personId){
        System.out.println("**Inicia proceso getMessageError, se recibe el parametro p_personId: " + p_personId);
        ...
        "        v_debug := v_debug || '" + constantesErrors.ERROR_KIT_DETAIL_1 + "';\n" + 
        "    ELSE\n" + 
        ...
        "        V_ERROR_COUNT := V_ERROR_COUNT + 1;\n" + 
        "        v_debug := v_debug || '" + constantesErrors.ERROR_KIT_DETAIL_2  + "';\n" + 
        "    ELSE\n" + 
        ...
        "        V_ERROR_COUNT := V_ERROR_COUNT + 1;\n" + 
        "        v_debug := v_debug || '" + constantesErrors. ERROR_KIT_DETAIL_3 + "';\n" + 
        "    ELSE\n" + 
        ...
        "        V_ERROR_COUNT := V_ERROR_COUNT + 1;\n" + 
        "        v_debug := v_debug || '" + constantesErrors. ERROR_KIT_DETAIL_4 + "';\n" + 
        "    ELSE\n" + 
        ...
        "        V_ERROR_COUNT := V_ERROR_COUNT + 1;\n" + 
        "        v_debug := v_debug || '" + constantesErrors. ERROR_KIT_DETAIL_5 + "';\n" + 
        "    END IF;\n" + 
        "\n" + 
        ...
        "           IF VAL_SEXO <> '0' " + 
        "               THEN " + 
        "               v_debug := '" + constantesErrors.ERROR_KIT_DETAIL_6 + "'; " + 
        "           END IF;    " + 
        "     \n" + 
        "    END IF;\n" +
...
/*        " DECLARE                                                                                            " + 
  ...
  */
        ...
        System.out.println("UN ERROR NO CONTROLADO: "  + e.getMessage().toString());
...
public String validaInitReport(String pUserId){
                                   ...
                                   OAWebBean webBean)
  {
    ...
    if(null!=InvSoliVOImpl){
     ...
     InvSoliVORowImpl = (xXGamInvSoliVORowImpl)InvSoliVOImpl.createRow();
      ...
      strPersonID = getPersonIdFromUserID(pStrUserName,connection);
            ...
            {
              return "EXCEPTION al establecer el atributo person_id:"+sqle.getErrorCode()+" , "+sqle.getMessage();
            }
      ...
      String[] arrayFulNameEmpNumSex = getFulNameEmpNumSex(strPersonID,connection);
            
            if(null!=arrayFulNameEmpNumSex[0]){
              if(arrayFulNameEmpNumSex[0].contains("EXCEPTION")){
               return arrayFulNameEmpNumSex[0];
              }
              oanombreEmpleadoBean.setText(pageContext,arrayFulNameEmpNumSex[1]);
       ...
       String[] arrayPersonTypeID = getPersonTypeID(strPersonID,connection);
       ...
       String[] arrayGradeInfo = getGradeInfo(strPersonID,connection);
        ...
        String[] arrayAccountingInfo = getAccountingInfo(strPersonID,connection);
              if(null!=arrayAccountingInfo[0]){
                ...
                {
                  return "EXCEPTION al establecer el Id de la cuenta de gasto:"+sqle.getErrorCode()+" , "+sqle.getMessage();
                }
  ...
  /**
                                        ...
                                        ,Connection pConnection)
    {
     ...
     String strPrepStmt = " select employee_id " + 
      ...
      {
        retval = "EXCEPTION al obtener el Person ID:"+sqle.getErrorCode()+" , "+sqle.getMessage();
      }
  ...
  /**
                                        ...
                                        ,Connection pConnection)
    {
      ...
      if(counter>1){
        retval[0] = "EXCEPTION al obtener Nombre del empleado, numero de empleado y genero:Mas de un registro.";
      }
      return retval; 
  ...
  */
  ...
  {
   retval[0] = "EXCEPTION al obtener localidad y zona del empleado:"+sqle.getErrorCode()+" , "+sqle.getMessage();
  }
  ...
  public String valFillSolCrearCabeInfo()
  {
    ...
    if(null!=InvSoliVOImpl){
      System.out.println("FetchedRowCount InvSoliVO:"+InvSoliVOImpl.getFetchedRowCount());
  ...
  { 
    ...
    if(null!=InvSoliVOImpl){
      InvSoliVORowImpl = (xXGamInvSoliVORowImpl)InvSoliVOImpl.getCurrentRow();
    ...
    String[] arrayOrganizationInfo = getHROrganizationInfo(strPersonID,connection);
    ...
    String[] arrayPositionInfo = getPositionInfo(strPersonID,connection);
         if(null!=arrayPositionInfo[0]){
           ...
           strShortPosition = arrayPositionInfo[2].substring(arrayPositionInfo[2].indexOf('.',3)+1); 
           if(null==InvSoliVORowImpl.getCategory()||"".equals(InvSoliVORowImpl.getCategory())){
     ...
     String[] arrayHrLocationZonaInfo = getHrLocationZonaInfo(strPersonID,connection); 
                                         ...
                                         Connection pConnection)
  {
    String[] retval = new String[3]; 
        ...
        int counter = 0;
        String strPrepStmt = " SELECT  hrao.organization_id  org_id   " + 
                             "        ,hrao.name             org_name " + 
  ...
  {
    String retval = null; 
    xXGamInvAvailableKitsVOImpl InvAvailableKitsVOImpl = getxXGamInvAvailableKitsVO1();
    ViewCriteria vc = InvAvailableKitsVOImpl.createViewCriteria(); 
    ViewCriteriaRow vcr1 = vc.createViewCriteriaRow(); 
    vcr1.setAttribute("KitCode","IN ("+strGetAvailableKitsInfo.substring(0,strGetAvailableKitsInfo.length()-1)+")"); 
    vc.add(vcr1); 
                                     ...
                                     , String pStrKitID)
  {
    ...
    System.out.println("XXGAM_INV_USUARIO_UNIFORME Value:"+pageContext.getProfile("XXGAM_INV_USUARIO_UNIFORME"));
    if(null!=pageContext.getProfile("XXGAM_INV_USUARIO_UNIFORME")&&!"".equals(pageContext.getProfile("XXGAM_INV_USUARIO_UNIFORME"))){
      ...
      if("Y".equals(strIsSuperUser)){
       System.out.println("Se trata de un Super Usuario Uniformes..");
        ...
        retval ="EXCEPTION Valor:"+strIsSuperUser+" no valido para el Perfil XXGAM_INV_USUARIO_UNIFORME.";
        return retval; 
      }
    } 
    ...
    if(null!=pStrKitID){
      ...
      {
        retval = "EXCEPTION al convertir pStrKitID:"+pStrKitID+" a Number";
      }
    }
    
    String strPrepStmt = " select  xid.dota_id " + 
                          ...
                          "              where history.person_id = "+pNumPersonID.toString()+
                          ...
                          "                                                    where tmp.person_id = "+pNumPersonID.toString()+ 
                          "                                                      and tmp.kit_cod = '"+pStrKitCode+"'" +
                          ...
                          "   where  xid.kit_cod = '"+pStrKitCode+"'"+
                          "     and NVL(dota_default,'X') in ('Y') "; 
     ...
     /** prepStmt.setString(2,pStrKitCode); **/
      ...
      while(resultSet.next()){
        if(null!=V2InvSoliDtlVOImpl){
          ...
          V2InvSoliDtlVORowImpl = (xXGamV2InvSoliDtlVORowImpl)V2InvSoliDtlVOImpl.createRow();
          ...
          if(0d!=resultSet.getDouble("talla_id")){
            if(null==resultSet.getString("talla_nbr")||"".equals(resultSet.getString("talla_nbr"))){
              retval ="EXCEPTION se tiene el talla_id:"+resultSet.getDouble("talla_id")+" pero no se tiene el talla_nbr";
              return retval;
            }
          }
          ...
          ***************************************************************************************************/
          ...
          oracle.jbo.domain.Number numValidaCicloByNomen = this.callValidarCicloByNomen(InvSoliVORowImpl.getPersonId()
           ...
           ** Deben estar vacias para que los move order no se creen con cantidades en 0**/
           if(null!=V2InvSoliDtlVORowImpl.getQtyNbr()){
             if(0==V2InvSoliDtlVORowImpl.getQtyNbr().compareTo(0)){
               V2InvSoliDtlVORowImpl.setTallaNbr(null);
               V2InvSoliDtlVORowImpl.setTallaId(null);
               V2InvSoliDtlVORowImpl.setQtyNbr(null);
               V2InvSoliDtlVORowImpl.setInventoryId(null);
    ...
    {
       retval = "EXCEPTION al recuperar informacion de la tabla XXGAM_INV_SIZ_UNIF_HISTORY: "+sqle.getErrorCode()+" , "+sqle.getMessage();
       return retval;
    }
  ...
  */
  ...
  public String fillSoliIDKitIDInfo(String pStrGrabKitCode)
  {
    ...
    String strPrepStmt = " select kit_id " + 
                         "   from XXGAM_INV_KIT " + 
                         "  where kit_cod = ?";
    PreparedStatement prepStmt = null;
    ResultSet resultSet = null;
    ...
    {
      retval ="EXCEPTION al obtener el ID del Kit:"+pStrGrabKitCode+","+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval; 
    }
    ...
    if (null!=InvSoliVOImpl){
      ...
      oracle.jbo.domain.Number numSoliID = oaDBTransaction.getSequenceValue("XXGAM_INV_SOLI_S");
      oracle.jbo.domain.Number numKitID = null;
      try
      {
      ...
      {
         retval ="EXCEPTION al convertir:"+strKitID+" a oracle.jbo.domain.Number" ;
         return retval; 
      }
      retval ="SoliID:"+numSoliID.toString()+",KitID:"+numKitID.toString(); 
  ...
  public String fillSoliDtlIDInfo()
  {
   ...
   RowSetIterator V2InvSoliDtlVOIterator = V2InvSoliDtlVOImpl.createRowSetIterator(null);
   while(V2InvSoliDtlVOIterator.hasNext()){
     V2InvSoliDtlVORowImpl = (xXGamV2InvSoliDtlVORowImpl)V2InvSoliDtlVOIterator.next();
     if(null!=InvSoliDtlVOImpl){
       ...
       numSoliDtlID = oaDBTransaction.getSequenceValue("XXGAM_INV_SOLI_DTL_S");
       System.out.println("numSoliDtlID:"+numSoliDtlID.toString());
       InvSoliDtlVORowImpl = (xXGamInvSoliDtlVORowImpl)InvSoliDtlVOImpl.createRow();
      ...
      /** if("EMPLEADO PLANTA".equals(InvSoliVORowImpl.getAdscription())){ **/
       ...
       System.out.println("setQtyNbr:"+V2InvSoliDtlVORowImpl.getQtyNbr());
       System.out.println("setTallaId:"+V2InvSoliDtlVORowImpl.getTallaId());
       if(null!=V2InvSoliDtlVORowImpl.getTallaId()&&(0!=V2InvSoliDtlVORowImpl.getTallaId().compareTo(0))){
       InvSoliDtlVORowImpl.setTallaId(V2InvSoliDtlVORowImpl.getTallaId());
       }
       if(null!=V2InvSoliDtlVORowImpl.getQtyNbr()&&!"".equals(V2InvSoliDtlVORowImpl.getQtyNbr())){
   ...
   V2InvSoliDtlVOIterator.closeRowSetIterator();
    ...
    } catch (SQLException sqle)
    {
      closeResultSet(resultSet);
      closePreparedStatement(prepStmt);
       retval="EXCEPTION Insertar aquellos registros que no esten marcados como default."+sqle.getErrorCode()+" , "+sqle.getMessage();  
       return retval; 
    } /** END Try **/
  ...
  public com.sun.java.util.collections.List valAllLinesV2InvSoliDtl()
  {
    ...
    String strPrepStmt = " select xit.talla_id " + 
    ...
    if(null!=V2InvSoliDtlVOImpl){
     RowSetIterator V2InvSoliDtlIterator = V2InvSoliDtlVOImpl.createRowSetIterator(null); 
      ...
      String strTallaID = null; 
        ...
        V2InvSoliDtlVORowImpl = (xXGamV2InvSoliDtlVORowImpl)V2InvSoliDtlIterator.next();
        ...
        if(null!=strTallaNbr&&!"".equals(strTallaNbr)
          ...
          } catch (SQLException sqle)
          {
            closeResultSet(resultSet);
            closePreparedStatement(prepStmt);
             retval.add(new OAException("EXCEPTION AL validar la talla de la prenda"+sqle.getErrorCode()+" , "+sqle.getMessage(),OAException.ERROR));  
             /* return retval; */
          } /** END Try **/
          ...
          if(null!=strTallaID){
            ...
            {
              retval.add(new OAException("EXCEPTION al convertir:"+strTallaID+" a Number",OAException.ERROR));
             /* return retval; */
            }
          }else{
           retval.add(new OAException( "EXCEPTION La talla:"+strTallaNbr+" de la prenda:"+strNomenclature+" no es valida",OAException.ERROR));
           /* return retval;  */
          }
     ...
     while(V2InvSoliDtlIterator.hasNext()){
        ...
        ******************************************************************************/ 
         if(-1==numQtyEentered.compareTo(0)){
           retval.add(new OAException(strNomenclature+": La cantidad ingresada debe ser mayor que cero.",OAException.ERROR));
         }
         
         try{
         java.lang.Integer.parseInt(numQtyEentered.toString());
         }catch(java.lang.NumberFormatException nfexcp){
           retval.add(new OAException(strNomenclature+": La cantidad ingresada no debe contener decimales.",OAException.ERROR));
         } 
         
         if(null==strTallaNbr||"".equals(strTallaNbr)){
           retval.add(new OAException(strNomenclature+": Si ingresa la Cantidad, debe seleccionar la Talla.",OAException.ERROR));
          /* return retval; */
         }
         if(null!=numQtyPermitida){
           if(numQtyPermitida.compareTo(numQtyEentered)<0){
             retval.add(new OAException(strNomenclature+": La cantidad ingresada " + numQtyEentered.toString() + " no puede ser mayor que la permitida " + numQtyPermitida.toString() + ".",OAException.ERROR));
           }
         }
       }else if(null!=numTallaID){
         if(!(0==numTallaID.compareTo(0))){
         retval.add(new OAException(strNomenclature+": Si ingresa la Talla, debe seleccionar la Cantidad.",OAException.ERROR));
         /* return retval; */
         }
       }
     }/** End  while(V2InvSoliDtlIterator.hasNext()){ **/
  ...
  public String callValidarSustitutos()
  {
    ...
    String lSql = "BEGIN XXGAM_INV_MOVEORDER_PKG.VALIDA_SUSTITUTOS(p_soli_id => ?); END;";
    OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)this.getOADBTransaction();
    ...
    try {
      ...
      retval = "EXCEPTION Al validar Sustitutos:"+sqle1.getErrorCode()+" , "+sqle1.getMessage();
      return retval; 
  ...
  public String getKitIDInfo(String pStrKitCode)
  {
    ...
    {
      retval ="EXCEPTION al obtener el ID del Kit:"+pStrKitCode+","+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval; 
    }
    ...
    if(0==counter){
      retval ="EXCEPTION al obtener el ID del Kit:"+pStrKitCode+" , no se encontraron registros.";
      return retval;
    }
  ...
  public String valPeriodActiveKit(String pStrKitCode)
  {
    ...
    oracle.jbo.domain.Date jboDateSysdate = oaDBTransaction.getCurrentDBDate();
    ...
    try
    {
      ...
      while(resultSet.next()){
        counter = counter +1; 
        retval = "SUCCESS";
        sqlDateStartDateActive = resultSet.getDate("start_date_active");
        sqlDateEndDateActive = resultSet.getDate("end_date_active");
        jboDateStartActive = new oracle.jbo.domain.Date(sqlDateStartDateActive); 
        jboDateEndActive = new oracle.jbo.domain.Date(sqlDateEndDateActive);
        break;
      }
    } catch (SQLException sqle)
    {
      retval ="EXCEPTION al validar que el periodo del kit:"+pStrKitCode+" no se encuentre cerrado:"+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval; 
    }
    ...
    if(0==counter){
      retval ="EXCEPTION al validar que el periodo del kit:"+pStrKitCode+" no se encuentre cerrado: No se encontraron registros.";
      return retval;
    }
    
    System.out.println("jboDateSysdate:"+jboDateSysdate.dateValue().getTime());
    System.out.println("jboDateStartActive:"+jboDateStartActive.dateValue().getTime());
    System.out.println("jboDateEndActive:"+jboDateEndActive.dateValue().getTime());
    
    if(null!=jboDateSysdate&&null!=jboDateStartActive&&null!=jboDateEndActive){
      if(jboDateSysdate.dateValue().getTime()>=jboDateStartActive.dateValue().getTime()
       &&(jboDateSysdate.dateValue().getTime()<=jboDateEndActive.dateValue().getTime())){
       }else{
         retval ="EXCEPTION el periodo:"+jboDateStartActive.toString()+" - "+jboDateEndActive.toString()+" del Kit:"+pStrKitCode+"  se encuentra cerrado." ;
         return retval; 
       }
    }
  ...
  public String valSoloUnaUNI(Number numPersonID, String strKitCode)
  {
    ...
    String retval = ""; 
       int counter = 0; 
    String strPrepStmt = "  select xis.NRO_SOLICITUD " + 
                         "       ,xis.employee_number " + 
                         "       ,xis.person_id " + 
    ...
    {
      retval ="EXCEPTION al validar solicitudes unicas dentro del periodo en el lookup XXGAM_APERTURA_DE_PERIODOS. "+sqle.getErrorCode()+" , "+sqle.getMessage();
      return retval; 
    }
                                       ...
                                       , String pStrCycleCod)
  {
    oracle.jbo.domain.Number esValido = null;
    OADBTransactionImpl oadbtransactionimpl = (OADBTransactionImpl)this.getOADBTransaction();
    String str = " BEGIN ? :=  XXGAM_INV_VTASIZ_UTIL_PKG.valida_ciclos_by_nomen(pni_person_id      => ?" +
                                                                             " ,psi_nomenclature   => ?" +
                                                                             " ,psi_cycle_varchar  => ?" +
                                                                             " ); END; ";
    OracleCallableStatement oraclecallablestatement = (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(str, 1);
                                     ...
                                     OAWebBean webBean)
  {
    ...
    OAFormValueBean PersonIdSLBean = (OAFormValueBean)webBean.findChildRecursive("PersonIdSL");
    if(null!=PersonIdSLBean){
      try
      {
        System.out.println("PersonIdSLBean.getValue():"+PersonIdSLBean.getValue());
        System.out.println("PersonIdSLBean.getValue(pageContext):"+PersonIdSLBean.getValue(pageContext));
        if(null!=PersonIdSLBean.getValue(pageContext)){
        numPersonID = new oracle.jbo.domain.Number(PersonIdSLBean.getValue(pageContext));
        }
      } catch (SQLException sqle)
      {
         retval = "EXCEPTION al covertir a numerico el PersonID:"+sqle.getMessage()+", "+sqle.getErrorCode();
         return retval; 
      }
    }
    
    OAFormValueBean userIdSLBean = (OAFormValueBean)webBean.findChildRecursive("userIdSL");
    if(null!=userIdSLBean){
      if(null!=userIdSLBean.getValue(pageContext)){
        try
        {
          numUserID = new oracle.jbo.domain.Number(userIdSLBean.getValue(pageContext));
        } catch (SQLException sqle)
        {
           retval = "EXCEPTION al covertir a numerico el UserID:"+sqle.getMessage()+", "+sqle.getErrorCode();
           return retval; 
        }
      }
    }
    ...
    if(null==numPersonID||null==numUserID){
      retval = "EXCEPTION No se pudieron recuperar las variables numPersonID y numUserID.";
      return retval; 
    }
    ...
    if(null!=V2InvSoliVOImpl){
      ...
      String[] arrayActiveAssignmentInfo = this.getActiveAssignmentInfo(numPersonID.toString(),connection);
        if(null!=arrayActiveAssignmentInfo[0]){
          if(arrayActiveAssignmentInfo[0].contains("EXCEPTION")){
            return arrayActiveAssignmentInfo[0];
          }
      ...
      String[] arrayFulNameEmpNumSex = getFulNameEmpNumSex(numPersonID.toString(),connection);
      ...
      String[] arrayPersonTypeID = getPersonTypeID(numPersonID.toString(),connection);
           if(null!=arrayPersonTypeID[0]){
             if(arrayPersonTypeID[0].contains("EXCEPTION")){
              return arrayPersonTypeID[0];
             }
      ...
      String[] arrayGradeInfo = getGradeInfo(numPersonID.toString(),connection);
            if(null!=arrayGradeInfo[0]){
              if(arrayGradeInfo[0].contains("EXCEPTION")){
                return arrayGradeInfo[0];
              }
      ...
      String strShortPosition = null;   
      String[] arrayPositionInfo = getPositionInfo(numPersonID.toString(),connection);   
      if(null!=arrayPositionInfo[0]){
        if(arrayPositionInfo[0].contains("EXCEPTION")){
          return arrayPositionInfo[0]; 
          /***********************************************
      ...
      String[] arrayAccountingInfo = getAccountingInfo(numPersonID.toString(),connection);
            if(null!=arrayAccountingInfo[0]){
              if(arrayAccountingInfo[0].contains("EXCEPTION")){
                return arrayAccountingInfo[0];
              }           
      ...
      oracle.jbo.domain.Date currentDate = oaDBTransaction.getCurrentDBDate();
      String[] arrayContDueDateInfo = getContDueDateInfo(numPersonID.toString(),connection);
      if(null!=arrayContDueDateInfo[0]){
        ...
        System.out.println("arrayContDueDateInfo[1]:"+arrayContDueDateInfo[1]);
        if(null!=arrayContDueDateInfo[1]&&!"".equals(arrayContDueDateInfo[1])){
        ContDueDate = new oracle.jbo.domain.Date(arrayContDueDateInfo[1]);
        }
      }
      
      
     V2InvSoliVORowImpl = (xXGamV2InvSoliVORowImpl)V2InvSoliVOImpl.createRow(); 
     ...
     V2InvSoliVORowImpl.setUserId(numUserID);
      ...
      if(null==V2InvSoliVORowImpl.getCategory()||"".equals(V2InvSoliVORowImpl.getCategory())){
   ...
   * @return
   */
  private String[] getContDueDateInfo(String pStrPersonID, Connection pConnection)
  {
    ...
    int counter = 0;
     ...
     String strPrepStmt = " select paaf.date_probation_end  fecha_termino_contrato " + 
                          "   from per_all_assignments_f paaf " + 
    ...
    {
       retval[0] = "EXCEPTION al obtener la fecha de finalizacion de contrato:"+sqle.getErrorCode()+" , "+sqle.getMessage();
       return retval;
    }
    ...
    if(0==counter){
      retval[0] = "EXCEPTION al obtener la fecha de finalizacion de contrato: No se encontraron registros.";
      return retval;
    }
    
    if(counter>1){
      retval[0] = "EXCEPTION al obtener la fecha de finalizacion de contrato: Mas de un Registro.";
      return retval;
    }
  ...
  public String getAvailableKitsInfoSU()
  {
    ...
    if(null!=V2InvSoliVOImpl){
      V2InvSoliVORowImpl = (xXGamV2InvSoliVORowImpl)V2InvSoliVOImpl.getCurrentRow();
      ...
      while(resultSet.next()){
        if(null!=V2InvSoliDtlVOImpl){
          ...
          ***************************************************************************************************/
          ...
          oracle.jbo.domain.Number numValidaCicloByNomen = this.callValidarCicloByNomen(V2InvSoliVORowImpl.getPersonId()
                                                                                       ,resultSet.getString("nomenclature")
                                                                                       ,resultSet.getString("cycle_cod"));
  ...
  public String fillSoliDtlIDInfoSU(String pStrSoliID)
  {
    ...
    {
      retval ="EXCEPTION al convertir a numerico elvalor pStrSoliID:"+pStrSoliID+" "+sqle.getMessage()+" ,"+sqle.getErrorCode();
    }
    ...
    while(V2InvSoliDtlVOIterator.hasNext()){
     ...
     if(null!=InvSoliDtlVOImpl){
      ...
      /** if("EMPLEADO PLANTA".equals(InvSoliVORowImpl.getAdscription())){ **/
       ...
       InvSoliDtlVORowImpl.setSoliId(numSoliID/**InvSoliVORowImpl.getSoliId()**/);
       InvSoliDtlVORowImpl.setSoliDtlId(numSoliDtlID);
 ...
 /**
  ...
  public String getNumberUNIS()
  {
    ...
    if(null!=InvSoliVOImpl){
      InvSoliVORowImpl = (xXGamInvSoliVORowImpl)InvSoliVOImpl.getCurrentRow();
      if(null!=InvSoliVORowImpl){
        oracle.jbo.domain.Number numPersonID = InvSoliVORowImpl.getPersonId();
