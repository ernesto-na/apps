...
public class xXGamInvTallasAllCO extends OAControllerImpl
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    super.processRequest(pageContext, webBean);
      ...
      String strSoliDtlValue = (String)pageContext.getSessionValue("SoliDtlValue");
      ...
      System.out.println("searchText: "  + strSearchText);
       ...
       xXGamInvUniformesLovAMImpl am = (xXGamInvUniformesLovAMImpl)pageContext.getApplicationModule(webBean);
       if(null!=strSearchText&&null!=strSoliDtlValue){
       am.executeInitial(pageContext.getParameter("searchText"),  pageContext.getSessionValue("SoliDtlValue").toString());
       }
